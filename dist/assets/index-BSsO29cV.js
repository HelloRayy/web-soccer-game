...
### Spacing & Gaps
`;for(let z=0;z<c.length-1;z++){const de=c[z],ye=c[z+1],G=((L=no[de.type])==null?void 0:L.label)||de.type,fe=((B=no[ye.type])==null?void 0:B.label)||ye.type,xe=Math.round(ye.y-(de.y+de.height)),he=Math.round(ye.x-(de.x+de.width));Math.abs(de.y-ye.y)<30?u+=`- ${G} → ${fe}: \`${he}px\` horizontal gap
