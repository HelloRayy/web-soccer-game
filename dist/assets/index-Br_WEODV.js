 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zp;function X1(){if(zp)return mt;zp=1;var o=Symbol.for("react.transitional.element"),n=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),l=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),_=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),p=Symbol.for("react.lazy"),y=Symbol.for("react.activity"),v=Symbol.iterator;function C(A){return A===null||typeof A!="object"?null:(A=v&&A[v]||A["@@iterator"],typeof A=="function"?A:null)}var k={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},M=Object.assign,L={};function B(A,Z,pe){this.props=A,this.context=Z,this.refs=L,this.updater=pe||k}B.prototype.isReactComponent={},B.prototype.setState=function(A,Z){if(typeof A!="object"&&typeof A!="function"&&A!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,A,Z,"setState")},B.prototype.forceUpdate=function(A){this.updater.enqueueForceUpdate(this,A,"forceUpdate")};function J(){}J.prototype=B.prototype;function F(A,Z,pe){this.props=A,this.context=Z,this.refs=L,this.updater=pe||k}var z=F.prototype=new J;z.constructor=F,M(z,B.prototype),z.isPureReactComponent=!0;var ue=Array.isArray;function xe(){}var Y={H:null,A:null,T:null,S:null},ge=Object.prototype.hasOwnProperty;function he(A,Z,pe){var je=pe.ref;return{$$typeof:o,type:A,key:Z,ref:je!==void 0?je:null,props:pe}}function _e(A,Z){return he(A.type,Z,A.props)}function ce(A){return typeof A=="object"&&A!==null&&A.$$typeof===o}function Q(A){var Z={"=":"=0",":":"=2"};return"$"+A.replace(/[=:]/g,function(pe){return Z[pe]})}var ze=/\/+/g;function fe(A,Z){return typeof A=="object"&&A!==null&&A.key!=null?Q(""+A.key):Z.toString(36)}function Se(A){switch(A.status){case"fulfilled":return A.value;case"rejected":throw A.reason;default:switch(typeof A.status=="string"?A.then(xe,xe):(A.status="pending",A.then(function(Z){A.status==="pending"&&(A.status="fulfilled",A.value=Z)},function(Z){A.status==="pending"&&(A.status="rejected",A.reason=Z)})),A.status){case"fulfilled":return A.value;case"rejected":throw A.reason}}throw A}function N(A,Z,pe,je,qe){var rt=typeof A;(rt==="undefined"||rt==="boolean")&&(A=null);var dt=!1;if(A===null)dt=!0;else switch(rt){case"bigint":case"string":case"number":dt=!0;break;case"object":switch(A.$$typeof){case o:case n:dt=!0;break;case p:return dt=A._init,N(dt(A._payload),Z,pe,je,qe)}}if(dt)return qe=qe(A),dt=je===""?"."+fe(A,0):je,ue(qe)?(pe="",dt!=null&&(pe=dt.replace(ze,"$&/")+"/"),N(qe,Z,pe,"",function(Pe){return Pe})):qe!=null&&(ce(qe)&&(qe=_e(qe,pe+(qe.key==null||A&&A.key===qe.key?"":(""+qe.key).replace(ze,"$&/")+"/")+dt)),Z.push(qe)),1;dt=0;var en=je===""?".":je+":";if(ue(A))for(var Qe=0;Qe<A.length;Qe++)je=A[Qe],rt=en+fe(je,Qe),dt+=N(je,Z,pe,rt,qe);else if(Qe=C(A),typeof Qe=="function")for(A=Qe.call(A),Qe=0;!(je=A.next()).done;)je=je.value,rt=en+fe(je,Qe++),dt+=N(je,Z,pe,rt,qe);else if(rt==="object"){if(typeof A.then=="function")return N(Se(A),Z,pe,je,qe);throw Z=String(A),Error("Objects are not valid as a React child (found: "+(Z==="[object Object]"?"object with keys {"+Object.keys(A).join(", ")+"}":Z)+"). If you meant to render a collection of children, use an array instead.")}return dt}function re(A,Z,pe){if(A==null)return A;var je=[],qe=0;return N(A,je,"","",function(rt){return Z.call(pe,rt,qe++)}),je}function W(A){if(A._status===-1){var Z=A._result;Z=Z(),Z.then(function(pe){(A._status===0||A._status===-1)&&(A._status=1,A._result=pe)},function(pe){(A._status===0||A._status===-1)&&(A._status=2,A._result=pe)}),A._status===-1&&(A._status=0,A._result=Z)}if(A._status===1)return A._result.default;throw A._result}var be=typeof reportError=="function"?reportError:function(A){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof A=="object"&&A!==null&&typeof A.message=="string"?String(A.message):String(A),error:A});if(!window.dispatchEvent(Z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",A);return}console.error(A)},De={map:re,forEach:function(A,Z,pe){re(A,function(){Z.apply(this,arguments)},pe)},count:function(A){var Z=0;return re(A,function(){Z++}),Z},toArray:function(A){return re(A,function(Z){return Z})||[]},only:function(A){if(!ce(A))throw Error("React.Children.only expected to receive a single React element child.");return A}};return mt.Activity=y,mt.Children=De,mt.Component=B,mt.Fragment=i,mt.Profiler=c,mt.PureComponent=F,mt.StrictMode=l,mt.Suspense=h,mt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Y,mt.__COMPILER_RUNTIME={__proto__:null,c:function(A){return Y.H.useMemoCache(A)}},mt.cache=function(A){return function(){return A.apply(null,arguments)}},mt.cacheSignal=function(){return null},mt.cloneElement=function(A,Z,pe){if(A==null)throw Error("The argument must be a React element, but you passed "+A+".");var je=M({},A.props),qe=A.key;if(Z!=null)for(rt in Z.key!==void 0&&(qe=""+Z.key),Z)!ge.call(Z,rt)||rt==="key"||rt==="__self"||rt==="__source"||rt==="ref"&&Z.ref===void 0||(je[rt]=Z[rt]);var rt=arguments.length-2;if(rt===1)je.children=pe;else if(1<rt){for(var dt=Array(rt),en=0;en<rt;en++)dt[en]=arguments[en+2];je.children=dt}return he(A.type,qe,je)},mt.createContext=function(A){return A={$$typeof:_,_currentValue:A,_currentValue2:A,_threadCount:0,Provider:null,Consumer:null},A.Provider=A,A.Consumer={$$typeof:u,_context:A},A},mt.createElement=function(A,Z,pe){var je,qe={},rt=null;if(Z!=null)for(je in Z.key!==void 0&&(rt=""+Z.key),Z)ge.call(Z,je)&&je!=="key"&&je!=="__self"&&je!=="__source"&&(qe[je]=Z[je]);var dt=arguments.length-2;if(dt===1)qe.children=pe;else if(1<dt){for(var en=Array(dt),Qe=0;Qe<dt;Qe++)en[Qe]=arguments[Qe+2];qe.children=en}if(A&&A.defaultProps)for(je in dt=A.defaultProps,dt)qe[je]===void 0&&(qe[je]=dt[je]);return he(A,rt,qe)},mt.createRef=function(){return{current:null}},mt.forwardRef=function(A){return{$$typeof:g,render:A}},mt.isValidElement=ce,mt.lazy=function(A){return{$$typeof:p,_payload:{_status:-1,_result:A},_init:W}},mt.memo=function(A,Z){return{$$typeof:m,type:A,compare:Z===void 0?null:Z}},mt.startTransition=function(A){var Z=Y.T,pe={};Y.T=pe;try{var je=A(),qe=Y.S;qe!==null&&qe(pe,je),typeof je=="object"&&je!==null&&typeof je.then=="function"&&je.then(xe,be)}catch(rt){be(rt)}finally{Z!==null&&pe.types!==null&&(Z.types=pe.types),Y.T=Z}},mt.unstable_useCacheRefresh=function(){return Y.H.useCacheRefresh()},mt.use=function(A){return Y.H.use(A)},mt.useActionState=function(A,Z,pe){return Y.H.useActionState(A,Z,pe)},mt.useCallback=function(A,Z){return Y.H.useCallback(A,Z)},mt.useContext=function(A){return Y.H.useContext(A)},mt.useDebugValue=function(){},mt.useDeferredValue=function(A,Z){return Y.H.useDeferredValue(A,Z)},mt.useEffect=function(A,Z){return Y.H.useEffect(A,Z)},mt.useEffectEvent=function(A){return Y.H.useEffectEvent(A)},mt.useId=function(){return Y.H.useId()},mt.useImperativeHandle=function(A,Z,pe){return Y.H.useImperativeHandle(A,Z,pe)},mt.useInsertionEffect=function(A,Z){return Y.H.useInsertionEffect(A,Z)},mt.useLayoutEffect=function(A,Z){return Y.H.useLayoutEffect(A,Z)},mt.useMemo=function(A,Z){return Y.H.useMemo(A,Z)},mt.useOptimistic=function(A,Z){return Y.H.useOptimistic(A,Z)},mt.useReducer=function(A,Z,pe){return Y.H.useReducer(A,Z,pe)},mt.useRef=function(A){return Y.H.useRef(A)},mt.useState=function(A){return Y.H.useState(A)},mt.useSyncExternalStore=function(A,Z,pe){return Y.H.useSyncExternalStore(A,Z,pe)},mt.useTransition=function(){return Y.H.useTransition()},mt.version="19.2.8",mt}var Bp;function fh(){return Bp||(Bp=1,yf.exports=X1()),yf.exports}var b=fh();const Rn=dh(b);var xf={exports:{}},Kl={},bf={exports:{}},vf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $p;function G1(){return $p||($p=1,(function(o){function n(N,re){var W=N.length;N.push(re);e:for(;0<W;){var be=W-1>>>1,De=N[be];if(0<c(De,re))N[be]=re,N[W]=De,W=be;else break e}}function i(N){return N.length===0?null:N[0]}function l(N){if(N.length===0)return null;var re=N[0],W=N.pop();if(W!==re){N[0]=W;e:for(var be=0,De=N.length,A=De>>>1;be<A;){var Z=2*(be+1)-1,pe=N[Z],je=Z+1,qe=N[je];if(0>c(pe,W))je<De&&0>c(qe,pe)?(N[be]=qe,N[je]=W,be=je):(N[be]=pe,N[Z]=W,be=Z);else if(je<De&&0>c(qe,W))N[be]=qe,N[je]=W,be=je;else break e}}return re}function c(N,re){var W=N.sortIndex-re.sortIndex;return W!==0?W:N.id-re.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var _=Date,g=_.now();o.unstable_now=function(){return _.now()-g}}var h=[],m=[],p=1,y=null,v=3,C=!1,k=!1,M=!1,L=!1,B=typeof setTimeout=="function"?setTimeout:null,J=typeof clearTimeout=="function"?clearTimeout:null,F=typeof setImmediate<"u"?setImmediate:null;function z(N){for(var re=i(m);re!==null;){if(re.callback===null)l(m);else if(re.startTime<=N)l(m),re.sortIndex=re.expirationTime,n(h,re);else break;re=i(m)}}function ue(N){if(M=!1,z(N),!k)if(i(h)!==null)k=!0,xe||(xe=!0,Q());else{var re=i(m);re!==null&&Se(ue,re.startTime-N)}}var xe=!1,Y=-1,ge=5,he=-1;function _e(){return L?!0:!(o.unstable_now()-he<ge)}function ce(){if(L=!1,xe){var N=o.unstable_now();he=N;var re=!0;try{e:{k=!1,M&&(M=!1,J(Y),Y=-1),C=!0;var W=v;try{t:{for(z(N),y=i(h);y!==null&&!(y.expirationTime>N&&_e());){var be=y.callback;if(typeof be=="function"){y.callback=null,v=y.priorityLevel;var De=be(y.expirationTime<=N);if(N=o.unstable_now(),typeof De=="function"){y.callback=De,z(N),re=!0;break t}y===i(h)&&l(h),z(N)}else l(h);y=i(h)}if(y!==null)re=!0;else{var A=i(m);A!==null&&Se(ue,A.startTime-N),re=!1}}break e}finally{y=null,v=W,C=!1}re=void 0}}finally{re?Q():xe=!1}}}var Q;if(typeof F=="function")Q=function(){F(ce)};else if(typeof MessageChannel<"u"){var ze=new MessageChannel,fe=ze.port2;ze.port1.onmessage=ce,Q=function(){fe.postMessage(null)}}else Q=function(){B(ce,0)};function Se(N,re){Y=B(function(){N(o.unstable_now())},re)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(N){N.callback=null},o.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ge=0<N?Math.floor(1e3/N):5},o.unstable_getCurrentPriorityLevel=function(){return v},o.unstable_next=function(N){switch(v){case 1:case 2:case 3:var re=3;break;default:re=v}var W=v;v=re;try{return N()}finally{v=W}},o.unstable_requestPaint=function(){L=!0},o.unstable_runWithPriority=function(N,re){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var W=v;v=N;try{return re()}finally{v=W}},o.unstable_scheduleCallback=function(N,re,W){var be=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?be+W:be):W=be,N){case 1:var De=-1;break;case 2:De=250;break;case 5:De=1073741823;break;case 4:De=1e4;break;default:De=5e3}return De=W+De,N={id:p++,callback:re,priorityLevel:N,startTime:W,expirationTime:De,sortIndex:-1},W>be?(N.sortIndex=W,n(m,N),i(h)===null&&N===i(m)&&(M?(J(Y),Y=-1):M=!0,Se(ue,W-be))):(N.sortIndex=De,n(h,N),k||C||(k=!0,xe||(xe=!0,Q()))),N},o.unstable_shouldYield=_e,o.unstable_wrapCallback=function(N){var re=v;return function(){var W=v;v=re;try{return N.apply(this,arguments)}finally{v=W}}}})(vf)),vf}var Pp;function F1(){return Pp||(Pp=1,bf.exports=G1()),bf.exports}var wf={exports:{}},ss={};/**
 * @license React
...
.icon-transitions-module__sending___uaLN- {
  ...
  `,document.head.appendChild(o),Ct.pausedAnimations=[];try{document.getAnimations().forEach(n=>{var l;if(n.playState!=="running")return;const i=(l=n.effect)==null?void 0:l.target;y2(i)||(n.pause(),Ct.pausedAnimations.push(n))})}catch{}document.querySelectorAll("video").forEach(n=>{n.paused||(n.dataset.wasPaused="false",n.pause())})}function l0(){var i;if(typeof document>"u"||!Ct.frozen)return;Ct.frozen=!1;const o=Ct.frozenTimeoutQueue;Ct.frozenTimeoutQueue=[];for(const l of o)Ct.origSetTimeout(()=>{if(Ct.frozen){Ct.frozenTimeoutQueue.push(l);return}try{l()}catch(c){console.warn("[agentation] Error replaying queued timeout:",c)}},0);const n=Ct.frozenRAFQueue;Ct.frozenRAFQueue=[];for(const l of n)Ct.origRAF(c=>{if(Ct.frozen){Ct.frozenRAFQueue.push(l);return}l(c)});for(const l of Ct.pausedAnimations)try{l.play()}catch(c){console.warn("[agentation] Error resuming animation:",c)}Ct.pausedAnimations=[],(i=document.getElementById(th))==null||i.remove(),document.querySelectorAll("video").forEach(l=>{l.dataset.wasPaused==="false"&&(l.play().catch(()=>{}),delete l.dataset.wasPaused)})}function Df(o){if(!o)return;const n=i=>i.stopImmediatePropagation();document.addEventListener("focusin",n,!0),document.addEventListener("focusout",n,!0);try{o.focus()}finally{document.removeEventListener("focusin",n,!0),document.removeEventListener("focusout",n,!0)}}var hu=b.forwardRef(function({element:n,timestamp:i,selectedText:l,placeholder:c="What should change?",initialValue:u="",submitLabel:_="Add",onSubmit:g,onCancel:h,onDelete:m,style:p,accentColor:y="#3c82f7",isExiting:v=!1,lightMode:C=!1,computedStyles:k},M){const[L,B]=b.useState(u),[J,F]=b.useState(!1),[z,ue]=b.useState("initial"),[xe,Y]=b.useState(!1),[ge,he]=b.useState(!1),_e=b.useRef(null),ce=b.useRef(null),Q=b.useRef(null),ze=b.useRef(null);b.useEffect(()=>{v&&z!=="exit"&&ue("exit")},[v,z]),b.useEffect(()=>{tt(()=>{ue("enter")},0);const be=tt(()=>{ue("entered")},200),De=tt(()=>{const A=_e.current;A&&(Df(A),A.selectionStart=A.selectionEnd=A.value.length,A.scrollTop=A.scrollHeight)},50);return()=>{clearTimeout(be),clearTimeout(De),Q.current&&clearTimeout(Q.current),ze.current&&clearTimeout(ze.current)}},[]);const fe=b.useCallback(()=>{ze.current&&clearTimeout(ze.current),F(!0),ze.current=tt(()=>{F(!1),Df(_e.current)},250)},[]);b.useImperativeHandle(M,()=>({shake:fe}),[fe]);const Se=b.useCallback(()=>{ue("exit"),Q.current=tt(()=>{h()},150)},[h]),N=b.useCallback(()=>{L.trim()&&g(L.trim())},[L,g]),re=b.useCallback(be=>{be.stopPropagation(),!be.nativeEvent.isComposing&&(be.key==="Enter"&&!be.shiftKey&&(be.preventDefault(),N()),be.key==="Escape"&&Se())},[N,Se]),W=[sn.popup,C?sn.light:"",z==="enter"?sn.enter:"",z==="entered"?sn.entered:"",z==="exit"?sn.exit:"",J?sn.shake:""].filter(Boolean).join(" ");return r.jsxs("div",{ref:ce,className:W,"data-annotation-popup":!0,style:p,onClick:be=>be.stopPropagation(),children:[r.jsxs("div",{className:sn.header,children:[k&&Object.keys(k).length>0?r.jsxs("button",{className:sn.headerToggle,onClick:()=>{const be=ge;he(!ge),be&&tt(()=>Df(_e.current),0)},type:"button",children:[r.jsx("svg",{className:`${sn.chevron} ${ge?sn.expanded:""}`,width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:r.jsx("path",{d:"M5.5 10.25L9 7.25L5.75 4",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}),r.jsx("span",{className:sn.element,children:n})]}):r.jsx("span",{className:sn.element,children:n}),i&&r.jsx("span",{className:sn.timestamp,children:i})]}),k&&Object.keys(k).length>0&&r.jsx("div",{className:`${sn.stylesWrapper} ${ge?sn.expanded:""}`,children:r.jsx("div",{className:sn.stylesInner,children:r.jsx("div",{className:sn.stylesBlock,children:Object.entries(k).map(([be,De])=>r.jsxs("div",{className:sn.styleLine,children:[r.jsx("span",{className:sn.styleProperty,children:be.replace(/([A-Z])/g,"-$1").toLowerCase()}),": ",r.jsx("span",{className:sn.styleValue,children:De}),";"]},be))})})}),l&&r.jsxs("div",{className:sn.quote,children:["“",l.slice(0,80),l.length>80?"...":"","”"]}),r.jsx("textarea",{ref:_e,className:sn.textarea,style:{borderColor:xe?y:void 0},placeholder:c,value:L,onChange:be=>B(be.target.value),onFocus:()=>Y(!0),onBlur:()=>Y(!1),rows:2,onKeyDown:re}),r.jsxs("div",{className:sn.actions,children:[m&&r.jsx("div",{className:sn.deleteWrapper,children:r.jsx("button",{className:sn.deleteButton,onClick:m,type:"button",children:r.jsx(h2,{size:22})})}),r.jsx("button",{className:sn.cancel,onClick:Se,children:"Cancel"}),r.jsx("button",{className:sn.submit,style:{backgroundColor:y,opacity:L.trim()?1:.4},onClick:N,disabled:!L.trim(),children:_})]})]})}),b2=({content:o,children:n,...i})=>{const[l,c]=b.useState(!1),[u,_]=b.useState(!1),[g,h]=b.useState({top:0,right:0}),m=b.useRef(null),p=b.useRef(null),y=b.useRef(null),v=()=>{if(m.current){const M=m.current.getBoundingClientRect();h({top:M.top+M.height/2,right:window.innerWidth-M.left+8})}},C=()=>{_(!0),y.current&&(clearTimeout(y.current),y.current=null),v(),p.current=tt(()=>{c(!0)},500)},k=()=>{p.current&&(clearTimeout(p.current),p.current=null),c(!1),y.current=tt(()=>{_(!1)},150)};return b.useEffect(()=>()=>{p.current&&clearTimeout(p.current),y.current&&clearTimeout(y.current)},[]),r.jsxs(r.Fragment,{children:[r.jsx("span",{ref:m,onMouseEnter:C,onMouseLeave:k,...i,children:n}),u&&eg.createPortal(r.jsx("div",{"data-feedback-toolbar":!0,style:{position:"fixed",top:g.top,right:g.right,transform:"translateY(-50%)",padding:"6px 10px",background:"#383838",color:"rgba(255, 255, 255, 0.7)",fontSize:"11px",fontWeight:400,lineHeight:"14px",borderRadius:"10px",width:"180px",textAlign:"left",zIndex:100020,pointerEvents:"none",boxShadow:"0px 1px 8px rgba(0, 0, 0, 0.28)",opacity:l?1:0,transition:"opacity 0.15s ease"},children:o}),document.body)]})},v2=`.styles-module__tooltip___mcXL2 {
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: help;
...
`,c.forEach((z,ue)=>{var Y;const xe=((Y=no[z.type])==null?void 0:Y.label)||z.type;u+=`${ue+1}. **${xe}** — \`${Math.round(z.width)}×${Math.round(z.height)}px\` at \`(${Math.round(z.x)}, ${Math.round(z.y)})\`
`}),u;const _=hy(n);u+=my(_),u+=`### Components
`,c.forEach((z,ue)=>{var Q;const xe=((Q=no[z.type])==null?void 0:Q.label)||z.type,Y={x:z.x,y:z.y,width:z.width,height:z.height};u+=`${ue+1}. **${xe}** — \`${Math.round(z.width)}×${Math.round(z.height)}px\` at \`(${Math.round(z.x)}, ${Math.round(z.y)})\`
`;const ge=oh(Y),_e=fy(ge,{includeLeftRight:l==="detailed"||l==="forensic"});for(const ze of _e)u+=`   - ${ze}
`;const ce=_y(Y,_);ce&&(u+=`   - CSS: ${ce}
`)}),u+=`
### Layout Analysis
`;const g=[];for(const z of c){const ue=g.find(xe=>Math.abs(xe.y-z.y)<30);ue?ue.items.push(z):g.push({y:z.y,items:[z]})}if(g.sort((z,ue)=>z.y-ue.y),g.forEach((z,ue)=>{z.items.sort((Y,ge)=>Y.x-ge.x);const xe=z.items.map(Y=>{var ge;return((ge=no[Y.type])==null?void 0:ge.label)||Y.type});if(z.items.length===1){const ge=z.items[0].width>n.width*.8;u+=`- Row ${ue+1} (y≈${Math.round(z.y)}): ${xe[0]}${ge?" — full width":""}
`}else u+=`- Row ${ue+1} (y≈${Math.round(z.y)}): ${xe.join(" | ")} — ${z.items.length} items side by side
`}),l==="detailed"||l==="forensic"){u+=`
### Spacing & Gaps
`;for(let z=0;z<c.length-1;z++){const ue=c[z],xe=c[z+1],Y=((L=no[ue.type])==null?void 0:L.label)||ue.type,ge=((B=no[xe.type])==null?void 0:B.label)||xe.type,he=Math.round(xe.y-(ue.y+ue.height)),_e=Math.round(xe.x-(ue.x+ue.width));Math.abs(ue.y-xe.y)<30?u+=`- ${Y} → ${ge}: \`${_e}px\` horizontal gap
`:u+=`- ${Y} → ${ge}: \`${he}px\` vertical gap
`}if(l==="forensic"&&c.length>2){u+=`
### All Pairwise Gaps
`;for(let z=0;z<c.length;z++)for(let ue=z+1;ue<c.length;ue++){const xe=c[z],Y=c[ue],ge=((J=no[xe.type])==null?void 0:J.label)||xe.type,he=((F=no[Y.type])==null?void 0:F.label)||Y.type,_e=Math.round(Y.y-(xe.y+xe.height)),ce=Math.round(Y.x-(xe.x+xe.width));u+=`- ${ge} ↔ ${he}: h=\`${ce}px\` v=\`${_e}px\`
`}}l==="forensic"&&(u+=`
### Z-Order (placement order)
`,o.forEach((z,ue)=>{var Y;const xe=((Y=no[z.type])==null?void 0:Y.label)||z.type;u+=`${ue}. ${xe} at \`(${Math.round(z.x)}, ${Math.round(z.y)})\`
`}))}u+=`
...
### CSS Suggestions
`,p){const z=c.find(ue=>ue.type==="sidebar");u+=`- \`display: grid; grid-template-columns: ${Math.round(z.width)}px 1fr;\`
...
`;const F=v?{width:k.width,height:k.height}:void 0,z=`at (${Math.round(k.x)}, ${Math.round(k.y)})`,ue=F?`, ${Math.round(F.width)}×${Math.round(F.height)}px`:"",Y=fy(B,{includeLeftRight:n==="detailed"||n==="forensic"});if(Y.length>0){u+=`  - Suggested position ${z}${ue}: ${Y[0]}
`;for(let he=1;he<Y.length;he++)u+=`    ${Y[he]}
`}else u+=`  - Suggested position ${z}${ue}
`;const ge=_y(k,h);ge&&(u+=`  - CSS: ${ge}
...
`)}
    ...
    }`].join(""),document.head.appendChild(o)};d4();function Qi(o,n){let i=document.elementFromPoint(o,n);if(!i)return null;for(;i!=null&&i.shadowRoot;){const l=i.shadowRoot.elementFromPoint(o,n);if(!l||l===i)break;i=l}return i}function Uf(o){let n=o;for(;n&&n!==document.body;){const l=window.getComputedStyle(n).position;if(l==="fixed"||l==="sticky")return!0;n=n.parentElement}return!1}function Vi(o){return o.status!=="resolved"&&o.status!=="dismissed"}function Jc(o){const n=ah(o),i=n.found?n:Qw(o);if(i.found&&i.source)return qw(i.source,"path")}function f4({demoAnnotations:o,demoDelay:n=1e3,enableDemoMode:i=!1,onAnnotationAdd:l,onAnnotationDelete:c,onAnnotationUpdate:u,onAnnotationsClear:_,onCopy:g,onSubmit:h,copyToClipboard:m=!0,endpoint:p,sessionId:y,onSessionCreated:v,webhookUrl:C,className:k}={}){var Nr,Or,ml,pl,ei,ti;const[M,L]=b.useState(!1),[B,J]=b.useState([]),[F,z]=b.useState(!0),[ue,xe]=b.useState(()=>kw()),[Y,ge]=b.useState(!1),he=b.useRef(null);b.useEffect(()=>{const S=D=>{const T=he.current;T&&T.contains(D.target)&&D.stopPropagation()},E=["mousedown","click","pointerdown"];return E.forEach(D=>document.body.addEventListener(D,S)),()=>{E.forEach(D=>document.body.removeEventListener(D,S))}},[]);const[_e,ce]=b.useState(!1),[Q,ze]=b.useState(!1),[fe,Se]=b.useState(null),[N,re]=b.useState({x:0,y:0}),[W,be]=b.useState(null),[De,A]=b.useState(!1),[Z,pe]=b.useState("idle"),[je,qe]=b.useState(!1),[rt,dt]=b.useState(!1),[en,Qe]=b.useState(null),[Pe,pt]=b.useState(null),[Je,ut]=b.useState([]),[At,dn]=b.useState(null),[bn,mn]=b.useState(null),[V,Me]=b.useState(null),[Fe,Ve]=b.useState(null),[nt,Ye]=b.useState([]),[Te,ct]=b.useState(0),[St,Ht]=b.useState(!1),[Be,I]=b.useState(!1),[X,oe]=b.useState(!1),[le,Oe]=b.useState(!1),[ke,me]=b.useState(!1),[it,ft]=b.useState("main"),[jt,st]=b.useState(!1),[Ae,wt]=b.useState(!1),[Et,Wt]=b.useState(!1),[Re,yt]=b.useState([]),[xt,ht]=b.useState(null),fn=b.useRef(!1),[Ge,Lt]=b.useState(!1),[vn,Yn]=b.useState(!1),[In,oo]=b.useState(1),[vs,Zn]=b.useState("new-page"),[ln,Dn]=b.useState(""),[Yt,jn]=b.useState(!1),[Ee,Jn]=b.useState(null),el=b.useRef(!1),tl=b.useRef({rearrange:null,placements:[]}),io=b.useRef({rearrange:null,placements:[]}),[Ei,oa]=b.useState(0),[Xo,Go]=b.useState(0),[Mi,ao]=b.useState(0),[Nn,nl]=b.useState(0),Fo=b.useRef(new Set),Ns=b.useRef(new Set),Xn=b.useRef(null),ia=b.useRef(),sl=Ae&&M&&!Et&&Ge;b.useEffect(()=>{if(sl){Yn(!1);const S=qa(()=>{Yn(!0)});return()=>cancelAnimationFrame(S)}else Yn(!1)},[sl]);const Wo=b.useRef(new Map),Ti=b.useRef(new Map),lo=b.useRef(),[es,ws]=b.useState(!1),[rn,gr]=b.useState([]),bu=b.useRef(rn);bu.current=rn;const[aa,vu]=b.useState(null),qo=b.useRef(null);b.useRef(!1),b.useRef([]),b.useRef(0),b.useRef(null),b.useRef(null),b.useRef(1);const[yr,as]=b.useState(!1),ro=b.useRef(null),[pn,co]=b.useState([]),Fn=b.useRef({cmd:!1,shift:!1}),Un=()=>{st(!0)},xr=()=>{st(!1)},Qo=()=>{yr||(ro.current=tt(()=>as(!0),850))},wu=()=>{ro.current&&(clearTimeout(ro.current),ro.current=null),as(!1),xr()};b.useEffect(()=>()=>{ro.current&&clearTimeout(ro.current)},[]);const[kt,br]=b.useState(()=>{try{const S=JSON.parse(localStorage.getItem("feedback-toolbar-settings")??"");return{...If,...S,annotationColorId:rr.find(E=>E.id===S.annotationColorId)?S.annotationColorId:If.annotationColorId}}catch{return If}}),[hs,vr]=b.useState(!0),[wr,Ri]=b.useState(!1),Qs=()=>{var S;(S=he.current)==null||S.classList.add(de.disableTransitions),vr(E=>!E),qa(()=>{var E;(E=he.current)==null||E.classList.remove(de.disableTransitions)})},ol=!1,Vs="off",[on,uo]=b.useState(y??null),il=b.useRef(!1),[ls,fo]=b.useState(p?"connecting":"disconnected"),[Bt,Ss]=b.useState(null),[Ks,Vo]=b.useState(!1),[rs,la]=b.useState(null),Ko=b.useRef(!1),[al,ho]=b.useState(new Set),[Ai,Di]=b.useState(new Set),[On,Os]=b.useState(!1),[ra,Ls]=b.useState(!1),[Zs,ca]=b.useState(!1),_o=b.useRef(null),ts=b.useRef(null),mo=b.useRef(null),Zo=b.useRef(null),ua=b.useRef(!1),Sr=b.useRef(0),da=b.useRef(null),fa=b.useRef(null),ll=8,Su=50,kr=b.useRef(null),Cr=b.useRef(null),Ni=b.useRef(null),et=typeof window<"u"?window.location.pathname:"/";b.useEffect(()=>{if(le)me(!0);else{st(!1),ft("main");const S=tt(()=>me(!1),0);return()=>clearTimeout(S)}},[le]);const rl=M&&F&&!Ae;b.useEffect(()=>{if(rl){ze(!1),ce(!0),ho(new Set);const S=tt(()=>{ho(E=>{const D=new Set(E);return B.forEach(T=>D.add(T.id)),D})},350);return()=>clearTimeout(S)}else if(_e){ze(!0);const S=tt(()=>{ce(!1),ze(!1)},250);return()=>clearTimeout(S)}},[rl]),b.useEffect(()=>{I(!0),ct(window.scrollY);const S=Nf(et);J(S.filter(Vi)),A0||(Ri(!0),A0=!0,tt(()=>Ri(!1),750));try{const E=localStorage.getItem("feedback-toolbar-theme");E!==null&&vr(E==="dark")}catch{}try{const E=localStorage.getItem("feedback-toolbar-position");if(E){const D=JSON.parse(E);typeof D.x=="number"&&typeof D.y=="number"&&Ss(D)}}catch{}},[et]),b.useEffect(()=>{Be&&localStorage.setItem("feedback-toolbar-settings",JSON.stringify(kt))},[kt,Be]),b.useEffect(()=>{Be&&localStorage.setItem("feedback-toolbar-theme",hs?"dark":"light")},[hs,Be]);const jr=b.useRef(!1);b.useEffect(()=>{const S=jr.current;jr.current=Ks,S&&!Ks&&Bt&&Be&&localStorage.setItem("feedback-toolbar-position",JSON.stringify(Bt))},[Ks,Bt,Be]),b.useEffect(()=>{if(!p||!Be||il.current)return;il.current=!0,fo("connecting"),(async()=>{try{const E=ww(et),D=y||E;let T=!1;if(D)try{const $=await w0(p,D);uo($.id),fo("connected"),Of(et,$.id),T=!0;const K=Nf(et),ye=new Set($.annotations.map(Ce=>Ce.id)),ve=K.filter(Ce=>!ye.has(Ce.id));if(ve.length>0){const Ie=`${typeof window<"u"?window.location.origin:""}${et}`,at=(await Promise.allSettled(ve.map(Ke=>Ga(p,$.id,{...Ke,sessionId:$.id,url:Ie})))).map((Ke,we)=>Ke.status==="fulfilled"?Ke.value:(console.warn("[Agentation] Failed to sync annotation:",Ke.reason),ve[we])),bt=[...$.annotations,...at];J(bt.filter(Vi)),nr(et,bt.filter(Vi),$.id)}else J($.annotations.filter(Vi)),nr(et,$.annotations.filter(Vi),$.id)}catch($){console.warn("[Agentation] Could not join session, creating new:",$),Sw(et)}if(!T){const $=typeof window<"u"?window.location.href:"/",K=await Lf(p,$);uo(K.id),fo("connected"),Of(et,K.id),v==null||v(K.id);const ye=_w(),ve=typeof window<"u"?window.location.origin:"",Ce=[];for(const[Ie,We]of ye){const at=We.filter(we=>!we._syncedTo);if(at.length===0)continue;const bt=`${ve}${Ie}`,Ke=Ie===et;Ce.push((async()=>{try{const we=Ke?K:await Lf(p,bt),gn=(await Promise.allSettled(at.map(Dt=>Ga(p,we.id,{...Dt,sessionId:we.id,url:bt})))).map((Dt,hn)=>Dt.status==="fulfilled"?Dt.value:(console.warn("[Agentation] Failed to sync annotation:",Dt.reason),at[hn])).filter(Vi);if(nr(Ie,gn,we.id),Ke){const Dt=new Set(at.map(hn=>hn.id));J(hn=>{const ot=hn.filter(_t=>!Dt.has(_t.id));return[...gn,...ot]})}}catch(we){console.warn(`[Agentation] Failed to sync annotations for ${Ie}:`,we)}})())}await Promise.allSettled(Ce)}}catch(E){fo("disconnected"),console.warn("[Agentation] Failed to initialize session, using local storage:",E)}})()},[p,y,Be,v,et]),b.useEffect(()=>{if(!p||!Be)return;const S=async()=>{try{(await fetch(`${p}/health`)).ok?fo("connected"):fo("disconnected")}catch{fo("disconnected")}};S();const E=g2(S,1e4);return()=>clearInterval(E)},[p,Be]),b.useEffect(()=>{if(!p||!Be||!on)return;const S=new EventSource(`${p}/sessions/${on}/events`),E=["resolved","dismissed"],D=T=>{var $;try{const K=JSON.parse(T.data);if(E.includes(($=K.payload)==null?void 0:$.status)){const ye=K.payload.id,ve=K.payload.kind;if(ve==="placement"){for(const[Ce,Ie]of Wo.current)if(Ie===ye){Wo.current.delete(Ce),yt(We=>We.filter(at=>at.id!==Ce));break}}else if(ve==="rearrange"){for(const[Ce,Ie]of Ti.current)if(Ie===ye){Ti.current.delete(Ce),Jn(We=>{if(!We)return null;const at=We.sections.filter(bt=>bt.id!==Ce);return at.length===0?null:{...We,sections:at}});break}}else Di(Ce=>new Set(Ce).add(ye)),tt(()=>{J(Ce=>Ce.filter(Ie=>Ie.id!==ye)),Di(Ce=>{const Ie=new Set(Ce);return Ie.delete(ye),Ie})},150)}}catch{}};return S.addEventListener("annotation.updated",D),()=>{S.removeEventListener("annotation.updated",D),S.close()}},[p,Be,on]),b.useEffect(()=>{if(!p||!Be)return;const S=fa.current==="disconnected",E=ls==="connected";fa.current=ls,S&&E&&(async()=>{try{const T=Nf(et);if(T.length===0)return;const K=`${typeof window<"u"?window.location.origin:""}${et}`;let ye=on,ve=[];if(ye)try{ve=(await w0(p,ye)).annotations}catch{ye=null}ye||(ye=(await Lf(p,K)).id,uo(ye),Of(et,ye));const Ce=new Set(ve.map(We=>We.id)),Ie=T.filter(We=>!Ce.has(We.id));if(Ie.length>0){const at=(await Promise.allSettled(Ie.map(we=>Ga(p,ye,{...we,sessionId:ye,url:K})))).map((we,tn)=>we.status==="fulfilled"?we.value:(console.warn("[Agentation] Failed to sync annotation on reconnect:",we.reason),Ie[tn])),Ke=[...ve,...at].filter(Vi);J(Ke),nr(et,Ke,ye)}}catch(T){console.warn("[Agentation] Failed to sync on reconnect:",T)}})()},[ls,p,Be,on,et]);const ku=b.useCallback(()=>{Y||(ge(!0),Oe(!1),L(!1),tt(()=>{Cw(!0),xe(!0),ge(!1)},400))},[Y]);b.useEffect(()=>{if(!i||!Be||!o||o.length===0||B.length>0)return;const S=[];return S.push(tt(()=>{L(!0)},n-200)),o.forEach((E,D)=>{const T=n+D*300;S.push(tt(()=>{const $=document.querySelector(E.selector);if(!$)return;const K=$.getBoundingClientRect(),{name:ye,path:ve}=Va($),Ce={id:`demo-${Date.now()}-${D}`,x:(K.left+K.width/2)/window.innerWidth*100,y:K.top+K.height/2+window.scrollY,comment:E.comment,element:ye,elementPath:ve,timestamp:Date.now(),selectedText:E.selectedText,boundingBox:{x:K.left,y:K.top+window.scrollY,width:K.width,height:K.height},nearbyText:er($),cssClasses:tr($)};J(Ie=>[...Ie,Ce])},T))}),()=>{S.forEach(clearTimeout)}},[i,Be,o,n]),b.useEffect(()=>{const S=()=>{ct(window.scrollY),Ht(!0),Ni.current&&clearTimeout(Ni.current),Ni.current=tt(()=>{Ht(!1)},150)};return window.addEventListener("scroll",S,{passive:!0}),()=>{window.removeEventListener("scroll",S),Ni.current&&clearTimeout(Ni.current)}},[]),b.useEffect(()=>{Be&&B.length>0?on?nr(et,B,on):gy(et,B):Be&&B.length===0&&localStorage.removeItem(mu(et))},[B,et,Be,on]),b.useEffect(()=>{if(Be&&!fn.current){fn.current=!0;const S=mw(et);S.length>0&&yt(S)}},[Be,et]),b.useEffect(()=>{Be&&fn.current&&!Ge&&(Re.length>0?pw(et,Re):gw(et))},[Re,et,Be,Ge]),b.useEffect(()=>{if(Be&&!el.current){el.current=!0;const S=yw(et);if(S){const E={...S,sections:S.sections.map(D=>({...D,currentRect:D.currentRect??{...D.originalRect}}))};Jn(E)}}},[Be,et]),b.useEffect(()=>{Be&&el.current&&!Ge&&(Ee?xw(et,Ee):bw(et))},[Ee,et,Be,Ge]);const cl=b.useRef(!1);b.useEffect(()=>{if(Be&&!cl.current){cl.current=!0;const S=vw(et);S&&(io.current={rearrange:S.rearrange,placements:S.placements||[]},S.purpose&&Dn(S.purpose))}},[Be,et]),b.useEffect(()=>{var E,D,T;if(!Be||!cl.current)return;const S=io.current;Ge?(((E=Ee==null?void 0:Ee.sections)==null?void 0:E.length)??0)>0||Re.length>0||ln?v0(et,{rearrange:Ee,placements:Re,purpose:ln}):Vc(et):(((T=(D=S.rearrange)==null?void 0:D.sections)==null?void 0:T.length)??0)>0||S.placements.length>0||ln?v0(et,{rearrange:S.rearrange,placements:S.placements,purpose:ln}):Vc(et)},[Ee,Re,ln,Ge,et,Be]),b.useEffect(()=>{Ae&&!Ee&&Jn({sections:[],originalOrder:[],detectedAt:Date.now()})},[Ae,Ee]),b.useEffect(()=>{if(!p||!on)return;const S=Wo.current,E=new Set(Re.map(D=>D.id));for(const D of Re){if(S.has(D.id))continue;S.set(D.id,"");const T=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:et;Ga(p,on,{id:D.id,x:D.x/window.innerWidth*100,y:D.y,comment:`Place ${D.type} at (${Math.round(D.x)}, ${Math.round(D.y)}), ${D.width}×${D.height}px${D.text?` — "${D.text}"`:""}`,element:`[design:${D.type}]`,elementPath:"[placement]",timestamp:D.timestamp,url:T,intent:"change",severity:"important",kind:"placement",placement:{componentType:D.type,width:D.width,height:D.height,scrollY:D.scrollY,text:D.text}}).then($=>{S.has(D.id)&&S.set(D.id,$.id)}).catch($=>{console.warn("[Agentation] Failed to sync placement annotation:",$),S.delete(D.id)})}for(const[D,T]of S)E.has(D)||(S.delete(D),T&&ki(p,T).catch(()=>{}))},[Re,p,on,et]),b.useEffect(()=>{if(!(!p||!on))return lo.current&&clearTimeout(lo.current),lo.current=tt(()=>{const S=Ti.current;if(!Ee||Ee.sections.length===0){for(const[,T]of S)T&&ki(p,T).catch(()=>{});S.clear();return}const E=new Set(Ee.sections.map(T=>T.id)),D=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:et;for(const T of Ee.sections){const $=T.originalRect,K=T.currentRect;if(!(Math.abs($.x-K.x)>1||Math.abs($.y-K.y)>1||Math.abs($.width-K.width)>1||Math.abs($.height-K.height)>1)){const Ce=S.get(T.id);Ce&&(S.delete(T.id),ki(p,Ce).catch(()=>{}));continue}const ve=S.get(T.id);ve?S0(p,ve,{comment:`Move ${T.label} section (${T.tagName}) — from (${Math.round($.x)},${Math.round($.y)}) ${Math.round($.width)}×${Math.round($.height)} to (${Math.round(K.x)},${Math.round(K.y)}) ${Math.round(K.width)}×${Math.round(K.height)}`}).catch(Ce=>{console.warn("[Agentation] Failed to update rearrange annotation:",Ce)}):(S.set(T.id,""),Ga(p,on,{id:T.id,x:K.x/window.innerWidth*100,y:K.y,comment:`Move ${T.label} section (${T.tagName}) — from (${Math.round($.x)},${Math.round($.y)}) ${Math.round($.width)}×${Math.round($.height)} to (${Math.round(K.x)},${Math.round(K.y)}) ${Math.round(K.width)}×${Math.round(K.height)}`,element:T.selector,elementPath:"[rearrange]",timestamp:Date.now(),url:D,intent:"change",severity:"important",kind:"rearrange",rearrange:{selector:T.selector,label:T.label,tagName:T.tagName,originalRect:$,currentRect:K}}).then(Ce=>{S.has(T.id)&&S.set(T.id,Ce.id)}).catch(Ce=>{console.warn("[Agentation] Failed to sync rearrange annotation:",Ce),S.delete(T.id)}))}for(const[T,$]of S)E.has(T)||(S.delete(T),$&&ki(p,$).catch(()=>{}))},300),()=>{lo.current&&clearTimeout(lo.current)}},[Ee,p,on,et]);const po=b.useRef(new Map);b.useLayoutEffect(()=>{const S=(Ee==null?void 0:Ee.sections)??[],E=new Set;if((Ae||Et)&&M)for(const D of S){E.add(D.id);try{const T=document.querySelector(D.selector);if(!T)continue;if(!po.current.has(D.id)){const $={transform:T.style.transform,transformOrigin:T.style.transformOrigin,opacity:T.style.opacity,position:T.style.position,zIndex:T.style.zIndex,display:T.style.display},K=[];let ye=T.parentElement;for(;ye&&ye!==document.body;){const Ce=getComputedStyle(ye);(Ce.overflow!=="visible"||Ce.overflowX!=="visible"||Ce.overflowY!=="visible")&&(K.push({el:ye,overflow:ye.style.overflow}),ye.style.overflow="visible"),ye=ye.parentElement}getComputedStyle(T).display==="inline"&&(T.style.display="inline-block"),po.current.set(D.id,{el:T,origStyles:$,ancestors:K}),T.style.transformOrigin="top left",T.style.zIndex="9999"}}catch{}}for(const[D,T]of po.current)if(!E.has(D)){const{el:$,origStyles:K,ancestors:ye}=T;$.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",$.style.transform=K.transform,$.style.transformOrigin=K.transformOrigin,$.style.opacity=K.opacity,$.style.position=K.position,$.style.zIndex=K.zIndex,po.current.delete(D),tt(()=>{$.style.transition="",$.style.display=K.display;for(const ve of ye)ve.el.style.overflow=ve.overflow},450)}},[Ee,Ae,Et,M]),b.useEffect(()=>()=>{for(const[,S]of po.current){const{el:E,origStyles:D,ancestors:T}=S;E.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",E.style.transform=D.transform,E.style.transformOrigin=D.transformOrigin,E.style.opacity=D.opacity,E.style.position=D.position,E.style.zIndex=D.zIndex,tt(()=>{E.style.transition="",E.style.display=D.display;for(const $ of T)$.el.style.overflow=$.overflow},450)}po.current.clear()},[]);const ha=b.useCallback(()=>{Wt(!0),wt(!1),ht(null),clearTimeout(ia.current),ia.current=tt(()=>{Wt(!1)},300)},[]),Er=b.useCallback(()=>{Ae&&(Wt(!0),wt(!1),ht(null),clearTimeout(ia.current),ia.current=tt(()=>{Wt(!1)},300)),L(!1)},[Ae]),Mr=b.useCallback(()=>{X||(x2(),oe(!0))},[X]),Oi=b.useCallback(()=>{X&&(l0(),oe(!1))},[X]),ul=b.useCallback(()=>{X?Oi():Mr()},[X,Mr,Oi]),Tr=b.useCallback(()=>{if(pn.length===0)return;const S=pn[0],E=S.element,D=pn.length>1,T=pn.map($=>$.element.getBoundingClientRect());if(D){const $={left:Math.min(...T.map(we=>we.left)),top:Math.min(...T.map(we=>we.top)),right:Math.max(...T.map(we=>we.right)),bottom:Math.max(...T.map(we=>we.bottom))},K=pn.slice(0,5).map(we=>we.name).join(", "),ye=pn.length>5?` +${pn.length-5} more`:"",ve=T.map(we=>({x:we.left,y:we.top+window.scrollY,width:we.width,height:we.height})),Ie=pn[pn.length-1].element,We=T[T.length-1],at=We.left+We.width/2,bt=We.top+We.height/2,Ke=Uf(Ie);be({x:at/window.innerWidth*100,y:Ke?bt:bt+window.scrollY,clientY:bt,element:`${pn.length} elements: ${K}${ye}`,elementPath:"multi-select",boundingBox:{x:$.left,y:$.top+window.scrollY,width:$.right-$.left,height:$.bottom-$.top},isMultiSelect:!0,isFixed:Ke,elementBoundingBoxes:ve,multiSelectElements:pn.map(we=>we.element),targetElement:Ie,fullPath:Wc(E),accessibility:Fc(E),computedStyles:Gc(E),computedStylesObj:Xc(E),nearbyElements:Yc(E),cssClasses:tr(E),nearbyText:er(E),sourceFile:Jc(E)})}else{const $=T[0],K=Uf(E);be({x:$.left/window.innerWidth*100,y:K?$.top:$.top+window.scrollY,clientY:$.top,element:S.name,elementPath:S.path,boundingBox:{x:$.left,y:K?$.top:$.top+window.scrollY,width:$.width,height:$.height},isFixed:K,fullPath:Wc(E),accessibility:Fc(E),computedStyles:Gc(E),computedStylesObj:Xc(E),nearbyElements:Yc(E),cssClasses:tr(E),nearbyText:er(E),reactComponents:S.reactComponents,sourceFile:Jc(E)})}co([]),Se(null)},[pn]);b.useEffect(()=>{M||(be(null),Me(null),Ve(null),Ye([]),Se(null),Oe(!1),co([]),Fn.current={cmd:!1,shift:!1},X&&Oi())},[M,X,Oi]),b.useEffect(()=>()=>{l0()},[]),b.useEffect(()=>{if(!M)return;const S=["p","span","h1","h2","h3","h4","h5","h6","li","td","th","label","blockquote","figcaption","caption","legend","dt","dd","pre","code","em","strong","b","i","u","s","a","time","address","cite","q","abbr","dfn","mark","small","sub","sup","[contenteditable]"].join(", "),E=":not([data-agentation-root]):not([data-agentation-root] *)",D=document.createElement("style");return D.id="feedback-cursor-styles",D.textContent=`
      body ${E} {
        cursor: crosshair !important;
      }
    ...
    `,document.head.appendChild(D),()=>{const T=document.getElementById("feedback-cursor-styles");T&&T.remove()}},[M]),b.useEffect(()=>{if(aa!==null&&M)return document.documentElement.setAttribute("data-drawing-hover",""),()=>document.documentElement.removeAttribute("data-drawing-hover")},[aa,M]),b.useEffect(()=>{if(!M||W||es||Ae)return;const S=E=>{const D=E.composedPath()[0]||E.target;if(us(D,"[data-feedback-toolbar]")){Se(null);return}const T=Qi(E.clientX,E.clientY);if(!T||us(T,"[data-feedback-toolbar]")){Se(null);return}const{name:$,elementName:K,path:ye,reactComponents:ve}=Pf(T,Vs),Ce=T.getBoundingClientRect();Se({element:$,elementName:K,elementPath:ye,rect:Ce,reactComponents:ve}),re({x:E.clientX,y:E.clientY})};return document.addEventListener("mousemove",S),()=>document.removeEventListener("mousemove",S)},[M,W,es,Ae,Vs,rn]);const _a=b.useCallback(S=>{var E;if(Me(S),Qe(null),pt(null),ut([]),(E=S.elementBoundingBoxes)!=null&&E.length){const D=[];for(const T of S.elementBoundingBoxes){const $=T.x+T.width/2,K=T.y+T.height/2-window.scrollY,ye=Qi($,K);ye&&D.push(ye)}Ye(D),Ve(null)}else if(S.boundingBox){const D=S.boundingBox,T=D.x+D.width/2,$=S.isFixed?D.y+D.height/2:D.y+D.height/2-window.scrollY,K=Qi(T,$);if(K){const ye=K.getBoundingClientRect(),ve=ye.width/D.width,Ce=ye.height/D.height;ve<.5||Ce<.5?Ve(null):Ve(K)}else Ve(null);Ye([])}else Ve(null),Ye([])},[]);b.useEffect(()=>{if(!M||es||Ae)return;const S=E=>{var qt,gn;if(ua.current){ua.current=!1;return}const D=E.composedPath()[0]||E.target;if(us(D,"[data-feedback-toolbar]")||us(D,"[data-annotation-popup]")||us(D,"[data-annotation-marker]"))return;if(E.metaKey&&E.shiftKey&&!W&&!V){E.preventDefault(),E.stopPropagation();const Dt=Qi(E.clientX,E.clientY);if(!Dt)return;const hn=Dt.getBoundingClientRect(),{name:ot,path:_t,reactComponents:an}=Pf(Dt,Vs),Qt=pn.findIndex(En=>En.element===Dt);Qt>=0?co(En=>En.filter((Wn,wn)=>wn!==Qt)):co(En=>[...En,{element:Dt,rect:hn,name:ot,path:_t,reactComponents:an??void 0}]);return}const T=us(D,"button, a, input, select, textarea, [role='button'], [onclick]");if(kt.blockInteractions&&T&&(E.preventDefault(),E.stopPropagation()),W){if(T&&!kt.blockInteractions)return;E.preventDefault(),(qt=kr.current)==null||qt.shake();return}if(V){if(T&&!kt.blockInteractions)return;E.preventDefault(),(gn=Cr.current)==null||gn.shake();return}E.preventDefault();const $=Qi(E.clientX,E.clientY);if(!$)return;const{name:K,path:ye,reactComponents:ve}=Pf($,Vs),Ce=$.getBoundingClientRect(),Ie=E.clientX/window.innerWidth*100,We=Uf($),at=We?E.clientY:E.clientY+window.scrollY,bt=window.getSelection();let Ke;bt&&bt.toString().trim().length>0&&(Ke=bt.toString().trim().slice(0,500));const we=Xc($),tn=Gc($);be({x:Ie,y:at,clientY:E.clientY,element:K,elementPath:ye,selectedText:Ke,boundingBox:{x:Ce.left,y:We?Ce.top:Ce.top+window.scrollY,width:Ce.width,height:Ce.height},nearbyText:er($),cssClasses:tr($),isFixed:We,fullPath:Wc($),accessibility:Fc($),computedStyles:tn,computedStylesObj:we,nearbyElements:Yc($),reactComponents:ve??void 0,sourceFile:Jc($),targetElement:$}),Se(null)};return document.addEventListener("click",S,!0),()=>document.removeEventListener("click",S,!0)},[M,es,Ae,W,V,kt.blockInteractions,Vs,pn]),b.useEffect(()=>{if(!M)return;const S=T=>{T.key==="Meta"&&(Fn.current.cmd=!0),T.key==="Shift"&&(Fn.current.shift=!0)},E=T=>{const $=Fn.current.cmd&&Fn.current.shift;T.key==="Meta"&&(Fn.current.cmd=!1),T.key==="Shift"&&(Fn.current.shift=!1);const K=Fn.current.cmd&&Fn.current.shift;$&&!K&&pn.length>0&&Tr()},D=()=>{Fn.current={cmd:!1,shift:!1},co([])};return document.addEventListener("keydown",S),document.addEventListener("keyup",E),window.addEventListener("blur",D),()=>{document.removeEventListener("keydown",S),document.removeEventListener("keyup",E),window.removeEventListener("blur",D)}},[M,pn,Tr]),b.useEffect(()=>{if(!M||W||es||Ae)return;const S=E=>{const D=E.composedPath()[0]||E.target;us(D,"[data-feedback-toolbar]")||us(D,"[data-annotation-marker]")||us(D,"[data-annotation-popup]")||new Set(["P","SPAN","H1","H2","H3","H4","H5","H6","LI","TD","TH","LABEL","BLOCKQUOTE","FIGCAPTION","CAPTION","LEGEND","DT","DD","PRE","CODE","EM","STRONG","B","I","U","S","A","TIME","ADDRESS","CITE","Q","ABBR","DFN","MARK","SMALL","SUB","SUP"]).has(D.tagName)||D.isContentEditable||(E.preventDefault(),_o.current={x:E.clientX,y:E.clientY})};return document.addEventListener("mousedown",S),()=>document.removeEventListener("mousedown",S)},[M,W,es,Ae]),b.useEffect(()=>{if(!M||W)return;const S=E=>{if(!_o.current)return;const D=E.clientX-_o.current.x,T=E.clientY-_o.current.y,$=D*D+T*T,K=ll*ll;if(!Zs&&$>=K&&(ts.current=_o.current,ca(!0),E.preventDefault()),(Zs||$>=K)&&ts.current){if(mo.current){const ot=Math.min(ts.current.x,E.clientX),_t=Math.min(ts.current.y,E.clientY),an=Math.abs(E.clientX-ts.current.x),Qt=Math.abs(E.clientY-ts.current.y);mo.current.style.transform=`translate(${ot}px, ${_t}px)`,mo.current.style.width=`${an}px`,mo.current.style.height=`${Qt}px`}const ye=Date.now();if(ye-Sr.current<Su)return;Sr.current=ye;const ve=ts.current.x,Ce=ts.current.y,Ie=Math.min(ve,E.clientX),We=Math.min(Ce,E.clientY),at=Math.max(ve,E.clientX),bt=Math.max(Ce,E.clientY),Ke=(Ie+at)/2,we=(We+bt)/2,tn=new Set,qt=[[Ie,We],[at,We],[Ie,bt],[at,bt],[Ke,we],[Ke,We],[Ke,bt],[Ie,we],[at,we]];for(const[ot,_t]of qt){const an=document.elementsFromPoint(ot,_t);for(const Qt of an)Qt instanceof HTMLElement&&tn.add(Qt)}const gn=document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th, div, span, section, article, aside, nav");for(const ot of gn)if(ot instanceof HTMLElement){const _t=ot.getBoundingClientRect(),an=_t.left+_t.width/2,Qt=_t.top+_t.height/2,En=an>=Ie&&an<=at&&Qt>=We&&Qt<=bt,Wn=Math.min(_t.right,at)-Math.max(_t.left,Ie),wn=Math.min(_t.bottom,bt)-Math.max(_t.top,We),Cs=Wn>0&&wn>0?Wn*wn:0,_s=_t.width*_t.height,Bs=_s>0?Cs/_s:0;(En||Bs>.5)&&tn.add(ot)}const Dt=[],hn=new Set(["BUTTON","A","INPUT","IMG","P","H1","H2","H3","H4","H5","H6","LI","LABEL","TD","TH","SECTION","ARTICLE","ASIDE","NAV"]);for(const ot of tn){if(us(ot,"[data-feedback-toolbar]")||us(ot,"[data-annotation-marker]"))continue;const _t=ot.getBoundingClientRect();if(!(_t.width>window.innerWidth*.8&&_t.height>window.innerHeight*.5)&&!(_t.width<10||_t.height<10)&&_t.left<at&&_t.right>Ie&&_t.top<bt&&_t.bottom>We){const an=ot.tagName;let Qt=hn.has(an);if(!Qt&&(an==="DIV"||an==="SPAN")){const En=ot.textContent&&ot.textContent.trim().length>0,Wn=ot.onclick!==null||ot.getAttribute("role")==="button"||ot.getAttribute("role")==="link"||ot.classList.contains("clickable")||ot.hasAttribute("data-clickable");(En||Wn)&&!ot.querySelector("p, h1, h2, h3, h4, h5, h6, button, a")&&(Qt=!0)}if(Qt){let En=!1;for(const Wn of Dt)if(Wn.left<=_t.left&&Wn.right>=_t.right&&Wn.top<=_t.top&&Wn.bottom>=_t.bottom){En=!0;break}En||Dt.push(_t)}}}if(Zo.current){const ot=Zo.current;for(;ot.children.length>Dt.length;)ot.removeChild(ot.lastChild);Dt.forEach((_t,an)=>{let Qt=ot.children[an];Qt||(Qt=document.createElement("div"),Qt.className=de.selectedElementHighlight,ot.appendChild(Qt)),Qt.style.transform=`translate(${_t.left}px, ${_t.top}px)`,Qt.style.width=`${_t.width}px`,Qt.style.height=`${_t.height}px`})}}};return document.addEventListener("mousemove",S,{passive:!0}),()=>document.removeEventListener("mousemove",S)},[M,W,Zs,ll]),b.useEffect(()=>{if(!M)return;const S=E=>{const D=Zs,T=ts.current;if(Zs&&T){ua.current=!0;const $=Math.min(T.x,E.clientX),K=Math.min(T.y,E.clientY),ye=Math.max(T.x,E.clientX),ve=Math.max(T.y,E.clientY),Ce=[];document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th").forEach(Ke=>{if(!(Ke instanceof HTMLElement)||us(Ke,"[data-feedback-toolbar]")||us(Ke,"[data-annotation-marker]"))return;const we=Ke.getBoundingClientRect();we.width>window.innerWidth*.8&&we.height>window.innerHeight*.5||we.width<10||we.height<10||we.left<ye&&we.right>$&&we.top<ve&&we.bottom>K&&Ce.push({element:Ke,rect:we})});const We=Ce.filter(({element:Ke})=>!Ce.some(({element:we})=>we!==Ke&&Ke.contains(we))),at=E.clientX/window.innerWidth*100,bt=E.clientY+window.scrollY;if(We.length>0){const Ke=We.reduce((hn,{rect:ot})=>({left:Math.min(hn.left,ot.left),top:Math.min(hn.top,ot.top),right:Math.max(hn.right,ot.right),bottom:Math.max(hn.bottom,ot.bottom)}),{left:1/0,top:1/0,right:-1/0,bottom:-1/0}),we=We.slice(0,5).map(({element:hn})=>Va(hn).name).join(", "),tn=We.length>5?` +${We.length-5} more`:"",qt=We[0].element,gn=Xc(qt),Dt=Gc(qt);be({x:at,y:bt,clientY:E.clientY,element:`${We.length} elements: ${we}${tn}`,elementPath:"multi-select",boundingBox:{x:Ke.left,y:Ke.top+window.scrollY,width:Ke.right-Ke.left,height:Ke.bottom-Ke.top},isMultiSelect:!0,fullPath:Wc(qt),accessibility:Fc(qt),computedStyles:Dt,computedStylesObj:gn,nearbyElements:Yc(qt),cssClasses:tr(qt),nearbyText:er(qt),sourceFile:Jc(qt)})}else{const Ke=Math.abs(ye-$),we=Math.abs(ve-K);Ke>20&&we>20&&be({x:at,y:bt,clientY:E.clientY,element:"Area selection",elementPath:`region at (${Math.round($)}, ${Math.round(K)})`,boundingBox:{x:$,y:K+window.scrollY,width:Ke,height:we},isMultiSelect:!0})}Se(null)}else D&&(ua.current=!0);_o.current=null,ts.current=null,ca(!1),Zo.current&&(Zo.current.innerHTML="")};return document.addEventListener("mouseup",S),()=>document.removeEventListener("mouseup",S)},[M,Zs]);const zs=b.useCallback(async(S,E,D)=>{const T=kt.webhookUrl||C;if(!T||!kt.webhooksEnabled&&!D)return!1;try{return(await fetch(T,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:S,timestamp:Date.now(),url:typeof window<"u"?window.location.href:void 0,...E})})).ok}catch($){return console.warn("[Agentation] Webhook failed:",$),!1}},[C,kt.webhookUrl,kt.webhooksEnabled]),Cu=b.useCallback(S=>{var D;if(!W)return;const E={id:Date.now().toString(),x:W.x,y:W.y,comment:S,element:W.element,elementPath:W.elementPath,timestamp:Date.now(),selectedText:W.selectedText,boundingBox:W.boundingBox,nearbyText:W.nearbyText,cssClasses:W.cssClasses,isMultiSelect:W.isMultiSelect,isFixed:W.isFixed,fullPath:W.fullPath,accessibility:W.accessibility,computedStyles:W.computedStyles,nearbyElements:W.nearbyElements,reactComponents:W.reactComponents,sourceFile:W.sourceFile,elementBoundingBoxes:W.elementBoundingBoxes,...p&&on?{sessionId:on,url:typeof window<"u"?window.location.href:void 0,status:"pending"}:{}};J(T=>[...T,E]),da.current=E.id,tt(()=>{da.current=null},300),tt(()=>{ho(T=>new Set(T).add(E.id))},250),l==null||l(E),zs("annotation.add",{annotation:E}),Os(!0),tt(()=>{be(null),Os(!1)},150),(D=window.getSelection())==null||D.removeAllRanges(),p&&on&&Ga(p,on,E).then(T=>{T.id!==E.id&&(J($=>$.map(K=>K.id===E.id?{...K,id:T.id}:K)),ho($=>{const K=new Set($);return K.delete(E.id),K.add(T.id),K}))}).catch(T=>{console.warn("[Agentation] Failed to sync annotation:",T)})},[W,l,zs,p,on]),dl=b.useCallback(()=>{Os(!0),tt(()=>{be(null),Os(!1)},150)},[]),fl=b.useCallback(S=>{const E=B.findIndex(T=>T.id===S),D=B[E];(V==null?void 0:V.id)===S&&(Ls(!0),tt(()=>{Me(null),Ve(null),Ye([]),Ls(!1)},150)),dn(S),Di(T=>new Set(T).add(S)),D&&(c==null||c(D),zs("annotation.delete",{annotation:D})),p&&ki(p,S).catch(T=>{console.warn("[Agentation] Failed to delete annotation from server:",T)}),tt(()=>{J(T=>T.filter($=>$.id!==S)),Di(T=>{const $=new Set(T);return $.delete(S),$}),dn(null),E<B.length-1&&(mn(E),tt(()=>mn(null),200))},150)},[B,V,c,zs,p]),ma=b.useCallback(S=>{var E;if(!S){Qe(null),pt(null),ut([]);return}if(Qe(S.id),(E=S.elementBoundingBoxes)!=null&&E.length){const D=[];for(const T of S.elementBoundingBoxes){const $=T.x+T.width/2,K=T.y+T.height/2-window.scrollY,ve=document.elementsFromPoint($,K).find(Ce=>!Ce.closest("[data-annotation-marker]")&&!Ce.closest("[data-agentation-root]"));ve&&D.push(ve)}ut(D),pt(null)}else if(S.boundingBox){const D=S.boundingBox,T=D.x+D.width/2,$=S.isFixed?D.y+D.height/2:D.y+D.height/2-window.scrollY,K=Qi(T,$);if(K){const ye=K.getBoundingClientRect(),ve=ye.width/D.width,Ce=ye.height/D.height;ve<.5||Ce<.5?pt(null):pt(K)}else pt(null);ut([])}else pt(null),ut([])},[]),ju=b.useCallback(S=>{if(!V)return;const E={...V,comment:S};J(D=>D.map(T=>T.id===V.id?E:T)),u==null||u(E),zs("annotation.update",{annotation:E}),p&&S0(p,V.id,{comment:S}).catch(D=>{console.warn("[Agentation] Failed to update annotation on server:",D)}),Ls(!0),tt(()=>{Me(null),Ve(null),Ye([]),Ls(!1)},150)},[V,u,zs,p]),hl=b.useCallback(()=>{Ls(!0),tt(()=>{Me(null),Ve(null),Ye([]),Ls(!1)},150)},[]),ks=b.useCallback(()=>{const S=B.length,E=Re.length>0||!!Ee;if(S===0&&rn.length===0&&!E)return;if(_==null||_(B),zs("annotations.clear",{annotations:B}),p){Promise.all(B.map($=>ki(p,$.id).catch(K=>{console.warn("[Agentation] Failed to delete annotation from server:",K)})));for(const[,$]of Wo.current)$&&ki(p,$).catch(()=>{});Wo.current.clear();for(const[,$]of Ti.current)$&&ki(p,$).catch(()=>{});Ti.current.clear()}dt(!0),qe(!0),gr([]);const D=qo.current;if(D){const $=D.getContext("2d");$&&$.clearRect(0,0,D.width,D.height)}(Re.length>0||Ee)&&(ao($=>$+1),nl($=>$+1),tt(()=>{yt([]),Jn(null)},200)),Ge&&Lt(!1),ln&&Dn(""),io.current={rearrange:null,placements:[]},Vc(et);const T=S*30+200;tt(()=>{J([]),ho(new Set),localStorage.removeItem(mu(et)),dt(!1)},T),tt(()=>qe(!1),1500)},[et,B,rn,Re,Ee,Ge,ln,_,zs,p]),_l=b.useCallback(async()=>{const S=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:et,E=Ae&&Ge;let D;if(E){if(Re.length===0&&!Ee&&!ln)return;D=""}else{if(D=j0(B,S,kt.outputDetail),!D&&rn.length===0&&Re.length===0&&!Ee)return;D||(D=`## Page Feedback: ${S}
`)}if(!E&&rn.length>0){const T=new Set;for(const ve of B)ve.drawingIndex!=null&&T.add(ve.drawingIndex);const $=qo.current;$&&($.style.visibility="hidden");const K=[],ye=window.scrollY;for(let ve=0;ve<rn.length;ve++){if(T.has(ve))continue;const Ce=rn[ve];if(Ce.points.length<2)continue;const Ie=Ce.fixed?Ce.points:Ce.points.map(yn=>({x:yn.x,y:yn.y-ye}));let We=1/0,at=1/0,bt=-1/0,Ke=-1/0;for(const yn of Ie)We=Math.min(We,yn.x),at=Math.min(at,yn.y),bt=Math.max(bt,yn.x),Ke=Math.max(Ke,yn.y);const we=bt-We,tn=Ke-at,qt=Math.hypot(we,tn),gn=Ie[0],Dt=Ie[Ie.length-1],hn=Math.hypot(Dt.x-gn.x,Dt.y-gn.y);let ot;const _t=hn<qt*.35,an=we/Math.max(tn,1);if(_t&&qt>20){const yn=Math.max(we,tn)*.15;let ns=0;for(const go of Ie){const Lr=go.x-We<yn,zr=bt-go.x<yn,Eu=go.y-at<yn,Mu=Ke-go.y<yn;(Lr||zr)&&(Eu||Mu)&&ns++}ot=ns>Ie.length*.15?"box":"circle"}else an>3&&tn<40?ot="underline":hn>qt*.5?ot="arrow":ot="drawing";const Qt=Math.min(10,Ie.length),En=Math.max(1,Math.floor(Ie.length/Qt)),Wn=new Set,wn=[],Cs=[gn];for(let yn=En;yn<Ie.length-1;yn+=En)Cs.push(Ie[yn]);Cs.push(Dt);for(const yn of Cs){const ns=Qi(yn.x,yn.y);if(!ns||Wn.has(ns)||us(ns,"[data-feedback-toolbar]"))continue;Wn.add(ns);const{name:go}=Va(ns);wn.includes(go)||wn.push(go)}const _s=`${Math.round(We)},${Math.round(at)} → ${Math.round(bt)},${Math.round(Ke)}`;let Bs;(ot==="circle"||ot==="box")&&wn.length>0?Bs=`${ot==="box"?"Boxed":"Circled"} **${wn[0]}**${wn.length>1?` (and ${wn.slice(1).join(", ")})`:""} (region: ${_s})`:ot==="underline"&&wn.length>0?Bs=`Underlined **${wn[0]}** (${_s})`:ot==="arrow"&&wn.length>=2?Bs=`Arrow from **${wn[0]}** to **${wn[wn.length-1]}** (${Math.round(gn.x)},${Math.round(gn.y)} → ${Math.round(Dt.x)},${Math.round(Dt.y)})`:wn.length>0?Bs=`${ot==="arrow"?"Arrow":"Drawing"} near **${wn.join("**, **")}** (region: ${_s})`:Bs=`Drawing at ${_s}`,K.push(Bs)}$&&($.style.visibility=""),K.length>0&&(D+=`
**Drawings:**
`,K.forEach((ve,Ce)=>{D+=`${Ce+1}. ${ve}
...
`+T)}h&&h(E,B),pe("sending"),await new Promise(T=>tt(T,150));const D=await zs("submit",{output:E,annotations:B},!0);pe(D?"sent":"failed"),tt(()=>pe("idle"),2500),D&&kt.autoClearAfterCopy&&tt(()=>ks(),500)},[h,zs,B,Re,Ee,Ge,vs,et,kt.outputDetail,Vs,kt.autoClearAfterCopy,ks]);b.useEffect(()=>{if(!rs)return;const S=10,E=T=>{const $=T.clientX-rs.x,K=T.clientY-rs.y,ye=Math.sqrt($*$+K*K);if(!Ks&&ye>S&&Vo(!0),Ks||ye>S){let ve=rs.toolbarX+$,Ce=rs.toolbarY+K;const Ie=20,We=337,at=44,Ke=We-(M?ls==="connected"?297:257:44),we=Ie-Ke,tn=window.innerWidth-Ie-We;ve=Math.max(we,Math.min(tn,ve)),Ce=Math.max(Ie,Math.min(window.innerHeight-at-Ie,Ce)),Ss({x:ve,y:Ce})}},D=()=>{Ks&&(Ko.current=!0),Vo(!1),la(null)};return document.addEventListener("mousemove",E),document.addEventListener("mouseup",D),()=>{document.removeEventListener("mousemove",E),document.removeEventListener("mouseup",D)}},[rs,Ks,M,ls]);const Rr=b.useCallback(S=>{if(S.target.closest("button")||S.target.closest("[data-agentation-settings-panel]"))return;const E=S.currentTarget.parentElement;if(!E)return;const D=E.getBoundingClientRect(),T=(Bt==null?void 0:Bt.x)??D.left,$=(Bt==null?void 0:Bt.y)??D.top;la({x:S.clientX,y:S.clientY,toolbarX:T,toolbarY:$})},[Bt]);if(b.useEffect(()=>{if(!Bt)return;const S=()=>{let $=Bt.x,K=Bt.y;const Ce=20-(337-(M?ls==="connected"?297:257:44)),Ie=window.innerWidth-20-337;$=Math.max(Ce,Math.min(Ie,$)),K=Math.max(20,Math.min(window.innerHeight-44-20,K)),($!==Bt.x||K!==Bt.y)&&Ss({x:$,y:K})};return S(),window.addEventListener("resize",S),()=>window.removeEventListener("resize",S)},[Bt,M,ls]),b.useEffect(()=>{const S=E=>{const D=E.target,T=D.tagName==="INPUT"||D.tagName==="TEXTAREA"||D.isContentEditable;if(E.key==="Escape"){if(Ae){xt?ht(null):ha();return}if(es){ws(!1);return}if(pn.length>0){co([]);return}W||M&&(Un(),L(!1))}if((E.metaKey||E.ctrlKey)&&E.shiftKey&&(E.key==="f"||E.key==="F")){E.preventDefault(),Un(),M?Er():L(!0);return}if(!(T||E.metaKey||E.ctrlKey)&&((E.key==="p"||E.key==="P")&&(E.preventDefault(),Un(),ul()),(E.key==="l"||E.key==="L")&&(E.preventDefault(),Un(),es&&ws(!1),le&&Oe(!1),W&&dl(),Ae?ha():wt(!0)),(E.key==="h"||E.key==="H")&&B.length>0&&(E.preventDefault(),Un(),z($=>!$)),(E.key==="c"||E.key==="C")&&(B.length>0||Re.length>0||Ee)&&(E.preventDefault(),Un(),_l()),(E.key==="x"||E.key==="X")&&(B.length>0||Re.length>0||Ee)&&(E.preventDefault(),Un(),ks(),Re.length>0&&yt([]),Ee&&Jn(null)),E.key==="s"||E.key==="S")){const $=wo(kt.webhookUrl)||wo(C||"");B.length>0&&$&&Z==="idle"&&(E.preventDefault(),Un(),pa())}};return document.addEventListener("keydown",S),()=>document.removeEventListener("keydown",S)},[M,es,Ae,xt,Re,Ee,W,B.length,kt.webhookUrl,C,Z,pa,ul,_l,ks,pn]),!Be||ue)return null;const Jo=B.length>0,Co=B.filter(S=>!Ai.has(S.id)&&S.kind!=="placement"&&S.kind!=="rearrange"),Ar=Co.length>0,jo=B.filter(S=>Ai.has(S.id)),Dr=S=>{const K=S.x/100*window.innerWidth,ye=typeof S.y=="string"?parseFloat(S.y):S.y,ve={};window.innerHeight-ye-22-10<80&&(ve.top="auto",ve.bottom="calc(100% + 10px)");const Ie=K-200/2,We=10;if(Ie<We){const at=We-Ie;ve.left=`calc(50% + ${at}px)`}else if(Ie+200>window.innerWidth-We){const at=Ie+200-(window.innerWidth-We);ve.left=`calc(50% - ${at}px)`}return ve};return eg.createPortal(r.jsxs("div",{ref:he,style:{display:"contents"},"data-agentation-theme":hs?"dark":"light","data-agentation-accent":kt.annotationColorId,"data-agentation-root":"",children:[r.jsx("div",{className:`${de.toolbar}${k?` ${k}`:""}`,"data-feedback-toolbar":!0,"data-agentation-toolbar":!0,style:Bt?{left:Bt.x,top:Bt.y,right:"auto",bottom:"auto"}:void 0,children:r.jsxs("div",{className:`${de.toolbarContainer} ${M?de.expanded:de.collapsed} ${wr?de.entrance:""} ${Y?de.hiding:""} ${!kt.webhooksEnabled&&(wo(kt.webhookUrl)||wo(C||""))?de.serverConnected:""}`,onClick:M?void 0:S=>{if(Ko.current){Ko.current=!1,S.preventDefault();return}L(!0)},onMouseDown:Rr,role:M?void 0:"button",tabIndex:M?-1:0,title:M?void 0:"Start feedback mode",children:[r.jsxs("div",{className:`${de.toggleContent} ${M?de.hidden:de.visible}`,children:[r.jsx(t2,{size:24}),Ar&&r.jsx("span",{className:`${de.badge} ${M?de.fadeOut:""} ${wr?de.entrance:""}`,children:Co.length})]}),r.jsxs("div",{className:`${de.controlsContent} ${M?de.visible:de.hidden} ${Bt&&Bt.y<100?de.tooltipBelow:""} ${jt||le?de.tooltipsHidden:""} ${yr?de.tooltipsInSession:""}`,onMouseEnter:Qo,onMouseLeave:wu,children:[r.jsxs("div",{className:`${de.buttonWrapper} ${Bt&&Bt.x<120?de.buttonWrapperAlignLeft:""}`,children:[r.jsx("button",{className:de.controlButton,onClick:S=>{S.stopPropagation(),Un(),ul()},"data-active":X,children:r.jsx(a2,{size:24,isPaused:X})}),r.jsxs("span",{className:de.buttonTooltip,children:[X?"Resume animations":"Pause animations",r.jsx("span",{className:de.shortcut,children:"P"})]})]}),r.jsxs("div",{className:de.buttonWrapper,children:[r.jsx("button",{className:`${de.controlButton} ${hs?"":de.light}`,onClick:S=>{S.stopPropagation(),Un(),es&&ws(!1),le&&Oe(!1),W&&dl(),Ae?ha():wt(!0)},"data-active":Ae,style:Ae&&Ge?{color:"#f97316",background:"rgba(249, 115, 22, 0.25)"}:void 0,children:r.jsx(m2,{size:21})}),r.jsxs("span",{className:de.buttonTooltip,children:[Ae?"Exit layout mode":"Layout mode",r.jsx("span",{className:de.shortcut,children:"L"})]})]}),r.jsxs("div",{className:de.buttonWrapper,children:[r.jsx("button",{className:de.controlButton,onClick:S=>{S.stopPropagation(),Un(),z(!F)},disabled:!Jo||Ae,children:r.jsx(i2,{size:24,isOpen:F})}),r.jsxs("span",{className:de.buttonTooltip,children:[F?"Hide markers":"Show markers",r.jsx("span",{className:de.shortcut,children:"H"})]})]}),r.jsxs("div",{className:de.buttonWrapper,children:[r.jsx("button",{className:`${de.controlButton} ${De?de.statusShowing:""}`,onClick:S=>{S.stopPropagation(),Un(),_l()},disabled:Ae&&Ge?Re.length===0&&!((Nr=Ee==null?void 0:Ee.sections)!=null&&Nr.length):!Jo&&rn.length===0&&Re.length===0&&!((Or=Ee==null?void 0:Ee.sections)!=null&&Or.length),"data-active":De,children:r.jsx(s2,{size:24,copied:De,tint:Ae&&Ge&&(Re.length>0||(ml=Ee==null?void 0:Ee.sections)!=null&&ml.length)?"#f97316":void 0})}),r.jsxs("span",{className:de.buttonTooltip,children:[Ae&&Ge?"Copy layout":"Copy feedback",r.jsx("span",{className:de.shortcut,children:"C"})]})]}),r.jsxs("div",{className:`${de.buttonWrapper} ${de.sendButtonWrapper} ${M&&!kt.webhooksEnabled&&(wo(kt.webhookUrl)||wo(C||""))?de.sendButtonVisible:""}`,children:[r.jsxs("button",{className:`${de.controlButton} ${Z==="sent"||Z==="failed"?de.statusShowing:""}`,onClick:S=>{S.stopPropagation(),Un(),pa()},disabled:!Jo||!wo(kt.webhookUrl)&&!wo(C||"")||Z==="sending","data-no-hover":Z==="sent"||Z==="failed",tabIndex:wo(kt.webhookUrl)||wo(C||"")?0:-1,children:[r.jsx(o2,{size:24,state:Z}),Jo&&Z==="idle"&&r.jsx("span",{className:de.buttonBadge,children:B.length})]}),r.jsxs("span",{className:de.buttonTooltip,children:["Send Annotations",r.jsx("span",{className:de.shortcut,children:"S"})]})]}),r.jsxs("div",{className:de.buttonWrapper,children:[r.jsx("button",{className:de.controlButton,onClick:S=>{S.stopPropagation(),Un(),ks()},disabled:!Jo&&rn.length===0&&Re.length===0&&!((pl=Ee==null?void 0:Ee.sections)!=null&&pl.length),"data-danger":!0,children:r.jsx(r2,{size:24})}),r.jsxs("span",{className:de.buttonTooltip,children:["Clear all",r.jsx("span",{className:de.shortcut,children:"X"})]})]}),r.jsxs("div",{className:de.buttonWrapper,children:[r.jsx("button",{className:de.controlButton,onClick:S=>{S.stopPropagation(),Un(),Ae&&ha(),Oe(!le)},children:r.jsx(l2,{size:24})}),p&&ls!=="disconnected"&&r.jsx("span",{className:`${de.mcpIndicator} ${de[ls]} ${le?de.hidden:""}`,title:ls==="connected"?"MCP Connected":"MCP Connecting..."}),r.jsx("span",{className:de.buttonTooltip,children:"Settings"})]}),r.jsx("div",{className:de.divider}),r.jsxs("div",{className:`${de.buttonWrapper} ${Bt&&typeof window<"u"&&Bt.x>window.innerWidth-120?de.buttonWrapperAlignRight:""}`,children:[r.jsx("button",{className:de.controlButton,onClick:S=>{S.stopPropagation(),Un(),Er()},children:r.jsx(c2,{size:24})}),r.jsxs("span",{className:de.buttonTooltip,children:["Exit",r.jsx("span",{className:de.shortcut,children:"Esc"})]})]})]}),r.jsx(Xv,{visible:Ae&&M,activeType:xt,onSelect:S=>{ht(xt===S?null:S)},isDarkMode:hs,sectionCount:(Ee==null?void 0:Ee.sections.length)??0,onDetectSections:()=>{const S=tw(),E=(Ee==null?void 0:Ee.sections)??[],D=new Set(E.map(ye=>ye.selector)),T=S.filter(ye=>!D.has(ye.selector)),$=[...E,...T],K=[...(Ee==null?void 0:Ee.originalOrder)??[],...T.map(ye=>ye.id)];Jn({sections:$,originalOrder:K,detectedAt:Date.now()})},placementCount:Re.length,onClearPlacements:()=>{ao(S=>S+1),nl(S=>S+1),tt(()=>{Jn({sections:[],originalOrder:[],detectedAt:Date.now()})},200)},blankCanvas:Ge,onBlankCanvasChange:S=>{const E={sections:[],originalOrder:[],detectedAt:Date.now()};S?(tl.current={rearrange:Ee,placements:Re},Jn(io.current.rearrange||E),yt(io.current.placements),ht(null)):(io.current={rearrange:Ee,placements:Re},Jn(tl.current.rearrange||E),yt(tl.current.placements)),Lt(S)},wireframePurpose:ln,onWireframePurposeChange:Dn,Tooltip:Ki,onDragStart:(S,E)=>{E.preventDefault();const D=Ne[S];let T=null,$=!1;const K=E.clientX,ye=E.clientY,ve=E.target.closest("[data-feedback-toolbar]"),Ce=(ve==null?void 0:ve.getBoundingClientRect().top)??window.innerHeight,Ie=at=>{const bt=at.clientX-K,Ke=at.clientY-ye;if(!$&&(Math.abs(bt)>4||Math.abs(Ke)>4)&&($=!0,T=document.createElement("div"),T.className=`${ne.dragPreview}${Ge?` ${ne.dragPreviewWireframe}`:""}`,document.body.appendChild(T)),!T)return;const we=Math.max(0,Ce-at.clientY),tn=Math.min(1,we/180),qt=1-Math.pow(1-tn,2),gn=28,Dt=20,hn=Math.min(140,D.width*.18),ot=Math.min(90,D.height*.18),_t=gn+(hn-gn)*qt,an=Dt+(ot-Dt)*qt;T.style.width=`${_t}px`,T.style.height=`${an}px`,T.style.left=`${at.clientX-_t/2}px`,T.style.top=`${at.clientY-an/2}px`,T.style.opacity=`${.5+.5*qt}`,T.textContent=qt>.25?S:""},We=at=>{if(window.removeEventListener("mousemove",Ie),window.removeEventListener("mouseup",We),T&&document.body.removeChild(T),$){const bt=D.width,Ke=D.height,we=window.scrollY,tn=Math.max(0,at.clientX-bt/2),qt=Math.max(0,at.clientY+we-Ke/2),gn={id:`dp-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,type:S,x:tn,y:qt,width:bt,height:Ke,scrollY:we,timestamp:Date.now()};yt(Dt=>[...Dt,gn]),ht(null),Fo.current=new Set,oa(Dt=>Dt+1)}};window.addEventListener("mousemove",Ie),window.addEventListener("mouseup",We)}}),r.jsx(u4,{settings:kt,onSettingsChange:S=>br(E=>({...E,...S})),isDarkMode:hs,onToggleTheme:Qs,isDevMode:ol,connectionStatus:ls,endpoint:p,isVisible:ke,toolbarNearBottom:!!Bt&&Bt.y<230,settingsPage:it,onSettingsPageChange:ft,onHideToolbar:ku})]})}),(Ae||Et)&&r.jsx("div",{className:`${ne.blankCanvas} ${vn?ne.visible:""} ${Yt?ne.gridActive:""}`,style:{"--canvas-opacity":In},"data-feedback-toolbar":!0}),Ae&&Ge&&vn&&r.jsxs("div",{className:ne.wireframeNotice,"data-feedback-toolbar":!0,children:[r.jsxs("div",{className:ne.wireframeOpacityRow,children:[r.jsx("span",{className:ne.wireframeOpacityLabel,children:"Toggle Opacity"}),r.jsx("input",{type:"range",className:ne.wireframeOpacitySlider,min:0,max:1,step:.01,value:In,onChange:S=>oo(Number(S.target.value))})]}),r.jsxs("div",{className:ne.wireframeNoticeTitleRow,children:[r.jsx("span",{className:ne.wireframeNoticeTitle,children:"Wireframe Mode"}),r.jsx("span",{className:ne.wireframeNoticeDivider}),r.jsx("button",{className:ne.wireframeStartOver,onClick:()=>{ao(S=>S+1),Jn({sections:[],originalOrder:[],detectedAt:Date.now()}),io.current={rearrange:null,placements:[]},Dn(""),Vc(et)},children:"Start Over"})]}),"Drag components onto the canvas.",r.jsx("br",{}),"Copied output will only include the wireframed layout."]}),(Ae||Et)&&r.jsx(Pv,{placements:Re,onChange:yt,activeComponent:Et?null:xt,onActiveComponentChange:ht,isDarkMode:hs,exiting:Et,onInteractionChange:jn,passthrough:!xt,extraSnapRects:Ee==null?void 0:Ee.sections.map(S=>S.currentRect),deselectSignal:Ei,clearSignal:Mi,wireframe:Ge,onSelectionChange:(S,E)=>{Fo.current=S,E||(Ns.current=new Set,Go(D=>D+1))},onDragMove:(S,E)=>{const D=Ns.current;if(!(!D.size||!Ee)){if(!Xn.current){Xn.current=new Map;for(const T of Ee.sections)D.has(T.id)&&Xn.current.set(T.id,{x:T.currentRect.x,y:T.currentRect.y})}for(const T of Ee.sections){if(!D.has(T.id)||!Xn.current.get(T.id))continue;const K=document.querySelector(`[data-rearrange-section="${T.id}"]`);K&&(K.style.transform=`translate(${S}px, ${E}px)`)}}},onDragEnd:(S,E,D)=>{const T=Ns.current,$=Xn.current;if(Xn.current=null,!(!T.size||!Ee||!$)){for(const K of T){const ye=document.querySelector(`[data-rearrange-section="${K}"]`);ye&&(ye.style.transform="")}D&&Jn(K=>K&&{...K,sections:K.sections.map(ye=>{const ve=$.get(ye.id);return ve?{...ye,currentRect:{...ye.currentRect,x:Math.max(0,ve.x+S),y:Math.max(0,ve.y+E)}}:ye})})}}}),(Ae||Et)&&Ee&&r.jsx(ow,{rearrangeState:Ee,onChange:Jn,isDarkMode:hs,exiting:Et,blankCanvas:Ge,extraSnapRects:Re.map(S=>({x:S.x,y:S.y,width:S.width,height:S.height})),clearSignal:Nn,deselectSignal:Xo,onSelectionChange:(S,E)=>{Ns.current=S,E||(Fo.current=new Set,oa(D=>D+1))},onDragMove:(S,E)=>{const D=Fo.current;if(D.size){if(!Xn.current){Xn.current=new Map;for(const T of Re)D.has(T.id)&&Xn.current.set(T.id,{x:T.x,y:T.y})}for(const T of D){const $=document.querySelector(`[data-design-placement="${T}"]`);$&&($.style.transform=`translate(${S}px, ${E}px)`)}}},onDragEnd:(S,E,D)=>{const T=Fo.current,$=Xn.current;if(Xn.current=null,!(!T.size||!$)){for(const K of T){const ye=document.querySelector(`[data-design-placement="${K}"]`);ye&&(ye.style.transform="")}D&&yt(K=>K.map(ye=>{const ve=$.get(ye.id);return ve?{...ye,x:Math.max(0,ve.x+S),y:Math.max(0,ve.y+E)}:ye}))}}}),r.jsx("canvas",{ref:qo,className:`${de.drawCanvas} ${es?de.active:""}`,style:{opacity:rl?1:0,transition:"opacity 0.15s ease"},"data-feedback-toolbar":!0}),r.jsxs("div",{className:de.markersLayer,"data-feedback-toolbar":!0,children:[_e&&Co.filter(S=>!S.isFixed).map((S,E,D)=>r.jsx(E0,{annotation:S,globalIndex:Co.findIndex(T=>T.id===S.id),layerIndex:E,layerSize:D.length,isExiting:Q,isClearing:rt,isAnimated:al.has(S.id),isHovered:!Q&&en===S.id,isDeleting:At===S.id,isEditingAny:!!V,renumberFrom:bn,markerClickBehavior:kt.markerClickBehavior,tooltipStyle:Dr(S),onHoverEnter:T=>!Q&&T.id!==da.current&&ma(T),onHoverLeave:()=>ma(null),onClick:T=>kt.markerClickBehavior==="delete"?fl(T.id):_a(T),onContextMenu:_a},S.id)),_e&&!Q&&jo.filter(S=>!S.isFixed).map(S=>r.jsx(M0,{annotation:S},S.id))]}),r.jsxs("div",{className:de.fixedMarkersLayer,"data-feedback-toolbar":!0,children:[_e&&Co.filter(S=>S.isFixed).map((S,E,D)=>r.jsx(E0,{annotation:S,globalIndex:Co.findIndex(T=>T.id===S.id),layerIndex:E,layerSize:D.length,isExiting:Q,isClearing:rt,isAnimated:al.has(S.id),isHovered:!Q&&en===S.id,isDeleting:At===S.id,isEditingAny:!!V,renumberFrom:bn,markerClickBehavior:kt.markerClickBehavior,tooltipStyle:Dr(S),onHoverEnter:T=>!Q&&T.id!==da.current&&ma(T),onHoverLeave:()=>ma(null),onClick:T=>kt.markerClickBehavior==="delete"?fl(T.id):_a(T),onContextMenu:_a},S.id)),_e&&!Q&&jo.filter(S=>S.isFixed).map(S=>r.jsx(M0,{annotation:S,fixed:!0},S.id))]}),M&&r.jsxs("div",{className:de.overlay,"data-feedback-toolbar":!0,style:W||V?{zIndex:99999}:void 0,children:[(fe==null?void 0:fe.rect)&&!W&&!St&&!Zs&&r.jsx("div",{className:`${de.hoverHighlight} ${de.enter}`,style:{left:fe.rect.left,top:fe.rect.top,width:fe.rect.width,height:fe.rect.height,borderColor:"color-mix(in srgb, var(--agentation-color-accent) 50%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 4%, transparent)"}}),pn.filter(S=>document.contains(S.element)).map((S,E)=>{const D=S.element.getBoundingClientRect(),T=pn.length>1;return r.jsx("div",{className:T?de.multiSelectOutline:de.singleSelectOutline,style:{position:"fixed",left:D.left,top:D.top,width:D.width,height:D.height,...T?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}},E)}),en&&!W&&(()=>{var $;const S=B.find(K=>K.id===en);if(!(S!=null&&S.boundingBox))return null;if(($=S.elementBoundingBoxes)!=null&&$.length)return Je.length>0?Je.filter(K=>document.contains(K)).map((K,ye)=>{const ve=K.getBoundingClientRect();return r.jsx("div",{className:`${de.multiSelectOutline} ${de.enter}`,style:{left:ve.left,top:ve.top,width:ve.width,height:ve.height}},`hover-outline-live-${ye}`)}):S.elementBoundingBoxes.map((K,ye)=>r.jsx("div",{className:`${de.multiSelectOutline} ${de.enter}`,style:{left:K.x,top:K.y-Te,width:K.width,height:K.height}},`hover-outline-${ye}`));const E=Pe&&document.contains(Pe)?Pe.getBoundingClientRect():null,D=E?{x:E.left,y:E.top,width:E.width,height:E.height}:{x:S.boundingBox.x,y:S.isFixed?S.boundingBox.y:S.boundingBox.y-Te,width:S.boundingBox.width,height:S.boundingBox.height},T=S.isMultiSelect;return r.jsx("div",{className:`${T?de.multiSelectOutline:de.singleSelectOutline} ${de.enter}`,style:{left:D.x,top:D.y,width:D.width,height:D.height,...T?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}})})(),fe&&!W&&!St&&!Zs&&r.jsxs("div",{className:`${de.hoverTooltip} ${de.enter}`,style:{left:Math.max(8,Math.min(N.x,window.innerWidth-100)),top:Math.max(N.y-(fe.reactComponents?48:32),8)},children:[fe.reactComponents&&r.jsx("div",{className:de.hoverReactPath,children:fe.reactComponents}),r.jsx("div",{className:de.hoverElementName,children:fe.elementName})]}),W&&r.jsxs(r.Fragment,{children:[(ei=W.multiSelectElements)!=null&&ei.length?W.multiSelectElements.filter(S=>document.contains(S)).map((S,E)=>{const D=S.getBoundingClientRect();return r.jsx("div",{className:`${de.multiSelectOutline} ${On?de.exit:de.enter}`,style:{left:D.left,top:D.top,width:D.width,height:D.height}},`pending-multi-${E}`)}):W.targetElement&&document.contains(W.targetElement)?(()=>{const S=W.targetElement.getBoundingClientRect();return r.jsx("div",{className:`${de.singleSelectOutline} ${On?de.exit:de.enter}`,style:{left:S.left,top:S.top,width:S.width,height:S.height,borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}})})():W.boundingBox&&r.jsx("div",{className:`${W.isMultiSelect?de.multiSelectOutline:de.singleSelectOutline} ${On?de.exit:de.enter}`,style:{left:W.boundingBox.x,top:W.boundingBox.y-Te,width:W.boundingBox.width,height:W.boundingBox.height,...W.isMultiSelect?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}}),(()=>{const S=W.x,E=W.isFixed?W.y:W.y-Te;return r.jsxs(r.Fragment,{children:[r.jsx(e4,{x:S,y:E,isMultiSelect:W.isMultiSelect,isExiting:On}),r.jsx(hu,{ref:kr,element:W.element,selectedText:W.selectedText,computedStyles:W.computedStylesObj,placeholder:W.element==="Area selection"?"What should change in this area?":W.isMultiSelect?"Feedback for this group of elements...":"What should change?",onSubmit:Cu,onCancel:dl,isExiting:On,lightMode:!hs,accentColor:W.isMultiSelect?"var(--agentation-color-green)":"var(--agentation-color-accent)",style:{left:Math.max(160,Math.min(window.innerWidth-160,S/100*window.innerWidth)),...E>window.innerHeight-290?{bottom:window.innerHeight-E+20}:{top:E+20}}})]})})()]}),V&&r.jsxs(r.Fragment,{children:[(ti=V.elementBoundingBoxes)!=null&&ti.length?nt.length>0?nt.filter(S=>document.contains(S)).map((S,E)=>{const D=S.getBoundingClientRect();return r.jsx("div",{className:`${de.multiSelectOutline} ${de.enter}`,style:{left:D.left,top:D.top,width:D.width,height:D.height}},`edit-multi-live-${E}`)}):V.elementBoundingBoxes.map((S,E)=>r.jsx("div",{className:`${de.multiSelectOutline} ${de.enter}`,style:{left:S.x,top:S.y-Te,width:S.width,height:S.height}},`edit-multi-${E}`)):(()=>{const S=Fe&&document.contains(Fe)?Fe.getBoundingClientRect():null,E=S?{x:S.left,y:S.top,width:S.width,height:S.height}:V.boundingBox?{x:V.boundingBox.x,y:V.isFixed?V.boundingBox.y:V.boundingBox.y-Te,width:V.boundingBox.width,height:V.boundingBox.height}:null;return E?r.jsx("div",{className:`${V.isMultiSelect?de.multiSelectOutline:de.singleSelectOutline} ${de.enter}`,style:{left:E.x,top:E.y,width:E.width,height:E.height,...V.isMultiSelect?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}}):null})(),r.jsx(hu,{ref:Cr,element:V.element,selectedText:V.selectedText,computedStyles:Kv(V.computedStyles),placeholder:"Edit your feedback...",initialValue:V.comment,submitLabel:"Save",onSubmit:ju,onCancel:hl,onDelete:()=>fl(V.id),isExiting:ra,lightMode:!hs,accentColor:V.isMultiSelect?"var(--agentation-color-green)":"var(--agentation-color-accent)",style:(()=>{const S=V.isFixed?V.y:V.y-Te;return{left:Math.max(160,Math.min(window.innerWidth-160,V.x/100*window.innerWidth)),...S>window.innerHeight-290?{bottom:window.innerHeight-S+20}:{top:S+20}}})()})]}),Zs&&r.jsxs(r.Fragment,{children:[r.jsx("div",{ref:mo,className:de.dragSelection}),r.jsx("div",{ref:Zo,className:de.highlightsContainer})]})]})]}),document.body)}const h4=()=>{const o=ko();return o.pathname==="/"||o.pathname==="/controller"?null:r.jsx("nav",{className:"bg-slate-900 border-b border-slate-800 text-slate-100 p-4 flex items-center justify-between shadow-lg",children:r.jsxs("div",{className:"flex items-center gap-6",children:[r.jsx(lr,{to:"/",className:"font-extrabold text-xl tracking-tight text-cyan-400 hover:text-cyan-300",children:"⚽ Soccer Web Game"}),r.jsx(lr,{to:"/",className:"text-sm font-semibold hover:text-cyan-400 transition",children:"Arena Game"}),r.jsx(lr,{to:"/controller",className:"text-sm font-semibold hover:text-cyan-400 transition",children:"📱 Mobile Remote"})]})})};function _4(){return r.jsx(vb,{children:r.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 flex flex-col select-none",children:[r.jsx(h4,{}),r.jsxs(Kx,{children:[r.jsx(Yf,{path:"/",element:r.jsx(q5,{})}),r.jsx(Yf,{path:"/controller",element:r.jsx(Q5,{})})]}),r.jsx(f4,{})]})})}K1.createRoot(document.getElementById("root")).render(r.jsx(Rn.StrictMode,{children:r.jsx(_4,{})}));
