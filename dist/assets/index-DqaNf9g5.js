 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zp;function X1(){if(zp)return pt;zp=1;var o=Symbol.for("react.transitional.element"),n=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),l=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),_=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),p=Symbol.for("react.lazy"),y=Symbol.for("react.activity"),v=Symbol.iterator;function C(D){return D===null||typeof D!="object"?null:(D=v&&D[v]||D["@@iterator"],typeof D=="function"?D:null)}var k={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},M=Object.assign,O={};function B(D,Z,pe){this.props=D,this.context=Z,this.refs=O,this.updater=pe||k}B.prototype.isReactComponent={},B.prototype.setState=function(D,Z){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,Z,"setState")},B.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function J(){}J.prototype=B.prototype;function F(D,Z,pe){this.props=D,this.context=Z,this.refs=O,this.updater=pe||k}var z=F.prototype=new J;z.constructor=F,M(z,B.prototype),z.isPureReactComponent=!0;var de=Array.isArray;function ye(){}var G={H:null,A:null,T:null,S:null},fe=Object.prototype.hasOwnProperty;function xe(D,Z,pe){var Ee=pe.ref;return{$$typeof:o,type:D,key:Z,ref:Ee!==void 0?Ee:null,props:pe}}function he(D,Z){return xe(D.type,Z,D.props)}function re(D){return typeof D=="object"&&D!==null&&D.$$typeof===o}function Q(D){var Z={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(pe){return Z[pe]})}var Oe=/\/+/g;function oe(D,Z){return typeof D=="object"&&D!==null&&D.key!=null?Q(""+D.key):Z.toString(36)}function ke(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(ye,ye):(D.status="pending",D.then(function(Z){D.status==="pending"&&(D.status="fulfilled",D.value=Z)},function(Z){D.status==="pending"&&(D.status="rejected",D.reason=Z)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function N(D,Z,pe,Ee,qe){var rt=typeof D;(rt==="undefined"||rt==="boolean")&&(D=null);var dt=!1;if(D===null)dt=!0;else switch(rt){case"bigint":case"string":case"number":dt=!0;break;case"object":switch(D.$$typeof){case o:case n:dt=!0;break;case p:return dt=D._init,N(dt(D._payload),Z,pe,Ee,qe)}}if(dt)return qe=qe(D),dt=Ee===""?"."+oe(D,0):Ee,de(qe)?(pe="",dt!=null&&(pe=dt.replace(Oe,"$&/")+"/"),N(qe,Z,pe,"",function(ve){return ve})):qe!=null&&(re(qe)&&(qe=he(qe,pe+(qe.key==null||D&&D.key===qe.key?"":(""+qe.key).replace(Oe,"$&/")+"/")+dt)),Z.push(qe)),1;dt=0;var en=Ee===""?".":Ee+":";if(de(D))for(var Qe=0;Qe<D.length;Qe++)Ee=D[Qe],rt=en+oe(Ee,Qe),dt+=N(Ee,Z,pe,rt,qe);else if(Qe=C(D),typeof Qe=="function")for(D=Qe.call(D),Qe=0;!(Ee=D.next()).done;)Ee=Ee.value,rt=en+oe(Ee,Qe++),dt+=N(Ee,Z,pe,rt,qe);else if(rt==="object"){if(typeof D.then=="function")return N(ke(D),Z,pe,Ee,qe);throw Z=String(D),Error("Objects are not valid as a React child (found: "+(Z==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":Z)+"). If you meant to render a collection of children, use an array instead.")}return dt}function ue(D,Z,pe){if(D==null)return D;var Ee=[],qe=0;return N(D,Ee,"","",function(rt){return Z.call(pe,rt,qe++)}),Ee}function W(D){if(D._status===-1){var Z=D._result;Z=Z(),Z.then(function(pe){(D._status===0||D._status===-1)&&(D._status=1,D._result=pe)},function(pe){(D._status===0||D._status===-1)&&(D._status=2,D._result=pe)}),D._status===-1&&(D._status=0,D._result=Z)}if(D._status===1)return D._result.default;throw D._result}var be=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent(Z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)},Ne={map:ue,forEach:function(D,Z,pe){ue(D,function(){Z.apply(this,arguments)},pe)},count:function(D){var Z=0;return ue(D,function(){Z++}),Z},toArray:function(D){return ue(D,function(Z){return Z})||[]},only:function(D){if(!re(D))throw Error("React.Children.only expected to receive a single React element child.");return D}};return pt.Activity=y,pt.Children=Ne,pt.Component=B,pt.Fragment=i,pt.Profiler=c,pt.PureComponent=F,pt.StrictMode=l,pt.Suspense=h,pt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=G,pt.__COMPILER_RUNTIME={__proto__:null,c:function(D){return G.H.useMemoCache(D)}},pt.cache=function(D){return function(){return D.apply(null,arguments)}},pt.cacheSignal=function(){return null},pt.cloneElement=function(D,Z,pe){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var Ee=M({},D.props),qe=D.key;if(Z!=null)for(rt in Z.key!==void 0&&(qe=""+Z.key),Z)!fe.call(Z,rt)||rt==="key"||rt==="__self"||rt==="__source"||rt==="ref"&&Z.ref===void 0||(Ee[rt]=Z[rt]);var rt=arguments.length-2;if(rt===1)Ee.children=pe;else if(1<rt){for(var dt=Array(rt),en=0;en<rt;en++)dt[en]=arguments[en+2];Ee.children=dt}return xe(D.type,qe,Ee)},pt.createContext=function(D){return D={$$typeof:_,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:u,_context:D},D},pt.createElement=function(D,Z,pe){var Ee,qe={},rt=null;if(Z!=null)for(Ee in Z.key!==void 0&&(rt=""+Z.key),Z)fe.call(Z,Ee)&&Ee!=="key"&&Ee!=="__self"&&Ee!=="__source"&&(qe[Ee]=Z[Ee]);var dt=arguments.length-2;if(dt===1)qe.children=pe;else if(1<dt){for(var en=Array(dt),Qe=0;Qe<dt;Qe++)en[Qe]=arguments[Qe+2];qe.children=en}if(D&&D.defaultProps)for(Ee in dt=D.defaultProps,dt)qe[Ee]===void 0&&(qe[Ee]=dt[Ee]);return xe(D,rt,qe)},pt.createRef=function(){return{current:null}},pt.forwardRef=function(D){return{$$typeof:g,render:D}},pt.isValidElement=re,pt.lazy=function(D){return{$$typeof:p,_payload:{_status:-1,_result:D},_init:W}},pt.memo=function(D,Z){return{$$typeof:m,type:D,compare:Z===void 0?null:Z}},pt.startTransition=function(D){var Z=G.T,pe={};G.T=pe;try{var Ee=D(),qe=G.S;qe!==null&&qe(pe,Ee),typeof Ee=="object"&&Ee!==null&&typeof Ee.then=="function"&&Ee.then(ye,be)}catch(rt){be(rt)}finally{Z!==null&&pe.types!==null&&(Z.types=pe.types),G.T=Z}},pt.unstable_useCacheRefresh=function(){return G.H.useCacheRefresh()},pt.use=function(D){return G.H.use(D)},pt.useActionState=function(D,Z,pe){return G.H.useActionState(D,Z,pe)},pt.useCallback=function(D,Z){return G.H.useCallback(D,Z)},pt.useContext=function(D){return G.H.useContext(D)},pt.useDebugValue=function(){},pt.useDeferredValue=function(D,Z){return G.H.useDeferredValue(D,Z)},pt.useEffect=function(D,Z){return G.H.useEffect(D,Z)},pt.useEffectEvent=function(D){return G.H.useEffectEvent(D)},pt.useId=function(){return G.H.useId()},pt.useImperativeHandle=function(D,Z,pe){return G.H.useImperativeHandle(D,Z,pe)},pt.useInsertionEffect=function(D,Z){return G.H.useInsertionEffect(D,Z)},pt.useLayoutEffect=function(D,Z){return G.H.useLayoutEffect(D,Z)},pt.useMemo=function(D,Z){return G.H.useMemo(D,Z)},pt.useOptimistic=function(D,Z){return G.H.useOptimistic(D,Z)},pt.useReducer=function(D,Z,pe){return G.H.useReducer(D,Z,pe)},pt.useRef=function(D){return G.H.useRef(D)},pt.useState=function(D){return G.H.useState(D)},pt.useSyncExternalStore=function(D,Z,pe){return G.H.useSyncExternalStore(D,Z,pe)},pt.useTransition=function(){return G.H.useTransition()},pt.version="19.2.8",pt}var Bp;function fh(){return Bp||(Bp=1,yf.exports=X1()),yf.exports}var b=fh();const Rn=dh(b);var xf={exports:{}},Kl={},bf={exports:{}},vf={};/**
 * @license React
...
`;const fe=oh(G),he=fy(fe,{includeLeftRight:l==="detailed"||l==="forensic"});for(const Oe of he)u+=`   - ${Oe}
`;const re=_y(G,_);re&&(u+=`   - CSS: ${re}
`)}),u+=`
### Layout Analysis
...
}`,c4={settingsPanel:"styles-module__settingsPanel___qNkn-",settingsHeader:"styles-module__settingsHeader___Fn1DP",settingsBrand:"styles-module__settingsBrand___OoKlM",settingsBrandSlash:"styles-module__settingsBrandSlash___Q-AU9",settingsVersion:"styles-module__settingsVersion___rXmL9",settingsSection:"styles-module__settingsSection___n5V-4",settingsLabel:"styles-module__settingsLabel___VCVOQ",cycleButton:"styles-module__cycleButton___XMBx3",cycleDot:"styles-module__cycleDot___zgSXY",dropdownButton:"styles-module__dropdownButton___mKHe8",sliderLabel:"styles-module__sliderLabel___6K5v1",slider:"styles-module__slider___v5z-c",themeToggle:"styles-module__themeToggle___3imlT",enter:"styles-module__enter___wginS",exit:"styles-module__exit___A4iJc",settingsOption:"styles-module__settingsOption___JoyH-",selected:"styles-module__selected___k1-Vq",settingsPanelContainer:"styles-module__settingsPanelContainer___5it-H",settingsPage:"styles-module__settingsPage___BMn-3",slideLeft:"styles-module__slideLeft___qUvW4",automationsPage:"styles-module__automationsPage___N7By0",slideIn:"styles-module__slideIn___uXDSu",themeIconWrapper:"styles-module__themeIconWrapper___pyaYa",themeIcon:"styles-module__themeIcon___w7lAm",themeIconIn:"styles-module__themeIconIn___qUWMV",settingsSectionGrow:"styles-module__settingsSectionGrow___eZTRw",settingsRow:"styles-module__settingsRow___y-tDE",settingsRowMarginTop:"styles-module__settingsRowMarginTop___uLpGb",settingsRowDisabled:"styles-module__settingsRowDisabled___ydl3Q",cycleButtonText:"styles-module__cycleButtonText___mbbnD",cycleTextIn:"styles-module__cycleTextIn___VBNTi",cycleDots:"styles-module__cycleDots___ehp6i",active:"styles-module__active___dpAhM",colorOptions:"styles-module__colorOptions___pbxZx",colorOption:"styles-module__colorOption___Co955",settingsNavLink:"styles-module__settingsNavLink___uYIwM",settingsNavLinkRight:"styles-module__settingsNavLinkRight___XBUzC",settingsBackButton:"styles-module__settingsBackButton___fflll",automationHeader:"styles-module__automationHeader___Avra9",automationDescription:"styles-module__automationDescription___vFTmJ",learnMoreLink:"styles-module__learnMoreLink___cG7OI",autoSendContainer:"styles-module__autoSendContainer___VpkXk",autoSendLabel:"styles-module__autoSendLabel___ngNdC",disabled:"styles-module__disabled___9AZYS",mcpStatusDot:"styles-module__mcpStatusDot___8AMxP",connecting:"styles-module__connecting___QEO1r",mcpPulse:"styles-module__mcpPulse___5Q3Jj",connected:"styles-module__connected___WyFkx",disconnected:"styles-module__disconnected___mvmvQ",mcpPulseError:"styles-module__mcpPulseError___VHxhx",mcpNavIndicator:"styles-module__mcpNavIndicator___auBHI",webhookUrlInput:"styles-module__webhookUrlInput___WDDDC",checkboxField:"styles-module__checkboxField___ZrSqv",divider:"styles-module__divider___h6Yux",scaleIn:"styles-module__scaleIn___QpQ8E"};if(typeof document<"u"){let o=document.getElementById("feedback-tool-styles-settings-panel-styles");o||(o=document.createElement("style"),o.id="feedback-tool-styles-settings-panel-styles",document.head.appendChild(o)),o.textContent=r4}var Be=c4;function u4({settings:o,onSettingsChange:n,isDarkMode:i,onToggleTheme:l,isDevMode:c,connectionStatus:u,endpoint:_,isVisible:g,toolbarNearBottom:h,settingsPage:m,onSettingsPageChange:p,onHideToolbar:y}){var v;return r.jsx("div",{className:`${Be.settingsPanel} ${g?Be.enter:Be.exit}`,style:h?{bottom:"auto",top:"calc(100% + 0.5rem)"}:void 0,"data-agentation-settings-panel":!0,children:r.jsxs("div",{className:Be.settingsPanelContainer,children:[r.jsxs("div",{className:`${Be.settingsPage} ${m==="automations"?Be.slideLeft:""}`,children:[r.jsxs("div",{className:Be.settingsHeader,children:[r.jsx("a",{className:Be.settingsBrand,href:"https://agentation.com",target:"_blank",rel:"noopener noreferrer",children:r.jsx("svg",{width:"72",height:"16",viewBox:"0 0 676 151",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:r.jsx("path",{d:"M79.6666 100.561L104.863 15.5213C107.828 4.03448 99.1201 -3.00582 88.7449 1.25541L3.52015 39.6065C1.48217 40.5329 0 42.7562 0 45.1647C0 48.6848 2.77907 51.4639 6.29922 51.4639C7.22558 51.4639 8.15193 51.2786 9.07829 50.9081L93.7472 12.7422C97.2674 11.0748 93.7472 8.29572 92.6356 12.1864L67.624 97.2259C66.5123 100.931 69.4767 105.193 73.7379 105.193C76.517 105.193 79.1108 103.155 79.6666 100.561ZM663.641 100.005C665.679 107.231 677.537 104.081 675.499 96.8553L666.05 66.2856C663.456 57.7631 655.489 55.7251 648.82 61.098L618.991 86.6654C617.324 87.9623 621.029 89.815 621.214 88.1476L625.846 61.6538C626.958 55.3546 624.179 50.5375 615.841 50.5375L579.158 51.0934C576.008 51.0934 578.417 53.8724 578.417 57.022C578.417 60.1716 580.825 61.6538 583.975 61.6538L616.212 60.9127C616.397 60.9127 614.544 59.6158 614.544 59.8011L609.727 88.7034C607.875 99.6344 617.694 102.784 626.031 95.7437L655.86 70.1763L654.192 69.6205L663.641 100.005ZM571.191 89.0739C555.443 88.7034 562.298 61.4685 578.787 61.8391C594.72 62.0243 587.124 89.2592 571.191 89.0739ZM571.006 100.375C601.575 100.931 611.024 51.6492 579.158 51.0934C547.847 50.5375 540.065 99.8197 571.006 100.375ZM521.909 46.4616C525.985 46.4616 529.505 42.9414 529.505 38.6802C529.505 34.4189 525.985 31.0841 521.909 31.0841C517.833 31.0841 514.127 34.6042 514.127 38.6802C514.127 42.7562 517.648 46.4616 521.909 46.4616ZM472.256 103.525C493.192 103.71 515.98 73.3259 519.13 62.3949L509.866 60.9127C505.234 73.3259 497.638 101.672 519.871 102.043C536.545 102.228 552.479 85.3685 563.595 70.1763C564.151 69.2499 564.706 68.1383 564.706 66.8414C564.706 63.6918 563.965 61.098 560.816 61.098C558.963 61.098 557.296 62.0243 556.184 63.5065C546.365 77.0313 530.802 90.9266 522.094 90.7414C511.904 90.5561 517.462 71.4732 519.871 64.9887C523.391 55.7251 512.831 53.5019 509.681 60.9127C506.531 68.6941 488.19 92.4088 475.035 92.2235C467.439 92.0383 464.29 83.8863 472.441 59.9864L486.707 17.7445C487.634 14.4097 485.41 10.519 481.334 10.519C478.741 10.519 476.517 12.1864 475.962 14.4097L461.696 56.4662C451.506 86.4801 455.211 103.155 472.256 103.525ZM447.43 42.5709L496.527 41.4593C499.306 41.4593 501.529 39.0507 501.529 36.2717C501.529 33.3073 499.306 31.0841 496.341 31.0841L447.245 32.1957C444.466 32.1957 442.242 34.4189 442.242 37.3833C442.242 40.1624 444.466 42.5709 447.43 42.5709ZM422.974 106.304C435.387 106.489 457.249 94.8173 472.441 53.8724C473.553 50.7228 472.071 48.3143 468.365 48.3143C466.142 48.3143 464.29 49.6112 463.548 51.6492C450.394 87.2212 431.682 96.1142 424.456 95.929C419.454 95.929 417.972 93.3352 418.713 85.5538C419.454 78.1429 410.376 74.9933 406.114 81.1073C401.297 87.777 394.442 94.2615 385.549 94.0763C370.172 93.891 376.471 67.0267 399.815 67.3972C408.338 67.5825 414.452 71.4732 417.045 76.6608C417.786 78.3282 419.454 79.6251 421.492 79.6251C424.271 79.6251 426.679 77.2166 426.679 74.4375C426.679 73.6964 426.494 72.9553 426.124 72.2143C421.862 63.6918 412.414 57.3926 400 57.2073C363.502 56.6515 353.497 104.451 383.326 104.822C397.036 105.193 410.005 94.0763 413.34 85.9243C412.599 86.8507 408.338 86.6654 408.523 84.4422C407.411 97.4111 410.931 106.119 422.974 106.304ZM335.897 104.266C335.897 115.012 347.569 117.606 347.569 103.34C347.569 89.0739 358.5 54.4282 361.464 45.1647L396.666 43.6825C405.929 43.1267 404.262 33.1221 397.036 33.3073L364.984 34.4189L368.875 22.7469C369.801 20.1531 370.542 17.9298 370.542 16.2624C370.542 13.4833 368.504 11.8159 365.911 11.8159C362.946 11.8159 360.352 12.7422 357.573 21.0794L352.942 35.16L330.153 36.0864C326.263 36.4569 323.483 38.1244 323.483 41.6445C323.483 45.5352 326.448 47.0174 330.709 46.8321L349.421 45.9058C345.901 56.6515 335.897 90.7414 335.897 104.266ZM186.939 78.6988C193.979 56.4662 212.877 54.984 212.877 62.9507C212.877 68.3236 203.984 77.0313 186.939 78.6988ZM113.942 150.955C142.844 152.437 159.704 111.492 160.63 80.5515C161.556 73.3259 153.96 70.3616 148.773 75.7344C141.918 83.1453 129.505 93.1499 119.685 93.1499C103.011 93.1499 116.165 59.8011 143.956 59.8011C149.514 59.8011 153.59 61.6538 156.184 64.0623C160.815 68.3236 170.82 62.0243 165.818 56.0957C161.927 51.4639 155.072 48.129 144.882 48.129C102.455 48.129 83.7426 105.007 116.721 105.007C134.692 105.007 151.367 88.3329 155.257 82.7747C154.516 83.5158 149.329 81.2925 149.699 79.4398L149.143 83.5158C148.958 107.045 134.322 141.506 116.536 139.838C113.386 139.468 112.089 137.43 112.089 134.836C112.089 128.907 122.094 119.273 145.067 113.53C159.518 109.824 152.293 101.487 143.4 104.081C111.163 113.53 99.6759 127.425 99.6759 137.8C99.6759 145.026 105.605 150.584 113.942 150.955ZM194.72 109.454C214.359 109.454 239 95.3732 251.228 77.9577C250.301 82.96 246.596 96.8553 246.596 101.487C246.596 110.01 254.748 109.454 261.232 102.784L288.097 75.5491L290.32 85.7391C293.284 99.4491 299.213 104.822 308.847 104.822C326.263 104.822 342.196 85.7391 349.421 74.8081L344.049 63.6918C339.787 74.8081 321.631 92.5941 311.626 92.5941C306.994 92.5941 304.771 89.815 303.289 83.7011L300.325 71.2879C297.916 60.7275 289.023 58.3189 279.018 68.1383L261.788 84.8127L264.382 69.991C266.235 59.2453 255.674 58.1337 250.116 65.915C241.779 77.0313 216.767 97.7817 196.387 97.7817C187.865 97.7817 185.456 93.7057 185.456 88.3329C230.848 84.998 239.185 47.2027 208.986 47.2027C172.858 47.2027 157.11 109.454 194.72 109.454Z",fill:"currentColor"})})}),r.jsxs("p",{className:Be.settingsVersion,children:["v","3.0.2"]}),r.jsx("button",{className:Be.themeToggle,onClick:l,title:i?"Switch to light mode":"Switch to dark mode",children:r.jsx("span",{className:Be.themeIconWrapper,children:r.jsx("span",{className:Be.themeIcon,children:i?r.jsx(u2,{size:20}):r.jsx(d2,{size:20})},i?"sun":"moon")})})]}),r.jsx("div",{className:Be.divider}),r.jsxs("div",{className:Be.settingsSection,children:[r.jsxs("div",{className:Be.settingsRow,children:[r.jsxs("div",{className:Be.settingsLabel,children:["Output Detail",r.jsx(Ki,{content:"Controls how much detail is included in the copied output"})]}),r.jsxs("button",{className:Be.cycleButton,onClick:()=>{const k=(ir.findIndex(M=>M.value===o.outputDetail)+1)%ir.length;n({outputDetail:ir[k].value})},children:[r.jsx("span",{className:Be.cycleButtonText,children:(v=ir.find(C=>C.value===o.outputDetail))==null?void 0:v.label},o.outputDetail),r.jsx("span",{className:Be.cycleDots,children:ir.map(C=>r.jsx("span",{className:`${Be.cycleDot} ${o.outputDetail===C.value?Be.active:""}`},C.value))})]})]}),r.jsxs("div",{className:`${Be.settingsRow} ${Be.settingsRowMarginTop} ${c?"":Be.settingsRowDisabled}`,children:[r.jsxs("div",{className:Be.settingsLabel,children:["React Components",r.jsx(Ki,{content:c?"Include React component names in annotations":"Disabled — production builds minify component names, making detection unreliable. Use in development mode."})]}),r.jsx($f,{checked:c&&o.reactEnabled,onChange:C=>n({reactEnabled:C.target.checked}),disabled:!c})]}),r.jsxs("div",{className:`${Be.settingsRow} ${Be.settingsRowMarginTop}`,children:[r.jsxs("div",{className:Be.settingsLabel,children:["Hide Until Restart",r.jsx(Ki,{content:"Hides the toolbar until you open a new tab"})]}),r.jsx($f,{checked:!1,onChange:C=>{C.target.checked&&y()}})]})]}),r.jsx("div",{className:Be.divider}),r.jsxs("div",{className:Be.settingsSection,children:[r.jsx("div",{className:`${Be.settingsLabel} ${Be.settingsLabelMarker}`,children:"Marker Color"}),r.jsx("div",{className:Be.colorOptions,children:rr.map(C=>r.jsx("button",{className:`${Be.colorOption} ${o.annotationColorId===C.id?Be.selected:""}`,style:{"--swatch":C.srgb,"--swatch-p3":C.p3},onClick:()=>n({annotationColorId:C.id}),title:C.label,type:"button"},C.id))})]}),r.jsx("div",{className:Be.divider}),r.jsxs("div",{className:Be.settingsSection,children:[r.jsx(R0,{className:"checkbox-field",label:"Clear on copy/send",checked:o.autoClearAfterCopy,onChange:C=>n({autoClearAfterCopy:C.target.checked}),tooltip:"Automatically clear annotations after copying"}),r.jsx(R0,{className:Be.checkboxField,label:"Block page interactions",checked:o.blockInteractions,onChange:C=>n({blockInteractions:C.target.checked})})]}),r.jsx("div",{className:Be.divider}),r.jsxs("button",{className:Be.settingsNavLink,onClick:()=>p("automations"),children:[r.jsx("span",{children:"Manage MCP & Webhooks"}),r.jsxs("span",{className:Be.settingsNavLinkRight,children:[_&&u!=="disconnected"&&r.jsx("span",{className:`${Be.mcpNavIndicator} ${Be[u]}`}),r.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:r.jsx("path",{d:"M7.5 12.5L12 8L7.5 3.5",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})]})]})]}),r.jsxs("div",{className:`${Be.settingsPage} ${Be.automationsPage} ${m==="automations"?Be.slideIn:""}`,children:[r.jsxs("button",{className:Be.settingsBackButton,onClick:()=>p("main"),children:[r.jsx(_2,{size:16}),r.jsx("span",{children:"Manage MCP & Webhooks"})]}),r.jsx("div",{className:Be.divider}),r.jsxs("div",{className:Be.settingsSection,children:[r.jsxs("div",{className:Be.settingsRow,children:[r.jsxs("span",{className:Be.automationHeader,children:["MCP Connection",r.jsx(Ki,{content:"Connect via Model Context Protocol to let AI agents like Claude Code receive annotations in real-time."})]}),_&&r.jsx("div",{className:`${Be.mcpStatusDot} ${Be[u]}`,title:u==="connected"?"Connected":u==="connecting"?"Connecting...":"Disconnected"})]}),r.jsxs("p",{className:Be.automationDescription,style:{paddingBottom:6},children:["MCP connection allows agents to receive and act on annotations."," ",r.jsx("a",{href:"https://agentation.dev/mcp",target:"_blank",rel:"noopener noreferrer",className:Be.learnMoreLink,children:"Learn more"})]})]}),r.jsx("div",{className:Be.divider}),r.jsxs("div",{className:`${Be.settingsSection} ${Be.settingsSectionGrow}`,children:[r.jsxs("div",{className:Be.settingsRow,children:[r.jsxs("span",{className:Be.automationHeader,children:["Webhooks",r.jsx(Ki,{content:"Send annotation data to any URL endpoint when annotations change. Useful for custom integrations."})]}),r.jsxs("div",{className:Be.autoSendContainer,children:[r.jsx("label",{htmlFor:"agentation-auto-send",className:`${Be.autoSendLabel} ${o.webhooksEnabled?Be.active:""} ${o.webhookUrl?"":Be.disabled}`,children:"Auto-Send"}),r.jsx($f,{id:"agentation-auto-send",checked:o.webhooksEnabled,onChange:C=>n({webhooksEnabled:C.target.checked}),disabled:!o.webhookUrl})]})]}),r.jsx("p",{className:Be.automationDescription,children:"The webhook URL will receive live annotation changes and annotation data."}),r.jsx("textarea",{className:Be.webhookUrlInput,placeholder:"Webhook URL",value:o.webhookUrl,onKeyDown:C=>C.stopPropagation(),onChange:C=>n({webhookUrl:C.target.value})})]})]})]})})}function Pf(o,n="filtered"){const{name:i,path:l}=Va(o);if(n==="off")return{name:i,elementName:i,path:l,reactComponents:null};const c=$w(o,{mode:n});return{name:c.path?`${c.path} ${i}`:i,elementName:i,path:l,reactComponents:c.path}}var D0=!1,If={outputDetail:"standard",autoClearAfterCopy:!1,annotationColorId:"blue",blockInteractions:!0,reactEnabled:!0,markerClickBehavior:"edit",webhookUrl:"",webhooksEnabled:!0},wo=o=>{if(!o||!o.trim())return!1;try{const n=new URL(o.trim());return n.protocol==="http:"||n.protocol==="https:"}catch{return!1}},rr=[{id:"indigo",label:"Indigo",srgb:"#6155F5",p3:"color(display-p3 0.38 0.33 0.96)"},{id:"blue",label:"Blue",srgb:"#0088FF",p3:"color(display-p3 0.00 0.53 1.00)"},{id:"cyan",label:"Cyan",srgb:"#00C3D0",p3:"color(display-p3 0.00 0.76 0.82)"},{id:"green",label:"Green",srgb:"#34C759",p3:"color(display-p3 0.20 0.78 0.35)"},{id:"yellow",label:"Yellow",srgb:"#FFCC00",p3:"color(display-p3 1.00 0.80 0.00)"},{id:"orange",label:"Orange",srgb:"#FF8D28",p3:"color(display-p3 1.00 0.55 0.16)"},{id:"red",label:"Red",srgb:"#FF383C",p3:"color(display-p3 1.00 0.22 0.24)"}],d4=()=>{if(typeof document>"u"||document.getElementById("agentation-color-tokens"))return;const o=document.createElement("style");o.id="agentation-color-tokens",o.textContent=[...rr.map(n=>`
...
`)}
    ...
    }`].join(""),document.head.appendChild(o)};d4();function Qi(o,n){let i=document.elementFromPoint(o,n);if(!i)return null;for(;i!=null&&i.shadowRoot;){const l=i.shadowRoot.elementFromPoint(o,n);if(!l||l===i)break;i=l}return i}function Uf(o){let n=o;for(;n&&n!==document.body;){const l=window.getComputedStyle(n).position;if(l==="fixed"||l==="sticky")return!0;n=n.parentElement}return!1}function Vi(o){return o.status!=="resolved"&&o.status!=="dismissed"}function Jc(o){const n=ah(o),i=n.found?n:Qw(o);if(i.found&&i.source)return qw(i.source,"path")}function f4({demoAnnotations:o,demoDelay:n=1e3,enableDemoMode:i=!1,onAnnotationAdd:l,onAnnotationDelete:c,onAnnotationUpdate:u,onAnnotationsClear:_,onCopy:g,onSubmit:h,copyToClipboard:m=!0,endpoint:p,sessionId:y,onSessionCreated:v,webhookUrl:C,className:k}={}){var Nr,Lr,ml,pl,ei,ti;const[M,O]=b.useState(!1),[B,J]=b.useState([]),[F,z]=b.useState(!0),[de,ye]=b.useState(()=>kw()),[G,fe]=b.useState(!1),xe=b.useRef(null);b.useEffect(()=>{const S=A=>{const T=xe.current;T&&T.contains(A.target)&&A.stopPropagation()},E=["mousedown","click","pointerdown"];return E.forEach(A=>document.body.addEventListener(A,S)),()=>{E.forEach(A=>document.body.removeEventListener(A,S))}},[]);const[he,re]=b.useState(!1),[Q,Oe]=b.useState(!1),[oe,ke]=b.useState(null),[N,ue]=b.useState({x:0,y:0}),[W,be]=b.useState(null),[Ne,D]=b.useState(!1),[Z,pe]=b.useState("idle"),[Ee,qe]=b.useState(!1),[rt,dt]=b.useState(!1),[en,Qe]=b.useState(null),[ve,ft]=b.useState(null),[Ke,ct]=b.useState([]),[Dt,dn]=b.useState(null),[bn,mn]=b.useState(null),[V,Te]=b.useState(null),[Ge,Ve]=b.useState(null),[nt,Ye]=b.useState([]),[Re,ut]=b.useState(0),[St,Ht]=b.useState(!1),[$e,I]=b.useState(!1),[Y,ie]=b.useState(!1),[ce,ze]=b.useState(!1),[Ce,me]=b.useState(!1),[it,ht]=b.useState("main"),[jt,st]=b.useState(!1),[Ae,wt]=b.useState(!1),[Et,Wt]=b.useState(!1),[De,yt]=b.useState([]),[xt,_t]=b.useState(null),fn=b.useRef(!1),[Fe,Ot]=b.useState(!1),[vn,Yn]=b.useState(!1),[In,oo]=b.useState(1),[vs,Zn]=b.useState("new-page"),[ln,An]=b.useState(""),[Yt,jn]=b.useState(!1),[Me,Jn]=b.useState(null),el=b.useRef(!1),tl=b.useRef({rearrange:null,placements:[]}),io=b.useRef({rearrange:null,placements:[]}),[Ei,oa]=b.useState(0),[Xo,Fo]=b.useState(0),[Mi,ao]=b.useState(0),[Nn,nl]=b.useState(0),Go=b.useRef(new Set),Ns=b.useRef(new Set),Xn=b.useRef(null),ia=b.useRef(),sl=Ae&&M&&!Et&&Fe;b.useEffect(()=>{if(sl){Yn(!1);const S=qa(()=>{Yn(!0)});return()=>cancelAnimationFrame(S)}else Yn(!1)},[sl]);const Wo=b.useRef(new Map),Ti=b.useRef(new Map),lo=b.useRef(),[es,ws]=b.useState(!1),[rn,gr]=b.useState([]),bu=b.useRef(rn);bu.current=rn;const[aa,vu]=b.useState(null),qo=b.useRef(null);b.useRef(!1),b.useRef([]),b.useRef(0),b.useRef(null),b.useRef(null),b.useRef(1);const[yr,as]=b.useState(!1),ro=b.useRef(null),[pn,co]=b.useState([]),Gn=b.useRef({cmd:!1,shift:!1}),Un=()=>{st(!0)},xr=()=>{st(!1)},Qo=()=>{yr||(ro.current=tt(()=>as(!0),850))},wu=()=>{ro.current&&(clearTimeout(ro.current),ro.current=null),as(!1),xr()};b.useEffect(()=>()=>{ro.current&&clearTimeout(ro.current)},[]);const[kt,br]=b.useState(()=>{try{const S=JSON.parse(localStorage.getItem("feedback-toolbar-settings")??"");return{...If,...S,annotationColorId:rr.find(E=>E.id===S.annotationColorId)?S.annotationColorId:If.annotationColorId}}catch{return If}}),[hs,vr]=b.useState(!0),[wr,Ri]=b.useState(!1),Qs=()=>{var S;(S=xe.current)==null||S.classList.add(_e.disableTransitions),vr(E=>!E),qa(()=>{var E;(E=xe.current)==null||E.classList.remove(_e.disableTransitions)})},ol=!1,Vs="off",[on,uo]=b.useState(y??null),il=b.useRef(!1),[ls,fo]=b.useState(p?"connecting":"disconnected"),[Bt,Ss]=b.useState(null),[Ks,Vo]=b.useState(!1),[rs,la]=b.useState(null),Ko=b.useRef(!1),[al,ho]=b.useState(new Set),[Di,Ai]=b.useState(new Set),[Ln,Ls]=b.useState(!1),[ra,Os]=b.useState(!1),[Zs,ca]=b.useState(!1),_o=b.useRef(null),ts=b.useRef(null),mo=b.useRef(null),Zo=b.useRef(null),ua=b.useRef(!1),Sr=b.useRef(0),da=b.useRef(null),fa=b.useRef(null),ll=8,Su=50,kr=b.useRef(null),Cr=b.useRef(null),Ni=b.useRef(null),et=typeof window<"u"?window.location.pathname:"/";b.useEffect(()=>{if(ce)me(!0);else{st(!1),ht("main");const S=tt(()=>me(!1),0);return()=>clearTimeout(S)}},[ce]);const rl=M&&F&&!Ae;b.useEffect(()=>{if(rl){Oe(!1),re(!0),ho(new Set);const S=tt(()=>{ho(E=>{const A=new Set(E);return B.forEach(T=>A.add(T.id)),A})},350);return()=>clearTimeout(S)}else if(he){Oe(!0);const S=tt(()=>{re(!1),Oe(!1)},250);return()=>clearTimeout(S)}},[rl]),b.useEffect(()=>{I(!0),ut(window.scrollY);const S=Nf(et);J(S.filter(Vi)),D0||(Ri(!0),D0=!0,tt(()=>Ri(!1),750));try{const E=localStorage.getItem("feedback-toolbar-theme");E!==null&&vr(E==="dark")}catch{}try{const E=localStorage.getItem("feedback-toolbar-position");if(E){const A=JSON.parse(E);typeof A.x=="number"&&typeof A.y=="number"&&Ss(A)}}catch{}},[et]),b.useEffect(()=>{$e&&localStorage.setItem("feedback-toolbar-settings",JSON.stringify(kt))},[kt,$e]),b.useEffect(()=>{$e&&localStorage.setItem("feedback-toolbar-theme",hs?"dark":"light")},[hs,$e]);const jr=b.useRef(!1);b.useEffect(()=>{const S=jr.current;jr.current=Ks,S&&!Ks&&Bt&&$e&&localStorage.setItem("feedback-toolbar-position",JSON.stringify(Bt))},[Ks,Bt,$e]),b.useEffect(()=>{if(!p||!$e||il.current)return;il.current=!0,fo("connecting"),(async()=>{try{const E=ww(et),A=y||E;let T=!1;if(A)try{const $=await w0(p,A);uo($.id),fo("connected"),Lf(et,$.id),T=!0;const K=Nf(et),ge=new Set($.annotations.map(je=>je.id)),we=K.filter(je=>!ge.has(je.id));if(we.length>0){const Ie=`${typeof window<"u"?window.location.origin:""}${et}`,at=(await Promise.allSettled(we.map(Ze=>Fa(p,$.id,{...Ze,sessionId:$.id,url:Ie})))).map((Ze,Se)=>Ze.status==="fulfilled"?Ze.value:(console.warn("[Agentation] Failed to sync annotation:",Ze.reason),we[Se])),bt=[...$.annotations,...at];J(bt.filter(Vi)),nr(et,bt.filter(Vi),$.id)}else J($.annotations.filter(Vi)),nr(et,$.annotations.filter(Vi),$.id)}catch($){console.warn("[Agentation] Could not join session, creating new:",$),Sw(et)}if(!T){const $=typeof window<"u"?window.location.href:"/",K=await Of(p,$);uo(K.id),fo("connected"),Lf(et,K.id),v==null||v(K.id);const ge=_w(),we=typeof window<"u"?window.location.origin:"",je=[];for(const[Ie,We]of ge){const at=We.filter(Se=>!Se._syncedTo);if(at.length===0)continue;const bt=`${we}${Ie}`,Ze=Ie===et;je.push((async()=>{try{const Se=Ze?K:await Of(p,bt),gn=(await Promise.allSettled(at.map(At=>Fa(p,Se.id,{...At,sessionId:Se.id,url:bt})))).map((At,hn)=>At.status==="fulfilled"?At.value:(console.warn("[Agentation] Failed to sync annotation:",At.reason),at[hn])).filter(Vi);if(nr(Ie,gn,Se.id),Ze){const At=new Set(at.map(hn=>hn.id));J(hn=>{const ot=hn.filter(mt=>!At.has(mt.id));return[...gn,...ot]})}}catch(Se){console.warn(`[Agentation] Failed to sync annotations for ${Ie}:`,Se)}})())}await Promise.allSettled(je)}}catch(E){fo("disconnected"),console.warn("[Agentation] Failed to initialize session, using local storage:",E)}})()},[p,y,$e,v,et]),b.useEffect(()=>{if(!p||!$e)return;const S=async()=>{try{(await fetch(`${p}/health`)).ok?fo("connected"):fo("disconnected")}catch{fo("disconnected")}};S();const E=g2(S,1e4);return()=>clearInterval(E)},[p,$e]),b.useEffect(()=>{if(!p||!$e||!on)return;const S=new EventSource(`${p}/sessions/${on}/events`),E=["resolved","dismissed"],A=T=>{var $;try{const K=JSON.parse(T.data);if(E.includes(($=K.payload)==null?void 0:$.status)){const ge=K.payload.id,we=K.payload.kind;if(we==="placement"){for(const[je,Ie]of Wo.current)if(Ie===ge){Wo.current.delete(je),yt(We=>We.filter(at=>at.id!==je));break}}else if(we==="rearrange"){for(const[je,Ie]of Ti.current)if(Ie===ge){Ti.current.delete(je),Jn(We=>{if(!We)return null;const at=We.sections.filter(bt=>bt.id!==je);return at.length===0?null:{...We,sections:at}});break}}else Ai(je=>new Set(je).add(ge)),tt(()=>{J(je=>je.filter(Ie=>Ie.id!==ge)),Ai(je=>{const Ie=new Set(je);return Ie.delete(ge),Ie})},150)}}catch{}};return S.addEventListener("annotation.updated",A),()=>{S.removeEventListener("annotation.updated",A),S.close()}},[p,$e,on]),b.useEffect(()=>{if(!p||!$e)return;const S=fa.current==="disconnected",E=ls==="connected";fa.current=ls,S&&E&&(async()=>{try{const T=Nf(et);if(T.length===0)return;const K=`${typeof window<"u"?window.location.origin:""}${et}`;let ge=on,we=[];if(ge)try{we=(await w0(p,ge)).annotations}catch{ge=null}ge||(ge=(await Of(p,K)).id,uo(ge),Lf(et,ge));const je=new Set(we.map(We=>We.id)),Ie=T.filter(We=>!je.has(We.id));if(Ie.length>0){const at=(await Promise.allSettled(Ie.map(Se=>Fa(p,ge,{...Se,sessionId:ge,url:K})))).map((Se,tn)=>Se.status==="fulfilled"?Se.value:(console.warn("[Agentation] Failed to sync annotation on reconnect:",Se.reason),Ie[tn])),Ze=[...we,...at].filter(Vi);J(Ze),nr(et,Ze,ge)}}catch(T){console.warn("[Agentation] Failed to sync on reconnect:",T)}})()},[ls,p,$e,on,et]);const ku=b.useCallback(()=>{G||(fe(!0),ze(!1),O(!1),tt(()=>{Cw(!0),ye(!0),fe(!1)},400))},[G]);b.useEffect(()=>{if(!i||!$e||!o||o.length===0||B.length>0)return;const S=[];return S.push(tt(()=>{O(!0)},n-200)),o.forEach((E,A)=>{const T=n+A*300;S.push(tt(()=>{const $=document.querySelector(E.selector);if(!$)return;const K=$.getBoundingClientRect(),{name:ge,path:we}=Va($),je={id:`demo-${Date.now()}-${A}`,x:(K.left+K.width/2)/window.innerWidth*100,y:K.top+K.height/2+window.scrollY,comment:E.comment,element:ge,elementPath:we,timestamp:Date.now(),selectedText:E.selectedText,boundingBox:{x:K.left,y:K.top+window.scrollY,width:K.width,height:K.height},nearbyText:er($),cssClasses:tr($)};J(Ie=>[...Ie,je])},T))}),()=>{S.forEach(clearTimeout)}},[i,$e,o,n]),b.useEffect(()=>{const S=()=>{ut(window.scrollY),Ht(!0),Ni.current&&clearTimeout(Ni.current),Ni.current=tt(()=>{Ht(!1)},150)};return window.addEventListener("scroll",S,{passive:!0}),()=>{window.removeEventListener("scroll",S),Ni.current&&clearTimeout(Ni.current)}},[]),b.useEffect(()=>{$e&&B.length>0?on?nr(et,B,on):gy(et,B):$e&&B.length===0&&localStorage.removeItem(mu(et))},[B,et,$e,on]),b.useEffect(()=>{if($e&&!fn.current){fn.current=!0;const S=mw(et);S.length>0&&yt(S)}},[$e,et]),b.useEffect(()=>{$e&&fn.current&&!Fe&&(De.length>0?pw(et,De):gw(et))},[De,et,$e,Fe]),b.useEffect(()=>{if($e&&!el.current){el.current=!0;const S=yw(et);if(S){const E={...S,sections:S.sections.map(A=>({...A,currentRect:A.currentRect??{...A.originalRect}}))};Jn(E)}}},[$e,et]),b.useEffect(()=>{$e&&el.current&&!Fe&&(Me?xw(et,Me):bw(et))},[Me,et,$e,Fe]);const cl=b.useRef(!1);b.useEffect(()=>{if($e&&!cl.current){cl.current=!0;const S=vw(et);S&&(io.current={rearrange:S.rearrange,placements:S.placements||[]},S.purpose&&An(S.purpose))}},[$e,et]),b.useEffect(()=>{var E,A,T;if(!$e||!cl.current)return;const S=io.current;Fe?(((E=Me==null?void 0:Me.sections)==null?void 0:E.length)??0)>0||De.length>0||ln?v0(et,{rearrange:Me,placements:De,purpose:ln}):Vc(et):(((T=(A=S.rearrange)==null?void 0:A.sections)==null?void 0:T.length)??0)>0||S.placements.length>0||ln?v0(et,{rearrange:S.rearrange,placements:S.placements,purpose:ln}):Vc(et)},[Me,De,ln,Fe,et,$e]),b.useEffect(()=>{Ae&&!Me&&Jn({sections:[],originalOrder:[],detectedAt:Date.now()})},[Ae,Me]),b.useEffect(()=>{if(!p||!on)return;const S=Wo.current,E=new Set(De.map(A=>A.id));for(const A of De){if(S.has(A.id))continue;S.set(A.id,"");const T=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:et;Fa(p,on,{id:A.id,x:A.x/window.innerWidth*100,y:A.y,comment:`Place ${A.type} at (${Math.round(A.x)}, ${Math.round(A.y)}), ${A.width}×${A.height}px${A.text?` — "${A.text}"`:""}`,element:`[design:${A.type}]`,elementPath:"[placement]",timestamp:A.timestamp,url:T,intent:"change",severity:"important",kind:"placement",placement:{componentType:A.type,width:A.width,height:A.height,scrollY:A.scrollY,text:A.text}}).then($=>{S.has(A.id)&&S.set(A.id,$.id)}).catch($=>{console.warn("[Agentation] Failed to sync placement annotation:",$),S.delete(A.id)})}for(const[A,T]of S)E.has(A)||(S.delete(A),T&&ki(p,T).catch(()=>{}))},[De,p,on,et]),b.useEffect(()=>{if(!(!p||!on))return lo.current&&clearTimeout(lo.current),lo.current=tt(()=>{const S=Ti.current;if(!Me||Me.sections.length===0){for(const[,T]of S)T&&ki(p,T).catch(()=>{});S.clear();return}const E=new Set(Me.sections.map(T=>T.id)),A=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:et;for(const T of Me.sections){const $=T.originalRect,K=T.currentRect;if(!(Math.abs($.x-K.x)>1||Math.abs($.y-K.y)>1||Math.abs($.width-K.width)>1||Math.abs($.height-K.height)>1)){const je=S.get(T.id);je&&(S.delete(T.id),ki(p,je).catch(()=>{}));continue}const we=S.get(T.id);we?S0(p,we,{comment:`Move ${T.label} section (${T.tagName}) — from (${Math.round($.x)},${Math.round($.y)}) ${Math.round($.width)}×${Math.round($.height)} to (${Math.round(K.x)},${Math.round(K.y)}) ${Math.round(K.width)}×${Math.round(K.height)}`}).catch(je=>{console.warn("[Agentation] Failed to update rearrange annotation:",je)}):(S.set(T.id,""),Fa(p,on,{id:T.id,x:K.x/window.innerWidth*100,y:K.y,comment:`Move ${T.label} section (${T.tagName}) — from (${Math.round($.x)},${Math.round($.y)}) ${Math.round($.width)}×${Math.round($.height)} to (${Math.round(K.x)},${Math.round(K.y)}) ${Math.round(K.width)}×${Math.round(K.height)}`,element:T.selector,elementPath:"[rearrange]",timestamp:Date.now(),url:A,intent:"change",severity:"important",kind:"rearrange",rearrange:{selector:T.selector,label:T.label,tagName:T.tagName,originalRect:$,currentRect:K}}).then(je=>{S.has(T.id)&&S.set(T.id,je.id)}).catch(je=>{console.warn("[Agentation] Failed to sync rearrange annotation:",je),S.delete(T.id)}))}for(const[T,$]of S)E.has(T)||(S.delete(T),$&&ki(p,$).catch(()=>{}))},300),()=>{lo.current&&clearTimeout(lo.current)}},[Me,p,on,et]);const po=b.useRef(new Map);b.useLayoutEffect(()=>{const S=(Me==null?void 0:Me.sections)??[],E=new Set;if((Ae||Et)&&M)for(const A of S){E.add(A.id);try{const T=document.querySelector(A.selector);if(!T)continue;if(!po.current.has(A.id)){const $={transform:T.style.transform,transformOrigin:T.style.transformOrigin,opacity:T.style.opacity,position:T.style.position,zIndex:T.style.zIndex,display:T.style.display},K=[];let ge=T.parentElement;for(;ge&&ge!==document.body;){const je=getComputedStyle(ge);(je.overflow!=="visible"||je.overflowX!=="visible"||je.overflowY!=="visible")&&(K.push({el:ge,overflow:ge.style.overflow}),ge.style.overflow="visible"),ge=ge.parentElement}getComputedStyle(T).display==="inline"&&(T.style.display="inline-block"),po.current.set(A.id,{el:T,origStyles:$,ancestors:K}),T.style.transformOrigin="top left",T.style.zIndex="9999"}}catch{}}for(const[A,T]of po.current)if(!E.has(A)){const{el:$,origStyles:K,ancestors:ge}=T;$.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",$.style.transform=K.transform,$.style.transformOrigin=K.transformOrigin,$.style.opacity=K.opacity,$.style.position=K.position,$.style.zIndex=K.zIndex,po.current.delete(A),tt(()=>{$.style.transition="",$.style.display=K.display;for(const we of ge)we.el.style.overflow=we.overflow},450)}},[Me,Ae,Et,M]),b.useEffect(()=>()=>{for(const[,S]of po.current){const{el:E,origStyles:A,ancestors:T}=S;E.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",E.style.transform=A.transform,E.style.transformOrigin=A.transformOrigin,E.style.opacity=A.opacity,E.style.position=A.position,E.style.zIndex=A.zIndex,tt(()=>{E.style.transition="",E.style.display=A.display;for(const $ of T)$.el.style.overflow=$.overflow},450)}po.current.clear()},[]);const ha=b.useCallback(()=>{Wt(!0),wt(!1),_t(null),clearTimeout(ia.current),ia.current=tt(()=>{Wt(!1)},300)},[]),Er=b.useCallback(()=>{Ae&&(Wt(!0),wt(!1),_t(null),clearTimeout(ia.current),ia.current=tt(()=>{Wt(!1)},300)),O(!1)},[Ae]),Mr=b.useCallback(()=>{Y||(x2(),ie(!0))},[Y]),Li=b.useCallback(()=>{Y&&(l0(),ie(!1))},[Y]),ul=b.useCallback(()=>{Y?Li():Mr()},[Y,Mr,Li]),Tr=b.useCallback(()=>{if(pn.length===0)return;const S=pn[0],E=S.element,A=pn.length>1,T=pn.map($=>$.element.getBoundingClientRect());if(A){const $={left:Math.min(...T.map(Se=>Se.left)),top:Math.min(...T.map(Se=>Se.top)),right:Math.max(...T.map(Se=>Se.right)),bottom:Math.max(...T.map(Se=>Se.bottom))},K=pn.slice(0,5).map(Se=>Se.name).join(", "),ge=pn.length>5?` +${pn.length-5} more`:"",we=T.map(Se=>({x:Se.left,y:Se.top+window.scrollY,width:Se.width,height:Se.height})),Ie=pn[pn.length-1].element,We=T[T.length-1],at=We.left+We.width/2,bt=We.top+We.height/2,Ze=Uf(Ie);be({x:at/window.innerWidth*100,y:Ze?bt:bt+window.scrollY,clientY:bt,element:`${pn.length} elements: ${K}${ge}`,elementPath:"multi-select",boundingBox:{x:$.left,y:$.top+window.scrollY,width:$.right-$.left,height:$.bottom-$.top},isMultiSelect:!0,isFixed:Ze,elementBoundingBoxes:we,multiSelectElements:pn.map(Se=>Se.element),targetElement:Ie,fullPath:Wc(E),accessibility:Gc(E),computedStyles:Fc(E),computedStylesObj:Xc(E),nearbyElements:Yc(E),cssClasses:tr(E),nearbyText:er(E),sourceFile:Jc(E)})}else{const $=T[0],K=Uf(E);be({x:$.left/window.innerWidth*100,y:K?$.top:$.top+window.scrollY,clientY:$.top,element:S.name,elementPath:S.path,boundingBox:{x:$.left,y:K?$.top:$.top+window.scrollY,width:$.width,height:$.height},isFixed:K,fullPath:Wc(E),accessibility:Gc(E),computedStyles:Fc(E),computedStylesObj:Xc(E),nearbyElements:Yc(E),cssClasses:tr(E),nearbyText:er(E),reactComponents:S.reactComponents,sourceFile:Jc(E)})}co([]),ke(null)},[pn]);b.useEffect(()=>{M||(be(null),Te(null),Ve(null),Ye([]),ke(null),ze(!1),co([]),Gn.current={cmd:!1,shift:!1},Y&&Li())},[M,Y,Li]),b.useEffect(()=>()=>{l0()},[]),b.useEffect(()=>{if(!M)return;const S=["p","span","h1","h2","h3","h4","h5","h6","li","td","th","label","blockquote","figcaption","caption","legend","dt","dd","pre","code","em","strong","b","i","u","s","a","time","address","cite","q","abbr","dfn","mark","small","sub","sup","[contenteditable]"].join(", "),E=":not([data-agentation-root]):not([data-agentation-root] *)",A=document.createElement("style");return A.id="feedback-cursor-styles",A.textContent=`
      body ${E} {
        cursor: crosshair !important;
      }
    ...
    `,document.head.appendChild(A),()=>{const T=document.getElementById("feedback-cursor-styles");T&&T.remove()}},[M]),b.useEffect(()=>{if(aa!==null&&M)return document.documentElement.setAttribute("data-drawing-hover",""),()=>document.documentElement.removeAttribute("data-drawing-hover")},[aa,M]),b.useEffect(()=>{if(!M||W||es||Ae)return;const S=E=>{const A=E.composedPath()[0]||E.target;if(us(A,"[data-feedback-toolbar]")){ke(null);return}const T=Qi(E.clientX,E.clientY);if(!T||us(T,"[data-feedback-toolbar]")){ke(null);return}const{name:$,elementName:K,path:ge,reactComponents:we}=Pf(T,Vs),je=T.getBoundingClientRect();ke({element:$,elementName:K,elementPath:ge,rect:je,reactComponents:we}),ue({x:E.clientX,y:E.clientY})};return document.addEventListener("mousemove",S),()=>document.removeEventListener("mousemove",S)},[M,W,es,Ae,Vs,rn]);const _a=b.useCallback(S=>{var E;if(Te(S),Qe(null),ft(null),ct([]),(E=S.elementBoundingBoxes)!=null&&E.length){const A=[];for(const T of S.elementBoundingBoxes){const $=T.x+T.width/2,K=T.y+T.height/2-window.scrollY,ge=Qi($,K);ge&&A.push(ge)}Ye(A),Ve(null)}else if(S.boundingBox){const A=S.boundingBox,T=A.x+A.width/2,$=S.isFixed?A.y+A.height/2:A.y+A.height/2-window.scrollY,K=Qi(T,$);if(K){const ge=K.getBoundingClientRect(),we=ge.width/A.width,je=ge.height/A.height;we<.5||je<.5?Ve(null):Ve(K)}else Ve(null);Ye([])}else Ve(null),Ye([])},[]);b.useEffect(()=>{if(!M||es||Ae)return;const S=E=>{var qt,gn;if(ua.current){ua.current=!1;return}const A=E.composedPath()[0]||E.target;if(us(A,"[data-feedback-toolbar]")||us(A,"[data-annotation-popup]")||us(A,"[data-annotation-marker]"))return;if(E.metaKey&&E.shiftKey&&!W&&!V){E.preventDefault(),E.stopPropagation();const At=Qi(E.clientX,E.clientY);if(!At)return;const hn=At.getBoundingClientRect(),{name:ot,path:mt,reactComponents:an}=Pf(At,Vs),Qt=pn.findIndex(En=>En.element===At);Qt>=0?co(En=>En.filter((Wn,wn)=>wn!==Qt)):co(En=>[...En,{element:At,rect:hn,name:ot,path:mt,reactComponents:an??void 0}]);return}const T=us(A,"button, a, input, select, textarea, [role='button'], [onclick]");if(kt.blockInteractions&&T&&(E.preventDefault(),E.stopPropagation()),W){if(T&&!kt.blockInteractions)return;E.preventDefault(),(qt=kr.current)==null||qt.shake();return}if(V){if(T&&!kt.blockInteractions)return;E.preventDefault(),(gn=Cr.current)==null||gn.shake();return}E.preventDefault();const $=Qi(E.clientX,E.clientY);if(!$)return;const{name:K,path:ge,reactComponents:we}=Pf($,Vs),je=$.getBoundingClientRect(),Ie=E.clientX/window.innerWidth*100,We=Uf($),at=We?E.clientY:E.clientY+window.scrollY,bt=window.getSelection();let Ze;bt&&bt.toString().trim().length>0&&(Ze=bt.toString().trim().slice(0,500));const Se=Xc($),tn=Fc($);be({x:Ie,y:at,clientY:E.clientY,element:K,elementPath:ge,selectedText:Ze,boundingBox:{x:je.left,y:We?je.top:je.top+window.scrollY,width:je.width,height:je.height},nearbyText:er($),cssClasses:tr($),isFixed:We,fullPath:Wc($),accessibility:Gc($),computedStyles:tn,computedStylesObj:Se,nearbyElements:Yc($),reactComponents:we??void 0,sourceFile:Jc($),targetElement:$}),ke(null)};return document.addEventListener("click",S,!0),()=>document.removeEventListener("click",S,!0)},[M,es,Ae,W,V,kt.blockInteractions,Vs,pn]),b.useEffect(()=>{if(!M)return;const S=T=>{T.key==="Meta"&&(Gn.current.cmd=!0),T.key==="Shift"&&(Gn.current.shift=!0)},E=T=>{const $=Gn.current.cmd&&Gn.current.shift;T.key==="Meta"&&(Gn.current.cmd=!1),T.key==="Shift"&&(Gn.current.shift=!1);const K=Gn.current.cmd&&Gn.current.shift;$&&!K&&pn.length>0&&Tr()},A=()=>{Gn.current={cmd:!1,shift:!1},co([])};return document.addEventListener("keydown",S),document.addEventListener("keyup",E),window.addEventListener("blur",A),()=>{document.removeEventListener("keydown",S),document.removeEventListener("keyup",E),window.removeEventListener("blur",A)}},[M,pn,Tr]),b.useEffect(()=>{if(!M||W||es||Ae)return;const S=E=>{const A=E.composedPath()[0]||E.target;us(A,"[data-feedback-toolbar]")||us(A,"[data-annotation-marker]")||us(A,"[data-annotation-popup]")||new Set(["P","SPAN","H1","H2","H3","H4","H5","H6","LI","TD","TH","LABEL","BLOCKQUOTE","FIGCAPTION","CAPTION","LEGEND","DT","DD","PRE","CODE","EM","STRONG","B","I","U","S","A","TIME","ADDRESS","CITE","Q","ABBR","DFN","MARK","SMALL","SUB","SUP"]).has(A.tagName)||A.isContentEditable||(E.preventDefault(),_o.current={x:E.clientX,y:E.clientY})};return document.addEventListener("mousedown",S),()=>document.removeEventListener("mousedown",S)},[M,W,es,Ae]),b.useEffect(()=>{if(!M||W)return;const S=E=>{if(!_o.current)return;const A=E.clientX-_o.current.x,T=E.clientY-_o.current.y,$=A*A+T*T,K=ll*ll;if(!Zs&&$>=K&&(ts.current=_o.current,ca(!0),E.preventDefault()),(Zs||$>=K)&&ts.current){if(mo.current){const ot=Math.min(ts.current.x,E.clientX),mt=Math.min(ts.current.y,E.clientY),an=Math.abs(E.clientX-ts.current.x),Qt=Math.abs(E.clientY-ts.current.y);mo.current.style.transform=`translate(${ot}px, ${mt}px)`,mo.current.style.width=`${an}px`,mo.current.style.height=`${Qt}px`}const ge=Date.now();if(ge-Sr.current<Su)return;Sr.current=ge;const we=ts.current.x,je=ts.current.y,Ie=Math.min(we,E.clientX),We=Math.min(je,E.clientY),at=Math.max(we,E.clientX),bt=Math.max(je,E.clientY),Ze=(Ie+at)/2,Se=(We+bt)/2,tn=new Set,qt=[[Ie,We],[at,We],[Ie,bt],[at,bt],[Ze,Se],[Ze,We],[Ze,bt],[Ie,Se],[at,Se]];for(const[ot,mt]of qt){const an=document.elementsFromPoint(ot,mt);for(const Qt of an)Qt instanceof HTMLElement&&tn.add(Qt)}const gn=document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th, div, span, section, article, aside, nav");for(const ot of gn)if(ot instanceof HTMLElement){const mt=ot.getBoundingClientRect(),an=mt.left+mt.width/2,Qt=mt.top+mt.height/2,En=an>=Ie&&an<=at&&Qt>=We&&Qt<=bt,Wn=Math.min(mt.right,at)-Math.max(mt.left,Ie),wn=Math.min(mt.bottom,bt)-Math.max(mt.top,We),Cs=Wn>0&&wn>0?Wn*wn:0,_s=mt.width*mt.height,Bs=_s>0?Cs/_s:0;(En||Bs>.5)&&tn.add(ot)}const At=[],hn=new Set(["BUTTON","A","INPUT","IMG","P","H1","H2","H3","H4","H5","H6","LI","LABEL","TD","TH","SECTION","ARTICLE","ASIDE","NAV"]);for(const ot of tn){if(us(ot,"[data-feedback-toolbar]")||us(ot,"[data-annotation-marker]"))continue;const mt=ot.getBoundingClientRect();if(!(mt.width>window.innerWidth*.8&&mt.height>window.innerHeight*.5)&&!(mt.width<10||mt.height<10)&&mt.left<at&&mt.right>Ie&&mt.top<bt&&mt.bottom>We){const an=ot.tagName;let Qt=hn.has(an);if(!Qt&&(an==="DIV"||an==="SPAN")){const En=ot.textContent&&ot.textContent.trim().length>0,Wn=ot.onclick!==null||ot.getAttribute("role")==="button"||ot.getAttribute("role")==="link"||ot.classList.contains("clickable")||ot.hasAttribute("data-clickable");(En||Wn)&&!ot.querySelector("p, h1, h2, h3, h4, h5, h6, button, a")&&(Qt=!0)}if(Qt){let En=!1;for(const Wn of At)if(Wn.left<=mt.left&&Wn.right>=mt.right&&Wn.top<=mt.top&&Wn.bottom>=mt.bottom){En=!0;break}En||At.push(mt)}}}if(Zo.current){const ot=Zo.current;for(;ot.children.length>At.length;)ot.removeChild(ot.lastChild);At.forEach((mt,an)=>{let Qt=ot.children[an];Qt||(Qt=document.createElement("div"),Qt.className=_e.selectedElementHighlight,ot.appendChild(Qt)),Qt.style.transform=`translate(${mt.left}px, ${mt.top}px)`,Qt.style.width=`${mt.width}px`,Qt.style.height=`${mt.height}px`})}}};return document.addEventListener("mousemove",S,{passive:!0}),()=>document.removeEventListener("mousemove",S)},[M,W,Zs,ll]),b.useEffect(()=>{if(!M)return;const S=E=>{const A=Zs,T=ts.current;if(Zs&&T){ua.current=!0;const $=Math.min(T.x,E.clientX),K=Math.min(T.y,E.clientY),ge=Math.max(T.x,E.clientX),we=Math.max(T.y,E.clientY),je=[];document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th").forEach(Ze=>{if(!(Ze instanceof HTMLElement)||us(Ze,"[data-feedback-toolbar]")||us(Ze,"[data-annotation-marker]"))return;const Se=Ze.getBoundingClientRect();Se.width>window.innerWidth*.8&&Se.height>window.innerHeight*.5||Se.width<10||Se.height<10||Se.left<ge&&Se.right>$&&Se.top<we&&Se.bottom>K&&je.push({element:Ze,rect:Se})});const We=je.filter(({element:Ze})=>!je.some(({element:Se})=>Se!==Ze&&Ze.contains(Se))),at=E.clientX/window.innerWidth*100,bt=E.clientY+window.scrollY;if(We.length>0){const Ze=We.reduce((hn,{rect:ot})=>({left:Math.min(hn.left,ot.left),top:Math.min(hn.top,ot.top),right:Math.max(hn.right,ot.right),bottom:Math.max(hn.bottom,ot.bottom)}),{left:1/0,top:1/0,right:-1/0,bottom:-1/0}),Se=We.slice(0,5).map(({element:hn})=>Va(hn).name).join(", "),tn=We.length>5?` +${We.length-5} more`:"",qt=We[0].element,gn=Xc(qt),At=Fc(qt);be({x:at,y:bt,clientY:E.clientY,element:`${We.length} elements: ${Se}${tn}`,elementPath:"multi-select",boundingBox:{x:Ze.left,y:Ze.top+window.scrollY,width:Ze.right-Ze.left,height:Ze.bottom-Ze.top},isMultiSelect:!0,fullPath:Wc(qt),accessibility:Gc(qt),computedStyles:At,computedStylesObj:gn,nearbyElements:Yc(qt),cssClasses:tr(qt),nearbyText:er(qt),sourceFile:Jc(qt)})}else{const Ze=Math.abs(ge-$),Se=Math.abs(we-K);Ze>20&&Se>20&&be({x:at,y:bt,clientY:E.clientY,element:"Area selection",elementPath:`region at (${Math.round($)}, ${Math.round(K)})`,boundingBox:{x:$,y:K+window.scrollY,width:Ze,height:Se},isMultiSelect:!0})}ke(null)}else A&&(ua.current=!0);_o.current=null,ts.current=null,ca(!1),Zo.current&&(Zo.current.innerHTML="")};return document.addEventListener("mouseup",S),()=>document.removeEventListener("mouseup",S)},[M,Zs]);const zs=b.useCallback(async(S,E,A)=>{const T=kt.webhookUrl||C;if(!T||!kt.webhooksEnabled&&!A)return!1;try{return(await fetch(T,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:S,timestamp:Date.now(),url:typeof window<"u"?window.location.href:void 0,...E})})).ok}catch($){return console.warn("[Agentation] Webhook failed:",$),!1}},[C,kt.webhookUrl,kt.webhooksEnabled]),Cu=b.useCallback(S=>{var A;if(!W)return;const E={id:Date.now().toString(),x:W.x,y:W.y,comment:S,element:W.element,elementPath:W.elementPath,timestamp:Date.now(),selectedText:W.selectedText,boundingBox:W.boundingBox,nearbyText:W.nearbyText,cssClasses:W.cssClasses,isMultiSelect:W.isMultiSelect,isFixed:W.isFixed,fullPath:W.fullPath,accessibility:W.accessibility,computedStyles:W.computedStyles,nearbyElements:W.nearbyElements,reactComponents:W.reactComponents,sourceFile:W.sourceFile,elementBoundingBoxes:W.elementBoundingBoxes,...p&&on?{sessionId:on,url:typeof window<"u"?window.location.href:void 0,status:"pending"}:{}};J(T=>[...T,E]),da.current=E.id,tt(()=>{da.current=null},300),tt(()=>{ho(T=>new Set(T).add(E.id))},250),l==null||l(E),zs("annotation.add",{annotation:E}),Ls(!0),tt(()=>{be(null),Ls(!1)},150),(A=window.getSelection())==null||A.removeAllRanges(),p&&on&&Fa(p,on,E).then(T=>{T.id!==E.id&&(J($=>$.map(K=>K.id===E.id?{...K,id:T.id}:K)),ho($=>{const K=new Set($);return K.delete(E.id),K.add(T.id),K}))}).catch(T=>{console.warn("[Agentation] Failed to sync annotation:",T)})},[W,l,zs,p,on]),dl=b.useCallback(()=>{Ls(!0),tt(()=>{be(null),Ls(!1)},150)},[]),fl=b.useCallback(S=>{const E=B.findIndex(T=>T.id===S),A=B[E];(V==null?void 0:V.id)===S&&(Os(!0),tt(()=>{Te(null),Ve(null),Ye([]),Os(!1)},150)),dn(S),Ai(T=>new Set(T).add(S)),A&&(c==null||c(A),zs("annotation.delete",{annotation:A})),p&&ki(p,S).catch(T=>{console.warn("[Agentation] Failed to delete annotation from server:",T)}),tt(()=>{J(T=>T.filter($=>$.id!==S)),Ai(T=>{const $=new Set(T);return $.delete(S),$}),dn(null),E<B.length-1&&(mn(E),tt(()=>mn(null),200))},150)},[B,V,c,zs,p]),ma=b.useCallback(S=>{var E;if(!S){Qe(null),ft(null),ct([]);return}if(Qe(S.id),(E=S.elementBoundingBoxes)!=null&&E.length){const A=[];for(const T of S.elementBoundingBoxes){const $=T.x+T.width/2,K=T.y+T.height/2-window.scrollY,we=document.elementsFromPoint($,K).find(je=>!je.closest("[data-annotation-marker]")&&!je.closest("[data-agentation-root]"));we&&A.push(we)}ct(A),ft(null)}else if(S.boundingBox){const A=S.boundingBox,T=A.x+A.width/2,$=S.isFixed?A.y+A.height/2:A.y+A.height/2-window.scrollY,K=Qi(T,$);if(K){const ge=K.getBoundingClientRect(),we=ge.width/A.width,je=ge.height/A.height;we<.5||je<.5?ft(null):ft(K)}else ft(null);ct([])}else ft(null),ct([])},[]),ju=b.useCallback(S=>{if(!V)return;const E={...V,comment:S};J(A=>A.map(T=>T.id===V.id?E:T)),u==null||u(E),zs("annotation.update",{annotation:E}),p&&S0(p,V.id,{comment:S}).catch(A=>{console.warn("[Agentation] Failed to update annotation on server:",A)}),Os(!0),tt(()=>{Te(null),Ve(null),Ye([]),Os(!1)},150)},[V,u,zs,p]),hl=b.useCallback(()=>{Os(!0),tt(()=>{Te(null),Ve(null),Ye([]),Os(!1)},150)},[]),ks=b.useCallback(()=>{const S=B.length,E=De.length>0||!!Me;if(S===0&&rn.length===0&&!E)return;if(_==null||_(B),zs("annotations.clear",{annotations:B}),p){Promise.all(B.map($=>ki(p,$.id).catch(K=>{console.warn("[Agentation] Failed to delete annotation from server:",K)})));for(const[,$]of Wo.current)$&&ki(p,$).catch(()=>{});Wo.current.clear();for(const[,$]of Ti.current)$&&ki(p,$).catch(()=>{});Ti.current.clear()}dt(!0),qe(!0),gr([]);const A=qo.current;if(A){const $=A.getContext("2d");$&&$.clearRect(0,0,A.width,A.height)}(De.length>0||Me)&&(ao($=>$+1),nl($=>$+1),tt(()=>{yt([]),Jn(null)},200)),Fe&&Ot(!1),ln&&An(""),io.current={rearrange:null,placements:[]},Vc(et);const T=S*30+200;tt(()=>{J([]),ho(new Set),localStorage.removeItem(mu(et)),dt(!1)},T),tt(()=>qe(!1),1500)},[et,B,rn,De,Me,Fe,ln,_,zs,p]),_l=b.useCallback(async()=>{const S=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:et,E=Ae&&Fe;let A;if(E){if(De.length===0&&!Me&&!ln)return;A=""}else{if(A=j0(B,S,kt.outputDetail),!A&&rn.length===0&&De.length===0&&!Me)return;A||(A=`## Page Feedback: ${S}
`)}if(!E&&rn.length>0){const T=new Set;for(const we of B)we.drawingIndex!=null&&T.add(we.drawingIndex);const $=qo.current;$&&($.style.visibility="hidden");const K=[],ge=window.scrollY;for(let we=0;we<rn.length;we++){if(T.has(we))continue;const je=rn[we];if(je.points.length<2)continue;const Ie=je.fixed?je.points:je.points.map(yn=>({x:yn.x,y:yn.y-ge}));let We=1/0,at=1/0,bt=-1/0,Ze=-1/0;for(const yn of Ie)We=Math.min(We,yn.x),at=Math.min(at,yn.y),bt=Math.max(bt,yn.x),Ze=Math.max(Ze,yn.y);const Se=bt-We,tn=Ze-at,qt=Math.hypot(Se,tn),gn=Ie[0],At=Ie[Ie.length-1],hn=Math.hypot(At.x-gn.x,At.y-gn.y);let ot;const mt=hn<qt*.35,an=Se/Math.max(tn,1);if(mt&&qt>20){const yn=Math.max(Se,tn)*.15;let ns=0;for(const go of Ie){const Or=go.x-We<yn,zr=bt-go.x<yn,Eu=go.y-at<yn,Mu=Ze-go.y<yn;(Or||zr)&&(Eu||Mu)&&ns++}ot=ns>Ie.length*.15?"box":"circle"}else an>3&&tn<40?ot="underline":hn>qt*.5?ot="arrow":ot="drawing";const Qt=Math.min(10,Ie.length),En=Math.max(1,Math.floor(Ie.length/Qt)),Wn=new Set,wn=[],Cs=[gn];for(let yn=En;yn<Ie.length-1;yn+=En)Cs.push(Ie[yn]);Cs.push(At);for(const yn of Cs){const ns=Qi(yn.x,yn.y);if(!ns||Wn.has(ns)||us(ns,"[data-feedback-toolbar]"))continue;Wn.add(ns);const{name:go}=Va(ns);wn.includes(go)||wn.push(go)}const _s=`${Math.round(We)},${Math.round(at)} → ${Math.round(bt)},${Math.round(Ze)}`;let Bs;(ot==="circle"||ot==="box")&&wn.length>0?Bs=`${ot==="box"?"Boxed":"Circled"} **${wn[0]}**${wn.length>1?` (and ${wn.slice(1).join(", ")})`:""} (region: ${_s})`:ot==="underline"&&wn.length>0?Bs=`Underlined **${wn[0]}** (${_s})`:ot==="arrow"&&wn.length>=2?Bs=`Arrow from **${wn[0]}** to **${wn[wn.length-1]}** (${Math.round(gn.x)},${Math.round(gn.y)} → ${Math.round(At.x)},${Math.round(At.y)})`:wn.length>0?Bs=`${ot==="arrow"?"Arrow":"Drawing"} near **${wn.join("**, **")}** (region: ${_s})`:Bs=`Drawing at ${_s}`,K.push(Bs)}$&&($.style.visibility=""),K.length>0&&(A+=`
**Drawings:**
`,K.forEach((we,je)=>{A+=`${je+1}. ${we}
`}))}if((De.length>0||E&&ln)&&(A+=`
`+x0(De,{width:window.innerWidth,height:window.innerHeight},{blankCanvas:Fe,wireframePurpose:ln||void 0},kt.outputDetail)),Me){const T=b0(Me,kt.outputDetail,{width:window.innerWidth,height:window.innerHeight});T&&(A+=`
`+T)}if(m)try{await navigator.clipboard.writeText(A)}catch{}g==null||g(A),D(!0),tt(()=>D(!1),2e3),kt.autoClearAfterCopy&&tt(()=>ks(),500)},[B,rn,De,Me,Fe,Ae,vs,ln,et,kt.outputDetail,Vs,kt.autoClearAfterCopy,ks,m,g]),pa=b.useCallback(async()=>{const S=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:et;let E=j0(B,S,kt.outputDetail);if(!E&&De.length===0&&!Me)return;if(E||(E=`## Page Feedback: ${S}
`),De.length>0&&(E+=`
`+x0(De,{width:window.innerWidth,height:window.innerHeight},{blankCanvas:Fe,wireframePurpose:ln||void 0},kt.outputDetail)),Me){const T=b0(Me,kt.outputDetail,{width:window.innerWidth,height:window.innerHeight});T&&(E+=`
`+T)}h&&h(E,B),pe("sending"),await new Promise(T=>tt(T,150));const A=await zs("submit",{output:E,annotations:B},!0);pe(A?"sent":"failed"),tt(()=>pe("idle"),2500),A&&kt.autoClearAfterCopy&&tt(()=>ks(),500)},[h,zs,B,De,Me,Fe,vs,et,kt.outputDetail,Vs,kt.autoClearAfterCopy,ks]);b.useEffect(()=>{if(!rs)return;const S=10,E=T=>{const $=T.clientX-rs.x,K=T.clientY-rs.y,ge=Math.sqrt($*$+K*K);if(!Ks&&ge>S&&Vo(!0),Ks||ge>S){let we=rs.toolbarX+$,je=rs.toolbarY+K;const Ie=20,We=337,at=44,Ze=We-(M?ls==="connected"?297:257:44),Se=Ie-Ze,tn=window.innerWidth-Ie-We;we=Math.max(Se,Math.min(tn,we)),je=Math.max(Ie,Math.min(window.innerHeight-at-Ie,je)),Ss({x:we,y:je})}},A=()=>{Ks&&(Ko.current=!0),Vo(!1),la(null)};return document.addEventListener("mousemove",E),document.addEventListener("mouseup",A),()=>{document.removeEventListener("mousemove",E),document.removeEventListener("mouseup",A)}},[rs,Ks,M,ls]);const Rr=b.useCallback(S=>{if(S.target.closest("button")||S.target.closest("[data-agentation-settings-panel]"))return;const E=S.currentTarget.parentElement;if(!E)return;const A=E.getBoundingClientRect(),T=(Bt==null?void 0:Bt.x)??A.left,$=(Bt==null?void 0:Bt.y)??A.top;la({x:S.clientX,y:S.clientY,toolbarX:T,toolbarY:$})},[Bt]);if(b.useEffect(()=>{if(!Bt)return;const S=()=>{let $=Bt.x,K=Bt.y;const je=20-(337-(M?ls==="connected"?297:257:44)),Ie=window.innerWidth-20-337;$=Math.max(je,Math.min(Ie,$)),K=Math.max(20,Math.min(window.innerHeight-44-20,K)),($!==Bt.x||K!==Bt.y)&&Ss({x:$,y:K})};return S(),window.addEventListener("resize",S),()=>window.removeEventListener("resize",S)},[Bt,M,ls]),b.useEffect(()=>{const S=E=>{const A=E.target,T=A.tagName==="INPUT"||A.tagName==="TEXTAREA"||A.isContentEditable;if(E.key==="Escape"){if(Ae){xt?_t(null):ha();return}if(es){ws(!1);return}if(pn.length>0){co([]);return}W||M&&(Un(),O(!1))}if((E.metaKey||E.ctrlKey)&&E.shiftKey&&(E.key==="f"||E.key==="F")){E.preventDefault(),Un(),M?Er():O(!0);return}if(!(T||E.metaKey||E.ctrlKey)&&((E.key==="p"||E.key==="P")&&(E.preventDefault(),Un(),ul()),(E.key==="l"||E.key==="L")&&(E.preventDefault(),Un(),es&&ws(!1),ce&&ze(!1),W&&dl(),Ae?ha():wt(!0)),(E.key==="h"||E.key==="H")&&B.length>0&&(E.preventDefault(),Un(),z($=>!$)),(E.key==="c"||E.key==="C")&&(B.length>0||De.length>0||Me)&&(E.preventDefault(),Un(),_l()),(E.key==="x"||E.key==="X")&&(B.length>0||De.length>0||Me)&&(E.preventDefault(),Un(),ks(),De.length>0&&yt([]),Me&&Jn(null)),E.key==="s"||E.key==="S")){const $=wo(kt.webhookUrl)||wo(C||"");B.length>0&&$&&Z==="idle"&&(E.preventDefault(),Un(),pa())}};return document.addEventListener("keydown",S),()=>document.removeEventListener("keydown",S)},[M,es,Ae,xt,De,Me,W,B.length,kt.webhookUrl,C,Z,pa,ul,_l,ks,pn]),!$e||de)return null;const Jo=B.length>0,Co=B.filter(S=>!Di.has(S.id)&&S.kind!=="placement"&&S.kind!=="rearrange"),Dr=Co.length>0,jo=B.filter(S=>Di.has(S.id)),Ar=S=>{const K=S.x/100*window.innerWidth,ge=typeof S.y=="string"?parseFloat(S.y):S.y,we={};window.innerHeight-ge-22-10<80&&(we.top="auto",we.bottom="calc(100% + 10px)");const Ie=K-200/2,We=10;if(Ie<We){const at=We-Ie;we.left=`calc(50% + ${at}px)`}else if(Ie+200>window.innerWidth-We){const at=Ie+200-(window.innerWidth-We);we.left=`calc(50% - ${at}px)`}return we};return eg.createPortal(r.jsxs("div",{ref:xe,style:{display:"contents"},"data-agentation-theme":hs?"dark":"light","data-agentation-accent":kt.annotationColorId,"data-agentation-root":"",children:[r.jsx("div",{className:`${_e.toolbar}${k?` ${k}`:""}`,"data-feedback-toolbar":!0,"data-agentation-toolbar":!0,style:Bt?{left:Bt.x,top:Bt.y,right:"auto",bottom:"auto"}:void 0,children:r.jsxs("div",{className:`${_e.toolbarContainer} ${M?_e.expanded:_e.collapsed} ${wr?_e.entrance:""} ${G?_e.hiding:""} ${!kt.webhooksEnabled&&(wo(kt.webhookUrl)||wo(C||""))?_e.serverConnected:""}`,onClick:M?void 0:S=>{if(Ko.current){Ko.current=!1,S.preventDefault();return}O(!0)},onMouseDown:Rr,role:M?void 0:"button",tabIndex:M?-1:0,title:M?void 0:"Start feedback mode",children:[r.jsxs("div",{className:`${_e.toggleContent} ${M?_e.hidden:_e.visible}`,children:[r.jsx(t2,{size:24}),Dr&&r.jsx("span",{className:`${_e.badge} ${M?_e.fadeOut:""} ${wr?_e.entrance:""}`,children:Co.length})]}),r.jsxs("div",{className:`${_e.controlsContent} ${M?_e.visible:_e.hidden} ${Bt&&Bt.y<100?_e.tooltipBelow:""} ${jt||ce?_e.tooltipsHidden:""} ${yr?_e.tooltipsInSession:""}`,onMouseEnter:Qo,onMouseLeave:wu,children:[r.jsxs("div",{className:`${_e.buttonWrapper} ${Bt&&Bt.x<120?_e.buttonWrapperAlignLeft:""}`,children:[r.jsx("button",{className:_e.controlButton,onClick:S=>{S.stopPropagation(),Un(),ul()},"data-active":Y,children:r.jsx(a2,{size:24,isPaused:Y})}),r.jsxs("span",{className:_e.buttonTooltip,children:[Y?"Resume animations":"Pause animations",r.jsx("span",{className:_e.shortcut,children:"P"})]})]}),r.jsxs("div",{className:_e.buttonWrapper,children:[r.jsx("button",{className:`${_e.controlButton} ${hs?"":_e.light}`,onClick:S=>{S.stopPropagation(),Un(),es&&ws(!1),ce&&ze(!1),W&&dl(),Ae?ha():wt(!0)},"data-active":Ae,style:Ae&&Fe?{color:"#f97316",background:"rgba(249, 115, 22, 0.25)"}:void 0,children:r.jsx(m2,{size:21})}),r.jsxs("span",{className:_e.buttonTooltip,children:[Ae?"Exit layout mode":"Layout mode",r.jsx("span",{className:_e.shortcut,children:"L"})]})]}),r.jsxs("div",{className:_e.buttonWrapper,children:[r.jsx("button",{className:_e.controlButton,onClick:S=>{S.stopPropagation(),Un(),z(!F)},disabled:!Jo||Ae,children:r.jsx(i2,{size:24,isOpen:F})}),r.jsxs("span",{className:_e.buttonTooltip,children:[F?"Hide markers":"Show markers",r.jsx("span",{className:_e.shortcut,children:"H"})]})]}),r.jsxs("div",{className:_e.buttonWrapper,children:[r.jsx("button",{className:`${_e.controlButton} ${Ne?_e.statusShowing:""}`,onClick:S=>{S.stopPropagation(),Un(),_l()},disabled:Ae&&Fe?De.length===0&&!((Nr=Me==null?void 0:Me.sections)!=null&&Nr.length):!Jo&&rn.length===0&&De.length===0&&!((Lr=Me==null?void 0:Me.sections)!=null&&Lr.length),"data-active":Ne,children:r.jsx(s2,{size:24,copied:Ne,tint:Ae&&Fe&&(De.length>0||(ml=Me==null?void 0:Me.sections)!=null&&ml.length)?"#f97316":void 0})}),r.jsxs("span",{className:_e.buttonTooltip,children:[Ae&&Fe?"Copy layout":"Copy feedback",r.jsx("span",{className:_e.shortcut,children:"C"})]})]}),r.jsxs("div",{className:`${_e.buttonWrapper} ${_e.sendButtonWrapper} ${M&&!kt.webhooksEnabled&&(wo(kt.webhookUrl)||wo(C||""))?_e.sendButtonVisible:""}`,children:[r.jsxs("button",{className:`${_e.controlButton} ${Z==="sent"||Z==="failed"?_e.statusShowing:""}`,onClick:S=>{S.stopPropagation(),Un(),pa()},disabled:!Jo||!wo(kt.webhookUrl)&&!wo(C||"")||Z==="sending","data-no-hover":Z==="sent"||Z==="failed",tabIndex:wo(kt.webhookUrl)||wo(C||"")?0:-1,children:[r.jsx(o2,{size:24,state:Z}),Jo&&Z==="idle"&&r.jsx("span",{className:_e.buttonBadge,children:B.length})]}),r.jsxs("span",{className:_e.buttonTooltip,children:["Send Annotations",r.jsx("span",{className:_e.shortcut,children:"S"})]})]}),r.jsxs("div",{className:_e.buttonWrapper,children:[r.jsx("button",{className:_e.controlButton,onClick:S=>{S.stopPropagation(),Un(),ks()},disabled:!Jo&&rn.length===0&&De.length===0&&!((pl=Me==null?void 0:Me.sections)!=null&&pl.length),"data-danger":!0,children:r.jsx(r2,{size:24})}),r.jsxs("span",{className:_e.buttonTooltip,children:["Clear all",r.jsx("span",{className:_e.shortcut,children:"X"})]})]}),r.jsxs("div",{className:_e.buttonWrapper,children:[r.jsx("button",{className:_e.controlButton,onClick:S=>{S.stopPropagation(),Un(),Ae&&ha(),ze(!ce)},children:r.jsx(l2,{size:24})}),p&&ls!=="disconnected"&&r.jsx("span",{className:`${_e.mcpIndicator} ${_e[ls]} ${ce?_e.hidden:""}`,title:ls==="connected"?"MCP Connected":"MCP Connecting..."}),r.jsx("span",{className:_e.buttonTooltip,children:"Settings"})]}),r.jsx("div",{className:_e.divider}),r.jsxs("div",{className:`${_e.buttonWrapper} ${Bt&&typeof window<"u"&&Bt.x>window.innerWidth-120?_e.buttonWrapperAlignRight:""}`,children:[r.jsx("button",{className:_e.controlButton,onClick:S=>{S.stopPropagation(),Un(),Er()},children:r.jsx(c2,{size:24})}),r.jsxs("span",{className:_e.buttonTooltip,children:["Exit",r.jsx("span",{className:_e.shortcut,children:"Esc"})]})]})]}),r.jsx(Xv,{visible:Ae&&M,activeType:xt,onSelect:S=>{_t(xt===S?null:S)},isDarkMode:hs,sectionCount:(Me==null?void 0:Me.sections.length)??0,onDetectSections:()=>{const S=tw(),E=(Me==null?void 0:Me.sections)??[],A=new Set(E.map(ge=>ge.selector)),T=S.filter(ge=>!A.has(ge.selector)),$=[...E,...T],K=[...(Me==null?void 0:Me.originalOrder)??[],...T.map(ge=>ge.id)];Jn({sections:$,originalOrder:K,detectedAt:Date.now()})},placementCount:De.length,onClearPlacements:()=>{ao(S=>S+1),nl(S=>S+1),tt(()=>{Jn({sections:[],originalOrder:[],detectedAt:Date.now()})},200)},blankCanvas:Fe,onBlankCanvasChange:S=>{const E={sections:[],originalOrder:[],detectedAt:Date.now()};S?(tl.current={rearrange:Me,placements:De},Jn(io.current.rearrange||E),yt(io.current.placements),_t(null)):(io.current={rearrange:Me,placements:De},Jn(tl.current.rearrange||E),yt(tl.current.placements)),Ot(S)},wireframePurpose:ln,onWireframePurposeChange:An,Tooltip:Ki,onDragStart:(S,E)=>{E.preventDefault();const A=Le[S];let T=null,$=!1;const K=E.clientX,ge=E.clientY,we=E.target.closest("[data-feedback-toolbar]"),je=(we==null?void 0:we.getBoundingClientRect().top)??window.innerHeight,Ie=at=>{const bt=at.clientX-K,Ze=at.clientY-ge;if(!$&&(Math.abs(bt)>4||Math.abs(Ze)>4)&&($=!0,T=document.createElement("div"),T.className=`${ne.dragPreview}${Fe?` ${ne.dragPreviewWireframe}`:""}`,document.body.appendChild(T)),!T)return;const Se=Math.max(0,je-at.clientY),tn=Math.min(1,Se/180),qt=1-Math.pow(1-tn,2),gn=28,At=20,hn=Math.min(140,A.width*.18),ot=Math.min(90,A.height*.18),mt=gn+(hn-gn)*qt,an=At+(ot-At)*qt;T.style.width=`${mt}px`,T.style.height=`${an}px`,T.style.left=`${at.clientX-mt/2}px`,T.style.top=`${at.clientY-an/2}px`,T.style.opacity=`${.5+.5*qt}`,T.textContent=qt>.25?S:""},We=at=>{if(window.removeEventListener("mousemove",Ie),window.removeEventListener("mouseup",We),T&&document.body.removeChild(T),$){const bt=A.width,Ze=A.height,Se=window.scrollY,tn=Math.max(0,at.clientX-bt/2),qt=Math.max(0,at.clientY+Se-Ze/2),gn={id:`dp-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,type:S,x:tn,y:qt,width:bt,height:Ze,scrollY:Se,timestamp:Date.now()};yt(At=>[...At,gn]),_t(null),Go.current=new Set,oa(At=>At+1)}};window.addEventListener("mousemove",Ie),window.addEventListener("mouseup",We)}}),r.jsx(u4,{settings:kt,onSettingsChange:S=>br(E=>({...E,...S})),isDarkMode:hs,onToggleTheme:Qs,isDevMode:ol,connectionStatus:ls,endpoint:p,isVisible:Ce,toolbarNearBottom:!!Bt&&Bt.y<230,settingsPage:it,onSettingsPageChange:ht,onHideToolbar:ku})]})}),(Ae||Et)&&r.jsx("div",{className:`${ne.blankCanvas} ${vn?ne.visible:""} ${Yt?ne.gridActive:""}`,style:{"--canvas-opacity":In},"data-feedback-toolbar":!0}),Ae&&Fe&&vn&&r.jsxs("div",{className:ne.wireframeNotice,"data-feedback-toolbar":!0,children:[r.jsxs("div",{className:ne.wireframeOpacityRow,children:[r.jsx("span",{className:ne.wireframeOpacityLabel,children:"Toggle Opacity"}),r.jsx("input",{type:"range",className:ne.wireframeOpacitySlider,min:0,max:1,step:.01,value:In,onChange:S=>oo(Number(S.target.value))})]}),r.jsxs("div",{className:ne.wireframeNoticeTitleRow,children:[r.jsx("span",{className:ne.wireframeNoticeTitle,children:"Wireframe Mode"}),r.jsx("span",{className:ne.wireframeNoticeDivider}),r.jsx("button",{className:ne.wireframeStartOver,onClick:()=>{ao(S=>S+1),Jn({sections:[],originalOrder:[],detectedAt:Date.now()}),io.current={rearrange:null,placements:[]},An(""),Vc(et)},children:"Start Over"})]}),"Drag components onto the canvas.",r.jsx("br",{}),"Copied output will only include the wireframed layout."]}),(Ae||Et)&&r.jsx(Pv,{placements:De,onChange:yt,activeComponent:Et?null:xt,onActiveComponentChange:_t,isDarkMode:hs,exiting:Et,onInteractionChange:jn,passthrough:!xt,extraSnapRects:Me==null?void 0:Me.sections.map(S=>S.currentRect),deselectSignal:Ei,clearSignal:Mi,wireframe:Fe,onSelectionChange:(S,E)=>{Go.current=S,E||(Ns.current=new Set,Fo(A=>A+1))},onDragMove:(S,E)=>{const A=Ns.current;if(!(!A.size||!Me)){if(!Xn.current){Xn.current=new Map;for(const T of Me.sections)A.has(T.id)&&Xn.current.set(T.id,{x:T.currentRect.x,y:T.currentRect.y})}for(const T of Me.sections){if(!A.has(T.id)||!Xn.current.get(T.id))continue;const K=document.querySelector(`[data-rearrange-section="${T.id}"]`);K&&(K.style.transform=`translate(${S}px, ${E}px)`)}}},onDragEnd:(S,E,A)=>{const T=Ns.current,$=Xn.current;if(Xn.current=null,!(!T.size||!Me||!$)){for(const K of T){const ge=document.querySelector(`[data-rearrange-section="${K}"]`);ge&&(ge.style.transform="")}A&&Jn(K=>K&&{...K,sections:K.sections.map(ge=>{const we=$.get(ge.id);return we?{...ge,currentRect:{...ge.currentRect,x:Math.max(0,we.x+S),y:Math.max(0,we.y+E)}}:ge})})}}}),(Ae||Et)&&Me&&r.jsx(ow,{rearrangeState:Me,onChange:Jn,isDarkMode:hs,exiting:Et,blankCanvas:Fe,extraSnapRects:De.map(S=>({x:S.x,y:S.y,width:S.width,height:S.height})),clearSignal:Nn,deselectSignal:Xo,onSelectionChange:(S,E)=>{Ns.current=S,E||(Go.current=new Set,oa(A=>A+1))},onDragMove:(S,E)=>{const A=Go.current;if(A.size){if(!Xn.current){Xn.current=new Map;for(const T of De)A.has(T.id)&&Xn.current.set(T.id,{x:T.x,y:T.y})}for(const T of A){const $=document.querySelector(`[data-design-placement="${T}"]`);$&&($.style.transform=`translate(${S}px, ${E}px)`)}}},onDragEnd:(S,E,A)=>{const T=Go.current,$=Xn.current;if(Xn.current=null,!(!T.size||!$)){for(const K of T){const ge=document.querySelector(`[data-design-placement="${K}"]`);ge&&(ge.style.transform="")}A&&yt(K=>K.map(ge=>{const we=$.get(ge.id);return we?{...ge,x:Math.max(0,we.x+S),y:Math.max(0,we.y+E)}:ge}))}}}),r.jsx("canvas",{ref:qo,className:`${_e.drawCanvas} ${es?_e.active:""}`,style:{opacity:rl?1:0,transition:"opacity 0.15s ease"},"data-feedback-toolbar":!0}),r.jsxs("div",{className:_e.markersLayer,"data-feedback-toolbar":!0,children:[he&&Co.filter(S=>!S.isFixed).map((S,E,A)=>r.jsx(E0,{annotation:S,globalIndex:Co.findIndex(T=>T.id===S.id),layerIndex:E,layerSize:A.length,isExiting:Q,isClearing:rt,isAnimated:al.has(S.id),isHovered:!Q&&en===S.id,isDeleting:Dt===S.id,isEditingAny:!!V,renumberFrom:bn,markerClickBehavior:kt.markerClickBehavior,tooltipStyle:Ar(S),onHoverEnter:T=>!Q&&T.id!==da.current&&ma(T),onHoverLeave:()=>ma(null),onClick:T=>kt.markerClickBehavior==="delete"?fl(T.id):_a(T),onContextMenu:_a},S.id)),he&&!Q&&jo.filter(S=>!S.isFixed).map(S=>r.jsx(M0,{annotation:S},S.id))]}),r.jsxs("div",{className:_e.fixedMarkersLayer,"data-feedback-toolbar":!0,children:[he&&Co.filter(S=>S.isFixed).map((S,E,A)=>r.jsx(E0,{annotation:S,globalIndex:Co.findIndex(T=>T.id===S.id),layerIndex:E,layerSize:A.length,isExiting:Q,isClearing:rt,isAnimated:al.has(S.id),isHovered:!Q&&en===S.id,isDeleting:Dt===S.id,isEditingAny:!!V,renumberFrom:bn,markerClickBehavior:kt.markerClickBehavior,tooltipStyle:Ar(S),onHoverEnter:T=>!Q&&T.id!==da.current&&ma(T),onHoverLeave:()=>ma(null),onClick:T=>kt.markerClickBehavior==="delete"?fl(T.id):_a(T),onContextMenu:_a},S.id)),he&&!Q&&jo.filter(S=>S.isFixed).map(S=>r.jsx(M0,{annotation:S,fixed:!0},S.id))]}),M&&r.jsxs("div",{className:_e.overlay,"data-feedback-toolbar":!0,style:W||V?{zIndex:99999}:void 0,children:[(oe==null?void 0:oe.rect)&&!W&&!St&&!Zs&&r.jsx("div",{className:`${_e.hoverHighlight} ${_e.enter}`,style:{left:oe.rect.left,top:oe.rect.top,width:oe.rect.width,height:oe.rect.height,borderColor:"color-mix(in srgb, var(--agentation-color-accent) 50%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 4%, transparent)"}}),pn.filter(S=>document.contains(S.element)).map((S,E)=>{const A=S.element.getBoundingClientRect(),T=pn.length>1;return r.jsx("div",{className:T?_e.multiSelectOutline:_e.singleSelectOutline,style:{position:"fixed",left:A.left,top:A.top,width:A.width,height:A.height,...T?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}},E)}),en&&!W&&(()=>{var $;const S=B.find(K=>K.id===en);if(!(S!=null&&S.boundingBox))return null;if(($=S.elementBoundingBoxes)!=null&&$.length)return Ke.length>0?Ke.filter(K=>document.contains(K)).map((K,ge)=>{const we=K.getBoundingClientRect();return r.jsx("div",{className:`${_e.multiSelectOutline} ${_e.enter}`,style:{left:we.left,top:we.top,width:we.width,height:we.height}},`hover-outline-live-${ge}`)}):S.elementBoundingBoxes.map((K,ge)=>r.jsx("div",{className:`${_e.multiSelectOutline} ${_e.enter}`,style:{left:K.x,top:K.y-Re,width:K.width,height:K.height}},`hover-outline-${ge}`));const E=ve&&document.contains(ve)?ve.getBoundingClientRect():null,A=E?{x:E.left,y:E.top,width:E.width,height:E.height}:{x:S.boundingBox.x,y:S.isFixed?S.boundingBox.y:S.boundingBox.y-Re,width:S.boundingBox.width,height:S.boundingBox.height},T=S.isMultiSelect;return r.jsx("div",{className:`${T?_e.multiSelectOutline:_e.singleSelectOutline} ${_e.enter}`,style:{left:A.x,top:A.y,width:A.width,height:A.height,...T?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}})})(),oe&&!W&&!St&&!Zs&&r.jsxs("div",{className:`${_e.hoverTooltip} ${_e.enter}`,style:{left:Math.max(8,Math.min(N.x,window.innerWidth-100)),top:Math.max(N.y-(oe.reactComponents?48:32),8)},children:[oe.reactComponents&&r.jsx("div",{className:_e.hoverReactPath,children:oe.reactComponents}),r.jsx("div",{className:_e.hoverElementName,children:oe.elementName})]}),W&&r.jsxs(r.Fragment,{children:[(ei=W.multiSelectElements)!=null&&ei.length?W.multiSelectElements.filter(S=>document.contains(S)).map((S,E)=>{const A=S.getBoundingClientRect();return r.jsx("div",{className:`${_e.multiSelectOutline} ${Ln?_e.exit:_e.enter}`,style:{left:A.left,top:A.top,width:A.width,height:A.height}},`pending-multi-${E}`)}):W.targetElement&&document.contains(W.targetElement)?(()=>{const S=W.targetElement.getBoundingClientRect();return r.jsx("div",{className:`${_e.singleSelectOutline} ${Ln?_e.exit:_e.enter}`,style:{left:S.left,top:S.top,width:S.width,height:S.height,borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}})})():W.boundingBox&&r.jsx("div",{className:`${W.isMultiSelect?_e.multiSelectOutline:_e.singleSelectOutline} ${Ln?_e.exit:_e.enter}`,style:{left:W.boundingBox.x,top:W.boundingBox.y-Re,width:W.boundingBox.width,height:W.boundingBox.height,...W.isMultiSelect?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}}),(()=>{const S=W.x,E=W.isFixed?W.y:W.y-Re;return r.jsxs(r.Fragment,{children:[r.jsx(e4,{x:S,y:E,isMultiSelect:W.isMultiSelect,isExiting:Ln}),r.jsx(hu,{ref:kr,element:W.element,selectedText:W.selectedText,computedStyles:W.computedStylesObj,placeholder:W.element==="Area selection"?"What should change in this area?":W.isMultiSelect?"Feedback for this group of elements...":"What should change?",onSubmit:Cu,onCancel:dl,isExiting:Ln,lightMode:!hs,accentColor:W.isMultiSelect?"var(--agentation-color-green)":"var(--agentation-color-accent)",style:{left:Math.max(160,Math.min(window.innerWidth-160,S/100*window.innerWidth)),...E>window.innerHeight-290?{bottom:window.innerHeight-E+20}:{top:E+20}}})]})})()]}),V&&r.jsxs(r.Fragment,{children:[(ti=V.elementBoundingBoxes)!=null&&ti.length?nt.length>0?nt.filter(S=>document.contains(S)).map((S,E)=>{const A=S.getBoundingClientRect();return r.jsx("div",{className:`${_e.multiSelectOutline} ${_e.enter}`,style:{left:A.left,top:A.top,width:A.width,height:A.height}},`edit-multi-live-${E}`)}):V.elementBoundingBoxes.map((S,E)=>r.jsx("div",{className:`${_e.multiSelectOutline} ${_e.enter}`,style:{left:S.x,top:S.y-Re,width:S.width,height:S.height}},`edit-multi-${E}`)):(()=>{const S=Ge&&document.contains(Ge)?Ge.getBoundingClientRect():null,E=S?{x:S.left,y:S.top,width:S.width,height:S.height}:V.boundingBox?{x:V.boundingBox.x,y:V.isFixed?V.boundingBox.y:V.boundingBox.y-Re,width:V.boundingBox.width,height:V.boundingBox.height}:null;return E?r.jsx("div",{className:`${V.isMultiSelect?_e.multiSelectOutline:_e.singleSelectOutline} ${_e.enter}`,style:{left:E.x,top:E.y,width:E.width,height:E.height,...V.isMultiSelect?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}}):null})(),r.jsx(hu,{ref:Cr,element:V.element,selectedText:V.selectedText,computedStyles:Kv(V.computedStyles),placeholder:"Edit your feedback...",initialValue:V.comment,submitLabel:"Save",onSubmit:ju,onCancel:hl,onDelete:()=>fl(V.id),isExiting:ra,lightMode:!hs,accentColor:V.isMultiSelect?"var(--agentation-color-green)":"var(--agentation-color-accent)",style:(()=>{const S=V.isFixed?V.y:V.y-Re;return{left:Math.max(160,Math.min(window.innerWidth-160,V.x/100*window.innerWidth)),...S>window.innerHeight-290?{bottom:window.innerHeight-S+20}:{top:S+20}}})()})]}),Zs&&r.jsxs(r.Fragment,{children:[r.jsx("div",{ref:mo,className:_e.dragSelection}),r.jsx("div",{ref:Zo,className:_e.highlightsContainer})]})]})]}),document.body)}const h4=()=>{const o=ko();return o.pathname==="/"||o.pathname==="/controller"?null:r.jsx("nav",{className:"bg-slate-900 border-b border-slate-800 text-slate-100 p-4 flex items-center justify-between shadow-lg",children:r.jsxs("div",{className:"flex items-center gap-6",children:[r.jsx(lr,{to:"/",className:"font-extrabold text-xl tracking-tight text-cyan-400 hover:text-cyan-300",children:"⚽ Soccer Web Game"}),r.jsx(lr,{to:"/",className:"text-sm font-semibold hover:text-cyan-400 transition",children:"Arena Game"}),r.jsx(lr,{to:"/controller",className:"text-sm font-semibold hover:text-cyan-400 transition",children:"📱 Mobile Remote"})]})})};function _4(){return r.jsx(vb,{children:r.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 flex flex-col select-none",children:[r.jsx(h4,{}),r.jsxs(Kx,{children:[r.jsx(Yf,{path:"/",element:r.jsx(q5,{})}),r.jsx(Yf,{path:"/controller",element:r.jsx(Q5,{})})]}),r.jsx(f4,{})]})})}K1.createRoot(document.getElementById("root")).render(r.jsx(Rn.StrictMode,{children:r.jsx(_4,{})}));
